...
const cs = {
  ...
  home: {
    ...
    heroClaims: [
      ...
      { a: "Míň klikání, víc ", accent: "hotovo", b: "." },
      { a: "Systém, který ", accent: "vydržíte", b: "." },
      ...
      { a: "Jedna ", accent: "zkratka", b: " denně stačí." },
...
const en: typeof cs = {
  ...
  home: {
    ...
    heroClaims: [
      ...
      { a: "Less clicking, more ", accent: "done", b: "." },
      { a: "A system you will actually ", accent: "keep", b: "." },
      ...
      { a: "One ", accent: "shortcut", b: " a day is enough." },
