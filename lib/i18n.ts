...
const cs = {
  ...
  search: {
    ...
    typeLabel: { tip: "Tip", kapitola: "Příručka", ai: "AI novinka", rozhovor: "Rozhovor", agent: "Agenti" },
  },
  home: {
    ...
    kurzEyebrow: "E-mailový kurz zdarma",
    kurzTitle: "AI za týden",
    kurzDesc: "Sedm dní, sedm krátkých e-mailů. Každý den jedna dovednost a jeden prompt, který si vyzkoušíte hned na vlastní práci — od prvního zadání po vlastní mini projekt.",
    kurzDays: ["Úkol místo tématu", "Čtyři díly promptu", "Nepříjemný e-mail", "Dlouhý dokument", "Čísla a tabulky", "Rutiny", "Mini projekt"],
    kurzCta: "Chci kurz zdarma",
    kurzSample: "Podívat se na ukázkové číslo →",
    ...
    tools: [
      ...
      { href: "/nastroje/diagnostika", label: "Na které úrovni AI jste", meta: "Diagnostika · 3 min" },
  ...
  footer: {
    ...
    agents: "Agenti a vlastní AI",
    prompts: "Databáze promptů",
    templates: "Šablony",
    gadgets: "Gadgety",
    glossary: "Slovník pojmů",
    resources: "Kam dál",
      connectors: "MCP konektory",
    ...
    newsletterArchive: "Archiv newsletteru",
...
const en: typeof cs = {
  ...
  search: {
    ...
    typeLabel: { tip: "Tip", kapitola: "Handbook", ai: "AI update", rozhovor: "Interview", agent: "Agents" },
  },
  home: {
    heroA: "A little ",
    heroAccent: "faster",
    ...
    kurzEyebrow: "Free email course",
    kurzTitle: "AI in a week",
    kurzDesc: "Seven days, seven short emails. One skill and one prompt a day, tried on your own work right away — from your first brief to your own mini project.",
    kurzDays: ["A task, not a topic", "Four parts of a prompt", "That awkward email", "A long document", "Numbers and tables", "Routines", "Mini project"],
    kurzCta: "Get the free course",
    kurzSample: "See a sample issue →",
    ...
    tools: [
      ...
      { href: "/nastroje/diagnostika", label: "Which AI level you are on", meta: "Diagnostic · 3 min" },
