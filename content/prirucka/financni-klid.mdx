...
Zisk je rozdíl mezi tím, co jste za nějaké období vydělali, a tím, co vás to stálo. Hotovost je stav účtu dnes ráno. Tyhle dvě věci spolu souvisejí jen volně a mezi nimi leží několik zdrojů zpoždění, které se sčítají.
...
Obrana je jednoduchá a nikdo ji nedělá, protože vypadá jako účetnictví, a to má přece na starost někdo jiný. Není to účetnictví. Je to výhled hotovosti: jednoduchý přehled na tři měsíce dopředu, kde v jednom sloupci stojí, co má přijít a kdy, a ve druhém, co má odejít a kdy. Vejde se do jedné tabulky a aktualizuje se jednou týdně za pár minut.
...
A když rezerva chybí a zároveň hrozí výpadek, zbývá možnost, o které se mlčí: **snížit náklady dřív, než dojdou peníze.** Udělat to v předstihu je nesrovnatelně snazší než v panice a nikoho to nepoškodí.

## Oddělené účty a systém, který vydrží pátek v pět

Nejčastější provozní chyba na volné noze je jeden účet, přes který teče všechno: příjmy z faktur, nákupy do podnikání, nájem, jídlo, dovolená i peníze určené na daň. Na takovém účtu není nikdy poznat, kolik z toho zůstatku je opravdu vaše. Když je na něm hodně, vypadá to jako úspěch. Když se pak objeví daňová povinnost, vypadá to jako křivda.
...
Efekt téhle jedné změny je psychologický víc než finanční. Peníze na daň nikdy nebyly vaše, jen chvíli protékaly vaším účtem — a když sedí jinde, platba není rána, ale převod. Výplata sama sobě v pevné částce navíc vyrovnává sezónnost, o které mluvila kapitola [Čas jako zboží](/prirucka/cas-jako-zbozi): silný měsíc se nepromění v drahý nákup a slabý měsíc v paniku, protože domácnost dostává pořád stejně a výkyvy zůstávají v provozu, kde jim je nejlíp.
...
Dvě věci k té ose stojí za zdůraznění. Za prvé, konkrétní data i sazby se mění a liší se podle situace každého — ověřovat se mají u účetní nebo daňového poradce, ne podle toho, co si někdo pamatuje z loňska. Za druhé, položky z osy patří do kalendáře jako **akce s předstihem**, ne jako datum. Ne „termín přiznání", ale „připravit podklady" tři týdny předem. Rozdíl je stejný jako u jakéhokoli jiného termínu: datum samo o sobě se nedá udělat, akce ano.
...
Dřív nebo později přijde faktura, která zůstane nezaplacená. Není to výjimka ani osobní selhání a nemá smysl to brát jako urážku — je to provozní riziko, které patří k práci na sebe. Rozdíl mezi lidmi, kterým to vezme týden života, a lidmi, kterým to vezme půl hodiny, je v tom, jestli mají předem rozmyšlený postup.
...
Do stejné kategorie patří věci, o kterých se jako o investici nepřemýšlí, ačkoli jí jsou. Vybavení, které nezdržuje a nebolí. Pojištění odpovědnosti, pokud ve vašem oboru dává smysl. Čas strávený nad vlastním systémem a šablonami, který se vrátí v každé další zakázce. A zdraví, které je na volné noze nejpodceňovanější provozní riziko vůbec, protože nemoc tady nemá kdo zaplatit; souvislosti rozebírá kapitola [Jak pracovat v souladu s vlastním tělem](/prirucka/telo-a-produktivita).

## Kdy si přidat a jak to říct

Zvyšování ceny je téma, u kterého se nejvíc plete ekonomika s odvahou. Přitom otázka „mám si přidat" má překvapivě věcné odpovědi a většina z nich se dá poznat dřív, než dojde trpělivost.
...
Věta, která na tohle stačí, je krátká: „Od ledna upravuji sazbu na X. Rozdělaná zakázka se dokončí za původních podmínek, chtěl jsem vám to říct s předstihem, ať s tím můžete počítat." Žádná omluva, žádné vysvětlování, žádné čekání na svolení. Kdo formulaci nemá v malíčku a bojí se reakce, může si rozhovor nanečisto zkusit — přesně na tohle je tip [Nácvik těžkého rozhovoru: AI hraje protistranu](/tipy/nacvik-tezkeho-rozhovoru-ai).
