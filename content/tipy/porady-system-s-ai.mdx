...
excerpt: "Kompletní návod s prompty: audit porad z kalendáře, agenda postavená na rozhodnutích, zápis s úkoly a pravidlo, které smaže polovinu schůzek."
category: "ai"
platform: "vsude"
audience: ["manazer"]
keys: []
...
updated: "2026-08-12"
tldr: >-
  Dobrý zápis ze špatné porady je jen precizní záznam ztraceného času — proto tenhle
  systém bere celý cyklus: audit kalendáře v člověkohodinách, pravidlo „porada bez
  agendy se nekoná“, podklad na pět minut čtení den předem, timeboxing, zápis řízený
  agendou a kontrolu úkolů den před další poradou. AI dělá mechaniku, ale který
  meeting se zruší, kdo úkol dostane a co se pošle ven, rozhoduje vždycky člověk.
  Cílem není mít lepší porady, ale méně porad, ve kterých se víc rozhodne.
faq:
  - q: "Kdy má porada vůbec smysl?"
    a: >-
      Ve třech případech: rozhoduje se (potřebujete víc hlav v jedné chvíli), řeší
      se konflikt nebo citlivá věc, nebo se něco společně tvoří. Ve všech ostatních
      — sdílení informací, reporty stavu, „aby všichni věděli“ — je porada nejdražší
      dostupný nástroj a psaný formát je lepší. Hodinová porada se sedmi lidmi
      nestojí hodinu, ale sedm hodin lidského času.
  - q: "Může AI rozhodnout, které porady zrušit?"
    a: >-
      Ne — model připraví audit kalendáře s člověkohodinami a návrhy, ale nezná
      politiku, historii ani to, že jistá schůzka je jediné místo, kde spolu dvě
      oddělení mluví. Zrušení porady je manažerský a sociální krok. Na váhavé
      případy funguje test tří měsíců: zrušte je a sledujte, co se rozbije —
      většinou nic.
  - q: "Čím se liší dobrá agenda od seznamu témat?"
    a: >-
      „Rozpočet“ není bod agendy, je to oblast. Bod agendy je otázka k zodpovězení
      nebo rozhodnutí k učinění, s určeným rozhodovatelem a časovým limitem.
      A zaveďte pravidlo: kdo poradu svolává, posílá agendu den předem — když
      nedorazí, porada se ruší. Zmizí schůzky, které nikdo neuměl zdůvodnit.
  - q: "Jak má vypadat podklad před poradou?"
    a: >-
      Musí se dát přečíst za pět minut — čtyřicetistránkový dokument nikdo neotevře
      a porada začne dvacetiminutovým vysvětlováním kontextu. Podklad nemá
      obsahovat doporučení, kterou variantu zvolit (od toho je porada), a chybějící
      údaje má přiznat značkou, ne vymyslet.
  - q: "Smí rutina sama posílat upomínky na nesplněné úkoly?"
    a: >-
      Ne. Automat, který sám napíše kolegovi „máš zpoždění“, dokáže poškodit vztahy
      rychleji, než systém ušetří čas — tón upomínky kolegovi zpožděnému kvůli
      nemoci se dá zvolit jen s kontextem, který model nemá. Rutina podklad
      připraví a dá ho jen vám; upomínky posílá člověk.
  - q: "Kdy kontrolovat úkoly z porady?"
    a: >-
      Den před další poradou, ne den po ní. Kontrola den po poradě zjistí, že se
      ještě nic nestalo; kontrola před další poradou nahradí úvodní čtvrthodinu
      „tak kde jsme skončili“ a je jediná, která něco změní. A úkol posunutý
      potřetí není zpožděný — je špatně zadaný, špatně přiřazený, nebo se nemá
      dělat.
---
