...
updated: "2026-08-12"
tldr: >-
  Report pro vedení není přehled dat, je to podklad pro rozhodnutí — data jsou
  důkaz, obsah je závěr a věc, kterou po vedení chcete. Návod vede od čísel
  spočítaných skriptem přes exekutivní shrnutí se závěrem na prvním řádku (BLUF),
  čtyřblokovou strukturu a grafy čitelné za deset vteřin až po simulovaného
  finančního ředitele, který report rozstřílí den před poradou, a převod celé
  přípravy na měsíční rutinu.
faq:
  - q: "Čím se liší report od hlášení?"
    a: >-
      Report je podklad pro rozhodnutí: obsahuje závěr, příčinu, co s tím děláte
      a co po vedení chcete — peníze, člověka, prioritu, nebo souhlas. Hlášení jen
      popisuje, co je v datech. Když z dokumentu nejde poznat, jaké rozhodnutí má
      padnout a kdo ho má udělat, není hotový.
  - q: "Můžu nechat model spočítat čísla do reportu přímo v chatu?"
    a: >-
      Ne — model nepočítá, generuje text, a z dlouhé tabulky vidí jen výřez.
      Agregace dělá skript, model dělá interpretaci: exportujte data do CSV,
      ukažte modelu hlavičku a pár řádků a nechte si napsat skript, který dá
      pokaždé stejná čísla.
  - q: "Kam v reportu patří hlavní závěr?"
    a: >-
      Na první řádek — princip BLUF, „bottom line up front“. Exekutivní shrnutí
      má tři až pět vět: stav, příčinu, co s tím děláte a co potřebujete od
      vedení. Když adresát musí dočíst na poslední slide, aby zjistil, o co jde,
      většinou nedočte.
  - q: "Jak poznám, že jsem data nadinterpretoval?"
    a: >-
      Nechte model rozdělit tvrzení na doložená, hypotézy a nepodložená. Věta
      „zhoršení způsobil odchod dvou kolegů“ je hypotéza, dokud ji data neoddělí
      od jiných vysvětlení — nemaže se, jen přeformuluje: „časově se to kryje
      s odchodem dvou kolegů, jiné vysvětlení jsme nenašli“. Ten rozdíl stojí pět
      slov a nese celou důvěryhodnost reportu.
  - q: "K čemu je simulovaný finanční ředitel?"
    a: >-
      Deset minut před odesláním si necháte report rozstřílet modelem v roli
      věcného, nepřátelského oponenta — a devět z deseti nepříjemných otázek si
      vyslechnete den předem, ne na poradě. Nálezy ale ověřujte proti textu,
      model občas kritizuje věc, kterou jen přehlédl.
  - q: "Může rutina report rovnou odeslat?"
    a: >-
      Ne — do zadání plánované úlohy patří věta „nikdy nic neodesílej“.
      Odeslání je rozhodnutí člověka, protože obsahem reportu je vaše hodnocení
      situace, ne výstup nástroje. Rutina připraví draft s čísly; závěr, příčinu
      a požadavek píšete vy.
---
