...
excerpt: "Kompletní návod s prompty: od zadání s omezeními přes itinerář den po dni s plánem B na déšť po rezervační checklist a ověření otvíracích dob u zdroje."
category: "ai"
platform: "vsude"
audience: ["rodic"]
keys: []
...
updated: "2026-08-12"
tldr: >-
  AI udělá za pár minut kostru cesty rozvrženou po dnech, ve které dávají přesuny geografický smysl a je vidět, kdy den přeteče — ale kostra není jízdní řád: otvírací doby, ceny a spoje si model občas domyslí, takže se ověřují u zdroje. Návod vede od zadání s omezeními přes itinerář den po dni, plán B na déšť a rezervační checklist až po offline verzi do mobilu. Kostru dělá stroj, ověřuje a rezervuje člověk.
faq:
  - q: "Proč mi AI vrací jen obecný seznam památek?"
    a: >-
      Protože zadání neobsahuje omezení. „Naplánuj mi Lisabon“ vrátí obsah prvního článku na internetu — plán vzniká z omezení, ne ze zájmů: termín, kdo jede, kde bydlíte, rozpočet, tempo, antizájmy a pevné body. Právě omezení lidé zapomínají napsat.
  - q: "Můžu věřit otvíracím dobám a cenám z chatu?"
    a: >-
      Ne — to je nejdražší chyba celého postupu. Model tvrdí otvírací dobu se stejnou jistotou, ať je pravdivá, nebo ne; sezonní režim, zavírací den a poslední vstup patří na oficiální web. Vyžádejte si místo odpovědí ověřovací seznam otázek — ověření zabere hodinu a je to jediná hodina, po které plánu můžete věřit.
  - q: "Kolik programu se vejde do jednoho dne?"
    a: >-
      Den ve městě unese zhruba šest až osm hodin aktivního programu, z toho jedna až dvě hodiny padnou na přesuny a čekání — s dětmi nebo seniory podstatně méně. Nechte si den spočítat realisticky a do každého dne nechte aspoň devadesát minut nezaplánovaných: není to lenost, je to konstrukční prvek.
  - q: "Co když na místě prší nebo je zavřeno?"
    a: >-
      Nechte si předem ke každému venkovnímu bloku doplnit vnitřní alternativu ve stejné čtvrti a vypsat, které dny jsou na počasí nejcitlivější — pak stačí dny prohodit podle předpovědi. A mějte v mobilu nouzový prompt, který podle zbytku dne navrhne tři varianty, co dělat místo toho.
  - q: "Jízdní řády vlaků a trajektů mi může najít AI?"
    a: >-
      Ne — čísla spojů a časy odjezdů si model domýšlí a kolem nich stojí celý den. Jízdní řády ověřujte vždy u dopravce nebo v oficiálním vyhledávači spojení, a znovu den předem, protože sezonní řády a výluky se mění.
  - q: "Jak dostat itinerář do mobilu na cestu?"
    a: >-
      Plán v konverzaci se v zahraničí bez dat neotevře. Nechte si ho přepsat do jedné samostatné stránky (v Claude jako artefakt) nebo do poznámky ke čtení offline — a před odjezdem ji otevřete v režimu letadlo, to je jediná zkouška, která platí. Citlivé údaje jako čísla rezervací sdílejte jinak než ve skupinovém chatu.
---
