...
Vrátí funkční přehled, se kterým jde jít rovnou na poradu. Dvě upozornění: vkládejte **agregovaná data**, ne surový export s tisíci řádky (osobní údaje tam nemají co dělat), a čísla v přehledu porovnejte s výstupem skriptu — přepis do JSON je další místo, kde se dá udělat chyba.
