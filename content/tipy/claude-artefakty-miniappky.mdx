...
updated: "2026-08-12"
tldr: >-
  Claude umí přímo v konverzaci postavit funkční mini-aplikaci — kalkulačku, kvíz, prototyp — kterou sdílíte odkazem, bez instalace a bez vývojáře. Návod vede od zadání s kontrolním příkladem přes iteraci po jedné změně a testování okrajových hodnot až po sdílení, údržbu a hranici, kdy artefakt přestane stačit. Dvě pravidla nad vším: artefakt počítá, člověk rozhoduje — a citlivá data do něj nepatří.
faq:
  - q: "Co artefakt zvládne a co od něj nečekat?"
    a: >-
      Zvládne kalkulačky, interaktivní nástroje, kvízy, trackery, prototypy a vizualizace — cokoli, co je „vzorec plus pravidla plus výjimky“. Nemá ale sdílenou paměť mezi lidmi: co zadá jeden, druhý neuvidí, a po zavření okna se to obvykle ztratí. Nesahá do firemních systémů a nemá přihlašování ani auditní stopu.
  - q: "Jak poznám, že kalkulačka počítá správně?"
    a: >-
      Dejte do zadání kontrolní příklad s výsledkem, který jste spočítali ručně — bez něj nemáte jak poznat, že nástroj počítá špatně, protože chyba ve vzorci je tichá. Před rozesláním si navíc nechte vypsat pravidla, podle kterých nástroj počítá, a zvlášť hodnoty, které si model doplnil sám — ten seznam bývá delší, než čekáte.
  - q: "Jak mám formulovat úpravy, aby se nic nerozbilo?"
    a: >-
      Jedna změna, jedna věta — po dávce deseti úprav nevíte, která věc se rozbila. Popisujte chování, ne řešení, řekněte, co se měnit nemá, a po každé dávce si nechte přepočítat kontrolní příklad. Když se verze nepovede, panel drží starší verze a dá se vrátit.
  - q: "Můžu do artefaktu dát data klientů nebo mzdy?"
    a: >-
      Ne — pracujte se sazbami, pravidly a vzorci, ne s databází klientů, mzdami ani zdravotními údaji. Když s citlivými daty pracovat musíte, jedině na placeném či firemním účtu se smluvní ochranou dat a s anonymizací všeho, co jde anonymizovat.
  - q: "Může nástroj sám rozhodovat nebo odesílat?"
    a: >-
      Ne — artefakt smí počítat a navrhovat, rozhodnutí zůstává na člověku. Semafor, doporučení i skóre jsou podklad; jakmile nástroj něco odesílá, schvaluje nebo známkuje, překročili jste hranici a jde o automatizaci, která si zaslouží jiný přístup.
  - q: "Kdy artefakt přestane stačit?"
    a: >-
      Pět signálů: data mají přetrvat a sdílet je víc lidí, jsou v tom osobní údaje, potřebujete auditní stopu, nástroj musí mluvit s vašimi systémy, nebo se stal kritickým. Artefakt pak není zahozená práce, ale nejlepší možné zadání pro vývojáře — funkční model vyzkoušený uživateli.
---
