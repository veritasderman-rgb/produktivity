...
updated: "2026-08-12"
tldr: >-
  AI je nejtrpělivější učitel, jakého kdy budete mít — vysvětlí totéž pošesté jinak a na vaší úrovni, když jí řeknete, co už umíte a co ne. Rozdíl mezi učením a příjemným pocitem z učení je ale aktivita: vysvětlení je začátek, ne cíl. Návod vede od nastavení přes Feynmanovu techniku (vysvětlíte vy, AI hledá díry) a řešené příklady až k testovým otázkám z vlastních poznámek a plánu na zkoušku.
faq:
  - q: "Proč mi AI vysvětluje látku moc složitě nebo moc obecně?"
    a: >-
      Většinou to není chyba modelu, ale zadání — bez kontextu dostane odpověď kalibrovanou na průměr internetu, tedy na nikoho. Zadejte jednou profil svého studia: obor, ročník, co už umíte a co nepředpokládat. Seznam „co ještě neumím“ je ta cennější polovina, bez něj model vysvětluje neznámý pojem pomocí tří dalších.
  - q: "Stačí si nechat látku vysvětlit a přečíst si to?"
    a: >-
      Ne — to je největší past celého postupu. Pocit „aha, jasné“ je plynulost textu, ne znalost; po hodině čtení odejdete s vyšší jistotou a stejnou znalostí. Obrana: za každé přečtené vysvětlení jeden pokus o vybavení — zavřít, napsat vlastními slovy, teprve pak porovnat.
  - q: "Co je Feynmanova technika s AI?"
    a: >-
      Otočený postup: zavřete skripta, napíšete vlastní vysvětlení látky zpaměti a necháte AI hledat chyby, díry a místa, kde používáte termín jako zaklínadlo. Tři kola obvykle stačí — hotovo je, když zpětná vazba vrací upřesnění místo chyb. Je to nejsilnější technika návodu a zároveň ta nejnepříjemnější.
  - q: "Můžu věřit číslům, která mi model spočítá?"
    a: >-
      Ne — model není kalkulačka, mezivýsledky dopočítává jako text, ne výpočtem. Každé číslo si přepočítejte a u složitějších výpočtů si nechte napsat skript nebo použijte kalkulačku.
  - q: "Můžu si otázky na zkoušku nechat vygenerovat z internetu?"
    a: >-
      Radši ne — zdrojem mají být vaše poznámky, skripta a prezentace vyučujícího, jinak otázky míří vedle sylabu. A zakažte modelu doplňovat díry vlastní znalostí, jinak se učíte něco, co na přednášce nezaznělo. Ke zkoušce platí, co učí váš vyučující.
  - q: "Řekne mi AI, jestli u zkoušky projdu?"
    a: >-
      Její hodnocení berte jako orientaci, ne známku — model neví, jak se u vás boduje, a bývá buď mírnější, nebo přísnější než realita. Je to zpětná vazba, ne výsledek: AI navrhuje, hodnotí člověk, a u zkoušky sedíte vy.
---
