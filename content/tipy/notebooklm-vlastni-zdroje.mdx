---
title: "NotebookLM: odpovědi jen z vašich zdrojů"
excerpt: "NotebookLM odpovídá výhradně z dokumentů, které do něj nahrajete, a každou větu doloží citací. Uvnitř prompty a rady, které zdroje raději nenahrávat."
category: "ai"
platform: "prohlizec"
...
tested: "2026-09-03"
tldr: >-
  NotebookLM odpovídá výhradně z dokumentů, které do něj nahrajete, a u každé věty
  ukáže citaci do konkrétní pasáže — knihovník, který nikdy nemluví zpaměti. Hodí se
  na zkoušky, smlouvy, firemní dokumentaci a onboarding; kvalita se rozhoduje
  výběrem zdrojů (jedno téma, jedna verze dokumentu, žádné „všechno pro jistotu“).
  Nejcennější dotaz je na to, co ve zdrojích chybí — a citace zkracuje ověření na
  deset vteřin, ale udělat ho musíte vy.
faq:
  - q: "Čím se NotebookLM liší od běžného chatu?"
    a: >-
      Běžný chat odpovídá z toho, co se naučil, a když se zeptáte na něco, co ve
      vašem dokumentu není, odpoví stejně plynule z obecné znalosti — a nepoznáte
      to. Notebook ukotvený ve zdrojích odpovídá jen z nahraného materiálu, každá
      odpověď nese citaci a mezera je vidět: když téma zdroje nepokrývají, dozvíte
      se to.
  - q: "Co do notebooku nahrát a co ne?"
    a: >-
      Nahrajte, co je relevantní a autoritativní: závazné dokumenty, materiály, ze
      kterých se skutečně zkouší, aktuální verze směrnic. Nenahrávejte duplicity
      a staré verze (odpověď pak přijde z té, kterou notebook našel dřív), materiál
      „pro kontext“ ani cizí podklady, o kterých nevíte, jestli platí. Sto zdrojů,
      z nichž je deset relevantních, zhorší odpovědi na těch deset.
  - q: "Můžu věřit citaci, aniž bych na ni klikl?"
    a: >-
      Ne — citace je pozvánka k ověření, ne důkaz. Formulace odpovědi může být
      silnější než originální text, hlavně u opatrných tvrzení odborných zdrojů,
      a notebook může špatně přečíst sken nebo sloučit dvě pasáže. U všeho, co má
      následek — u zkoušky, v podpisu, v e-mailu klientovi — otevřete citaci
      a přečtěte originál.
  - q: "K čemu je audio přehled a kde má hranici?"
    a: >-
      Hodí se jako první průlet materiálem před čtením, na mrtvý čas, jako opakování
      před zkouškou nebo předání kontextu kolegovi. Má ale zásadní limit: nemá
      citace, takže nepoznáte, kde zjednodušil nebo si domyslel pojítko. Poslouchejte
      ho jako orientaci, nikdy jako zdroj — cokoli použijete dál, si najděte v textu.
  - q: "Smím nahrát smlouvy nebo dokumenty s osobními údaji?"
    a: >-
      Nejdřív anonymizujte: jména, rodná čísla a adresy odstraňte nebo nahraďte
      zástupnými — pro odpověď o výpovědní lhůtě není potřeba vědět, kdo je
      pronajímatel. Citlivá data patří jen do placeného účtu se smluvní ochranou
      dat, a výstup u smluv není právní názor: notebook ukáže, co ve smlouvě stojí,
      ne jestli je to v pořádku.
  - q: "Co notebook neumí a kdy sáhnout po Claude nebo ChatGPT?"
    a: >-
      Neví nic mimo zdroje, nepočítá, nepracuje se soubory na disku, nemá konektory
      a není autor. Funguje dělba práce: v notebooku vytáhnete ověřený materiál
      s citacemi, v chatu z něj necháte vyrobit výstup — text, prezentaci, skript.
      Do chatu putuje jen to, co jste si proklikali na citace, ne surová odpověď.
---

Obecná AI ví všechno tak trochu — a když neví, občas si domyslí. Je to daň za to, že odpovídá z toho, co viděla při trénování: obrovské množství textu, ve kterém je vaše skriptum, vaše směrnice ani vaše smlouva vůbec nejsou. NotebookLM od Googlu jde opačnou cestou (od poloviny července 2026 pod novým jménem **Gemini Notebook** — nástroj i princip zůstávají stejné, starý odkaz i název dál fungují). Nahrajete zdroje, on odpovídá **výhradně z nich** a u každé věty ukáže, ze kterého dokumentu a z které pasáže ji vzal.
...
Počet zdrojů na notebook je omezený — v bezplatné verzi 50, u placených plánů víc — a je to spíš dobře než špatně. Nutí vás to vybírat.

### Co nahrát a co ne

Nahrajte to, co je **relevantní a autoritativní**: závazné dokumenty, materiály, ze kterých se skutečně zkouší, aktuální verze směrnic, přepisy schůzek, které opravdu proběhly. Podporované jsou PDF, dokumenty, prezentace a tabulky z Disku Google i nahrané ve formátu Word/PowerPoint, textové soubory a CSV, obrázky, odkazy na webové stránky a veřejná videa z YouTube s titulky; zvukové nahrávky (MP3, WAV) jsou dnes běžný typ zdroje, ne okrajová funkce.
...
- **[NotebookLM / Gemini Notebook](https://notebook.google.com)** — jádro celého postupu: odpovědi výhradně ze zdrojů v notebooku, citace do konkrétních pasáží, audio přehledy a poznámky, které se dají použít jako další zdroj.
