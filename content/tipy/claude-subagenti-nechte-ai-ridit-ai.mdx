...
excerpt: "Kompletní návod s prompty na orchestraci subagentů: kdy jeden agent nestačí, jak rozdělit práci do dávek a kontrolovat výsledky skriptem místo čtení."
category: "ai"
platform: "vsude"
...
updated: "2026-08-12"
tldr: >-
  Když se úloha nevejde do jedné konverzace — šedesát rešerší, tři sta dokumentů, překlad celého webu — řešením není lepší prompt, ale orchestrace: hlavní agent rozdá zadání, dílčí agenti pracují souběžně s čistým kontextem a šéf sbírá a kontroluje výsledky. Devadesát procent kvality se rozhoduje v instrukčním souboru, který napíšete jednou; formu pak hlídá kontrolní skript a člověk čte jen vzorek a označené položky.
faq:
  - q: "Kdy se paralelizace mezi agenty vyplatí?"
    a: >-
      Když má úloha tři znaky: hodně stejnorodých položek (u deseti je režie větší než úspora), nezávislost (položka osm nepotřebuje výsledek položky tři) a popsatelné pravidlo. Když jeden znak chybí, zůstaňte u jednoho agenta — i ten je proti ruční práci obrovská úspora.
  - q: "Proč se výstupy jednotlivých agentů rozjíždějí?"
    a: >-
      Protože agenti o sobě nevědí — nemůžou se domluvit ani si předat rozhodnutí. Cokoli musí být konzistentní napříč celkem (názvosloví, číslování, formát, tón), musí být v instrukčním souboru předem. To je jediné pravidlo orchestrace, které lidé porušují znovu a znovu.
  - q: "Co je pravidlo nejistoty a proč je nejdůležitější?"
    a: >-
      Výslovný pokyn, že agent nikdy nedomýšlí chybějící údaj: pole nechá prázdné, zapíše důvod a míru jistoty, nejasné položky označí k ruční kontrole. Bez něj agent mezeru vyplní věrohodně vypadající větou — prázdné pole doplní člověk za minutu, vymyšlené najde za měsíc.
  - q: "Musím číst všechny výstupy?"
    a: >-
      Ne — formu hlídá kontrolní skript (struktura, úplnost, formáty, meze, duplicity), člověk hlídá obsah. Osvědčený poměr: deset procent výstupů namátkou plus sto procent těch, které skript nebo agent označil. U tří set položek by ruční čtení stejně selhalo.
  - q: "Můžu pustit celou dávku najednou?"
    a: >-
      Radši ne. Nejdřív ověřte instrukce na jedné položce (a pak na druhé, co nejodlišnější) — každá nejasnost by se jinak zopakovala padesátkrát. U velkých objemů pracujte v etapách s kontrolními body: po každé etapě kontrola a případná úprava instrukcí. Systematickou chybu jinak zjistíte až na konci.
  - q: "Co se stane s citlivými daty při orchestraci?"
    a: >-
      Víc agentů znamená víc kopií dat — čím širší dávka, tím víc míst, kam se citlivý podklad dostane. Anonymizujte před spuštěním, ne po něm, a citlivé podklady dávejte jen do placeného či firemního účtu se smluvní ochranou dat.
---
