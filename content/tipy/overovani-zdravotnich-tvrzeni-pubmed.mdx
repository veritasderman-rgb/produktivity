...
excerpt: "Kompletní návod s 24 prompty: jak si tvrzení z reklamy, řetězového e-mailu nebo Instagramu proběhnout proti skutečným studiím přes PubMed konektor, jak s AI číst abstrakty, poznat slabou studii od silné — a jak z toho udělat rodinný registr ověřených tvrzení místo věčného googlení."
category: "ai"
platform: "vsude"
audience: ["rodic", "student", "novinar"]
keys: []
...
- **Hloubková rešerše** — pro velká témata, kde chcete místo dialogu jeden důkladný elaborát s citacemi; postup ukazuje [návod na rešerši](/tipy/deep-research-reserse-trhu).
