...
excerpt: "Kompletní návod s prompty: úlohy, které AI neudělá za žáka, jednoduchá pravidla třídy, obhajoba vlastního textu místo honu na čarodějnice a AI v hodině."
category: "ai"
platform: "vsude"
audience: ["ucitel"]
keys: []
...
updated: "2026-08-12"
tldr: >-
  Plošný zákaz AI ve škole nejde vymáhat, trestá poctivé a míjí to, co je potřeba naučit — užitečnější cíl je „aby se pořád něco naučili“. Návod ukazuje tři pásma pravidel místo zákazu, zadání odolná proti AI (osobní zkušenost, práce v hodině, hodnocení procesu, obhajoba), rozhovor místo detektoru a hodiny, ve kterých si žáci sami vyzkouší, že si model vymýšlí.
faq:
  - q: "Můžu se při hodnocení spolehnout na detektor AI textu?"
    a: >-
      Ne — detektory nemají spolehlivost, jakou by rozhodnutí o hodnocení žáka vyžadovalo. Falešně označují texty psané stroze, texty žáků s jiným mateřským jazykem i texty po korektuře, a obcházejí se triviálně přeformulováním. Detektor nesmí být důvodem k hodnocení ani ke kázeňskému opatření — nanejvýš podnět zeptat se.
  - q: "Co mám dělat, když mám podezření, že práci psala AI?"
    a: >-
      Rozhovor místo obvinění: mezi čtyřma očima, otázkami na konkrétní místa v práci — proč zrovna tenhle příklad, co znamená tahle věta. Kdo text nepsal, na otázky o vlastní práci neodpoví; a kdo odpoví na všechno, pravděpodobně ji psal a mýlili jste se vy. To je taky výsledek, a lepší než hodnocení podle detektoru.
  - q: "Jak napsat zadání, které za žáka AI neudělá?"
    a: >-
      Ne ztížením, ale tím, že se do něj dostane něco, co model nemá: osobní zkušenost a místní kontext, práce v hodině na téma zadané ten den, hodnocení procesu (osnova, verze, poznámky) místo jen výsledku a dvouminutová obhajoba odevzdaného textu. Cíl je snížit návratnost obcházení — když je poctivá cesta rychlejší, většina třídy ji zvolí.
  - q: "Nemám AI ve svém předmětu prostě zakázat?"
    a: >-
      Plošný zákaz nemáte jak vymáhat, znevýhodňuje žáky, kteří ho dodrží, a míjí dovednost, kterou se žáci jinde nenaučí. Funkční dohoda neodpovídá na „smí se AI?“, ale „u čeho a jak“: tři pásma — bez AI, s AI a přiznáním, s AI volně — a u každé úlohy řeknete, do kterého patří.
  - q: "Můžu žáky v hodině posadit k AI nástrojům?"
    a: >-
      Jen s rámcem, který řídíte vy: hotové zadání pro model připravujete vy, ne prázdné okno. A pozor na pravidla, která nejdou obejít — AI služby mají věkové hranice a podmínky použití, které ověřte u konkrétní služby a vedení školy, a osobní údaje žáků do nástrojů nepatří.
  - q: "Jak žáky naučit, že si model vymýšlí?"
    a: >-
      Vysvětlování nemá skoro žádný efekt — ukázat to má efekt obrovský. Připravte hodinu, ve které si žáci sami vyzkouší, že model sebejistě zalže: dotaz na neexistující věc, detail místní historie, citaci z knihy. Pointa není „modelu se nedá věřit“, ale „po výsledku se nedá poznat, jestli se mu dá věřit, proto se ověřuje vždycky“.
---
