...
Pár slov o materiálech: fotku učebnice používáte jako podklad pro **svou vlastní přípravu**, ne jako něco, co se dál rozesílá nebo publikuje. Vygenerovaný pracovní list je váš, naskenovaná stránka učebnice pořád patří nakladatelství — takže do sdílené složky pro žáky patří váš list, ne sken.
...
Vrátí plán, který se dá vytisknout a mít na katedře. Bod 5 je ten, kvůli kterému se prompt vyplatí: připravené škrty jsou rozdíl mezi hodinou, která skončí reflexí, a hodinou, která skončí zvoněním uprostřed cvičení. Minutáž berte jako návrh — model systematicky podceňuje čas na organizaci třídy, takže když plán tvrdí, že rozdání listů a rozdělení do dvojic zabere minutu, připočtěte si tři.
...
Vrátí šest kartiček. Vytiskněte je, zalaminujte a mějte v krabičce na katedře — jedna sada na téma vydrží roky. Aktivity typu „vymysli otázku pro spolužáky“ mají ještě druhý efekt: dostanete zásobu úloh formulovaných jazykem třídy.
...
Pět vytištěných listů v deskách zruší celou kategorii stresu. Jednu z nich si vyzkoušejte ve vlastní hodině, než ji použijete v cizí třídě — teprve tam se ukáže, jestli zadání drží.
