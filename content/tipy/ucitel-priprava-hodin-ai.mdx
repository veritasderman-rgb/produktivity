...
excerpt: "Návod s prompty: z tematického plánu a fotky učebnice hotová hodina, pracovní listy ve třech obtížnostech i suplování na počkání. Pedagogiku držíte vy."
category: "ai"
platform: "vsude"
audience: ["ucitel"]
keys: []
...
updated: "2026-08-12"
tldr: >-
  Příprava na hodinu má dvě části: učitelské řemeslo, které se delegovat nedá,
  a opisování, přeformulovávání a přepisování zadání do tří obtížností, které bere
  večery. AI umí tu druhou: z projektu s ŠVP a fotky učebnice připraví kostru
  hodiny s minutáží, pracovní listy ve třech úrovních opory, zásobník pro rychlíky
  i plán na suplování za deset minut. O tom, co se ve třídě skutečně stane,
  rozhoduje učitel — a do hodiny nesmí nic, co jste sami nepřečetli.
faq:
  - q: "Proč mi AI vrací obecné hodiny, které stejně předělám?"
    a: >-
      Protože nezná váš ŠVP, časovou dotaci, vybavení ani třídu — „připrav
      hodinu o Velké Moravě“ vrátí průměr internetu. Založte si projekt na
      předmět a ročník, nahrajte ŠVP, tematický plán, obsah učebnice a dva
      vlastní vzorové materiály. Nastavení zabere jeden podvečer za pololetí
      a změní výstupy víc než jakékoli vylepšování promptů.
  - q: "Můžu do chatu napsat jména žáků a jejich diagnózy?"
    a: >-
      Ne — pro přípravu hodin nepotřebujete ani jedno jméno. Popisujte typ, ne
      osobu: „tři žáci potřebují zadání rozdělené na kroky“ místo jména
      a diagnózy. Zprávy z poradny a údaje o zdravotním stavu patří nanejvýš do
      školního placeného účtu se smluvní ochranou dat, nikdy do soukromého
      profilu.
  - q: "Musím fakta z vygenerovaných materiálů ověřovat?"
    a: >-
      Ano — modely si vymýšlejí nejraději u detailů: letopočty, jména, čísla,
      a u českých reálií je riziko vyšší. Co jde na tabuli nebo do pracovního
      listu jako fakt, musí projít vaší kontrolou; nechte si tvrdá data vypsat
      do tabulky seřazené od nejrizikovějšího. Chybný letopočet od učitele si
      žáci zapamatují líp než ten správný z učebnice.
  - q: "Jak diferencovat, aby to nebylo nálepkování?"
    a: >-
      Tři varianty místo dvou: prostřední je výchozí a zbylé dvě jsou odbočky —
      jedna s větší oporou, druhá do hloubky. Rozdíl je v míře opory, ne
      v množství úloh, listy pojmenujte barvami místo úrovní a nechte žáky
      vybrat si s možností po deseti minutách změnit. Kdo je hotov dřív, nesmí
      dostat další porci téhož — naučí se pracovat pomaleji.
  - q: "Co dělat, když jdu za deset minut suplovat cizí předmět?"
    a: >-
      Nechte si připravit plán, který neprobírá novou látku, ale procvičuje —
      funguje i bez odbornosti a s poloviční třídou. Fakta z plánu neberte jako
      hotová: v cizím předmětu nepoznáte, že model něco popletl, takže se držte
      učebnice. A chytřejší je mít v kabinetu vytištěnou banku pěti
      univerzálních záložních hodin.
  - q: "Můžu vygenerovaný plán použít bez čtení?"
    a: >-
      Ne — hodina, kterou čtete poprvé před třídou, je horší než hodina bez
      přípravy. Nejčastěji nesedí minutáž (model podceňuje čas na organizaci)
      a náročnost jazyka: modely píší pro žáky o dva roky starší, než zadáte.
      Do hodiny nesmí nic, co jste sami nepřečetli.
---
