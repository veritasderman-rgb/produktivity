...
excerpt: "Kompletní návod s prompty: obsahové pilíře a hlas značky, měsíční plán, dávková výroba postů pro LinkedIn, Instagram i X a měsíční vyhodnocení."
category: "ai"
platform: "vsude"
...
updated: "2026-08-12"
tldr: >-
  Autopilot neznamená, že sítě obsluhuje robot: rozhodnutí uděláte jednou měsíčně
  (obsahové pilíře, hlas značky, plán), výrobu postů zvládnete v jednom dávkovém
  bloku pro LinkedIn, Instagram i X a denní provoz se scvrkne na deset minut nad
  komentáři. Palec, který zveřejní a odpoví, zůstává váš — účet, který mluví
  strojově, poznají lidé dřív než algoritmus. Do každého postu musí přijít něco,
  co model nemohl vědět.
faq:
  - q: "Můžu jeden post vylepit na všechny platformy stejný?"
    a: >-
      Ne — LinkedIn, Instagram a X mají jiné publikum, formát i chování. Z jedné
      myšlenky mají vzniknout tři různé posty, ne jeden nakopírovaný třikrát:
      na LinkedIn rozhodují první dva řádky a konkrétní zkušenost, na Instagramu
      vizuál a první řádek popisku, na X úspornost — jedna myšlenka na příspěvek.
  - q: "Jak poznám, že post zní genericky jako od AI?"
    a: >-
      Podle čtyř znaků: nikoho se nezastane, nemá konkrétno, nemá cenu za omyl
      a mohl by vyjít pod cizím jménem, aniž by si toho někdo všiml. Obrana:
      do každého postu musí přijít něco, co model nemohl vědět — číslo z vašeho
      provozu, situace ze čtvrtka, chyba, kterou jste udělali.
  - q: "Smí AI odpovídat na komentáře za mě?"
    a: >-
      Navrhovat ano, odesílat ne — AI navrhuje, člověk odesílá, a nesmí slibovat
      vaším jménem žádné termíny, ceny ani závazky. Stížnost zákazníka, odborná
      otázka, osobní útok a cokoli právního či zdravotního patří člověku. Funguje
      systém dvou desetiminutových oken denně místo dvaceti přerušení.
  - q: "Co se smí naplánovat dopředu a co ne?"
    a: >-
      Do fronty patří všechno hotové, co nezávisí na aktuálním dění. Nepatří tam
      reakce na aktuální události, citlivá oznámení a nic, co jste si nepřečetli
      po sobě. A rozvrhněte posty tak, abyste byli první hodinu po zveřejnění
      k zastižení — právě tehdy se z postu stává rozhovor.
  - q: "Můžu nechat AI zvládnout krizi na sítích?"
    a: >-
      Ne — u krize AI k formulaci veřejné reakce nepatří vůbec: nemá kontext,
      nezná právní pozadí a neodhadne, co reakce spustí. Co s ní dává smysl, je
      připravit si v klidu předem jednostránkový rozhodovací postup: jak krizi
      poznat, co dělat v prvních 60 minutách a kdy mlčet.
  - q: "Která čísla má smysl měsíčně sledovat?"
    a: >-
      Poměr interakcí k dosahu, uložení a sdílení (nejsilnější signál hodnoty),
      prokliky a nové sledující u konkrétního postu. Marnost jsou absolutní počty
      sledujících a lajky. A nad vším stojí číslo, které v žádné statistice není:
      kolik poptávek zmínilo, že vás četlo. Strategii měňte, až když se něco
      potvrdí dvakrát — měsíc je krátká doba a náhoda dělá víc, než se zdá.
---
