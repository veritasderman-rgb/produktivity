...
excerpt: "Kompletní návod s prompty: z průběžných poznámek věcná slovní hodnocení, těžké e-maily rodičům a podklady na třídní schůzky. Podepisuje vždy učitel."
category: "ai"
platform: "vsude"
audience: ["ucitel"]
keys: []
...
updated: "2026-08-12"
tldr: >-
  AI o vašich žácích neví nic — nemůže napsat hodnocení, může jen převést vaše
  průběžné poznámky do čitelné podoby. Návod vede od anonymizace a evidence
  diktované po hodinách přes věcná slovní hodnocení (bez frází, o práci místo
  povahy) až po těžké e-maily rodičům se strukturou fakt–dopad–nabídka–pozvání,
  konzultační karty a podklady k IVP. Jména žáků do chatu nepatří a hodnocení
  podepisuje vždy učitel.
faq:
  - q: "Napíše AI slovní hodnocení za mě?"
    a: >-
      Ne — bez podkladů vrátí frázi, a fráze v hodnocení je horší než známka,
      protože předstírá pozornost, kterou nikdo nevěnoval. S dvěma až třemi
      konkrétními poznámkami za pololetí u každého žáka vrátí věcný návrh,
      který přepíšete svým jazykem. Kvalita hodnocení se nerozhoduje v lednu,
      ale průběžně během roku.
  - q: "Jak pracovat s údaji žáků, aby to bylo bezpečné?"
    a: >-
      Žáky označujte iniciálami nebo čísly ze seznamu a převodní tabulku si
      nechte u sebe — do chatu neputuje nikdy. Vynechte i formulace, které dítě
      identifikují bez jména, a diagnózy popisujte projevy, ne názvem.
      Používejte školní nebo placený účet se smluvní ochranou dat a jméno
      doplňte až do hotového dokumentu u sebe.
  - q: "Jak zabránit tomu, aby dvacet čtyři hodnocení znělo stejně?"
    a: >-
      Výslovným zákazem opakování v zadání — žádná věta se nesmí opakovat
      napříč hodnoceními a každé musí být rozpoznatelně o jiném dítěti. Sadu si
      pak přečtěte celou najednou: opakující se rytmus vět je vidět až v celku
      a rodiče, kteří si hodnocení mezi sebou ukážou, si ho všimnou.
  - q: "Jak napsat rodičům nepříjemný e-mail, aby nevyzněl jako obvinění?"
    a: >-
      Strukturou o čtyřech částech: fakt (co se stalo, kdy, kolikrát, bez
      přídavných jmen), dopad na dítě, konkrétní nabídka školy a pozvání
      k rozhovoru s termíny. Vyhněte se hodnocení výchovy, srovnávání s ostatními
      a slibům výsledku — a zkontrolujte, že model nezměkčil čísla: „několik
      neodevzdaných prací“ místo „pět z devíti“ vážnost sdělení smaže.
  - q: "Smí model interpretovat příčiny chování dítěte?"
    a: >-
      Ne — věty typu „patrně jde o snahu upoutat pozornost“ z návrhů vyhazujte.
      Je to domněnka, ne pozorování, a rodiče ji čtou jako soud. Popisujte
      chování v konkrétních situacích, nikdy dítě jako takové; příčiny se řeší
      na schůzce, případně s výchovným poradcem.
  - q: "Může AI navrhnout podpůrná opatření nebo diagnózu k IVP?"
    a: >-
      Nemůže — IVP zpracovává škola na základě doporučení poradenského zařízení
      a model nesmí doporučovat opatření ani odhadovat diagnózu. Pomůže sepsat
      vaše pedagogické pozorování: jak se obtíž projevuje, za jakých podmínek se
      výkon zlepšuje a co jste už vyzkoušeli. O podpoře rozhoduje tým
      s poradnou a rodičem.
---
