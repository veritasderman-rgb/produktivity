...
excerpt: "Kompletní návod s prompty pro středoškoláky: z fotky sešitu použitelný zápis, Cornell poznámky s otázkami, nedělní konsolidace a příprava na písemku."
category: "ai"
platform: "vsude"
audience: ["student"]
keys: []
...
updated: "2026-08-12"
tldr: >-
  Poznámky nejsou archiv, ale nástroj — dobrý zápis je ten, ze kterého se dá za tři
  měsíce učit, protože obsahuje otázky, ne jen odpovědi. Návod na celý semestr: rychlý
  záznam (fotka tabule, dvě minuty diktování po hodině), Cornell struktura s otázkami,
  nedělní dvacetiminutová konsolidace a písemka nanečisto z vlastních poznámek. AI smí
  sáhnout na formu, ne na obsah — naučit se to za vás neumí.
faq:
  - q: "Umí AI přečíst můj rukopis z fotky sešitu?"
    a: >-
      Ano — u úhledného písma skoro bez chyb, u rychlých čmáranic hůř a u vzorců
      a matematických zápisů je potřeba výsledek kontrolovat vždycky. V promptu si
      vyžádejte, ať model nečitelná místa označí otazníkem v hranatých závorkách
      a nehádá; letopočty a čísla si proklepněte proti fotce, číslice se v rukopise
      pletou nejčastěji.
  - q: "Můžu si nechat poznámky rovnou vygenerovat, když jsem v hodině nebyl(a)?"
    a: >-
      Ne. „Napiš mi zápis o Velké Moravě“ vrátí text, který nemá nic společného
      s tím, co říkal váš učitel — a navíc v něm můžou být vymyšlená data.
      Poznámky vznikají z vaší hodiny (fotka, diktování, zápis), ne z paměti modelu.
  - q: "Proč se učit z vlastních poznámek, když spolužačka má úplnější?"
    a: >-
      Vaše poznámky obsahují to, co říkal váš učitel — a písemku píše on, ne autor
      učebnice. Vlastní zápis navíc nese kontext hodiny a jeho díry ukazují, co
      neumíte. Správné pořadí je: nejdřív svoje, pak doplnit chybějící z cizích
      a doplněné kusy si označit.
  - q: "Stačí si tabuli fotit a učit se pak z fotek?"
    a: >-
      Nestačí — fotky nejsou poznámky, fotka je surovina. Do dvou dnů ji zpracujte
      na text, jinak se ztratí mezi ostatními snímky; čtyři sta fotek tabule
      v telefonu je archiv, do kterého se nikdy nepodíváte.
  - q: "Jak poznám, že se opravdu učím, a ne jen čtu?"
    a: >-
      Když čtete poznámky se souhlasným přikyvováním, jen rozpoznáváte známý text —
      tomu se říká iluze znalosti. Spolehlivě funguje jediné: zavřít poznámky
      a vybavovat látku z hlavy — otázky z levého sloupce, dvacet nedělních otázek,
      písemka nanečisto. Odpověď musí být první z hlavy, teprve pak kontrola.
  - q: "Můžu odevzdat referát nebo sloh, který napsala AI?"
    a: >-
      Ne — kromě problémů se školou je to hlavně promarněný čas, protože u obhajoby,
      maturity ani přijímaček to za vás nikdo nedopoví. Platí jednoduchá zkouška:
      umíte obhájit každou větu, kterou jste napsali? A přečtěte si pravidla své
      školy — čím dál víc jich má hranici i způsob přiznání AI napsané.
---
