...
excerpt: "Kompletní návod s prompty: test jen z probrané látky, skupiny A/B/C se stejnou obtížností, opravování naskenovaných písemek. Známku dává učitel."
category: "ai"
platform: "vsude"
audience: ["ucitel"]
keys: []
...
updated: "2026-08-12"
tldr: >-
  Písemka stojí učitele čtyři až šest hodin, ze kterých je pedagogika sotva
  hodina — zbytek je mechanika, kterou zvládne AI: úlohy jen z vašich podkladů,
  rovnocenné skupiny A/B/C, bodovací klíč napsaný předem, návrh bodů
  z naskenovaných prací se zdůvodněním a rozbor chyb celé třídy. Co AI nesmí, je
  jediná věc: známku dává učitel — návrh bodů je podklad k rozhodnutí, ne
  rozhodnutí.
faq:
  - q: "Můžu si nechat vygenerovat test jen zadáním tématu?"
    a: >-
      Ne — model nezná váš postup ani učebnici a vyrobí učebnicově správnou
      písemku z látky, kterou jste možná neprobrali. Test smí obsahovat jen to,
      co je ve vašich podkladech: zápisky z hodin, stránky učebnice a domácí
      úkoly. Nejjednodušší návyk je po každé hodině vyfotit tabuli do složky
      předmětu.
  - q: "Stačí pro skupinu B prohodit čísla?"
    a: >-
      Nestačí — studenti to prohlédnou za minutu a jiná čísla často znamenají
      jinou obtížnost (rovnice s celým číslem je jednodušší než tatáž se
      zlomkem). Rovnocenné varianty mají stejnou strukturu úloha po úloze, jiné
      kontexty a srovnávací tabulku obtížnosti. A všechny varianty si spočítejte
      sami, než je rozdáte.
  - q: "Může AI opravovat písemky a dávat známky?"
    a: >-
      Navrhovat body ano, známku ne — model při čtení rukopisu občas přečte
      6 jako 8, přehlédne minus nebo nepozná pokračování na druhé straně.
      U každé úlohy chtějte zdůvodnění, aspoň pět prací opravte celé ručně na
      porovnání a práce na hranici známky posuzujte vždy sami. Známka je
      rozhodnutí o dítěti a rozhodnutí o dítěti se nedelegují.
  - q: "Můžu nahrát skeny písemek se jmény žáků?"
    a: >-
      Ne — práce žáků jsou osobní údaje. Před rozdáním na písemky předepište
      čísla a seznam číslo–jméno si nechte u sebe; skenujete pak práce bez
      jmen. Pracujte ve školním placeném účtu se smluvní ochranou dat, o kterém
      rozhodlo vedení, a po dokončení oprav konverzaci i soubory smažte.
  - q: "K čemu je bodovací klíč napsaný předem?"
    a: >-
      Nekonzistence v hodnocení nevzniká z nespravedlnosti, ale z únavy — první
      práce se opravují velkoryse, dvacátá přísně. Klíč rozepisuje body za
      postup, výsledek i částečně správné odpovědi a řeší chybu, která se táhne
      dál. Bez něj nemáte co porovnat s návrhem od AI.
  - q: "Co s písemkou po zadání známek?"
    a: >-
      Rozbor chyb třídy — jediná část písemky, která zlepší výuku, a nejlevnější
      krok návodu, protože podklady už máte. Rozdíl mezi „dělají chyby ve
      zlomcích“ a „polovina třídy krátí přes součet, protože nerozumí, co
      krácení znamená“ je rozdíl mezi zbytečným a užitečným opakováním.
---
