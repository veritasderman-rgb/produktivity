...
- **Gemini Notebook** (dřívější NotebookLM) — odpovídá jen z nahraných zdrojů a u každé odpovědi ukáže citaci; ideální, když ověřujete text proti vlastním podkladům.
