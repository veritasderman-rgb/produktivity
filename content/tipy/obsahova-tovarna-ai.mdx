...
excerpt: "Kompletní návod s prompty: pilířové téma rozebrat na posty, newsletter i video skript, zafixovat tón značky a schvalování, kde publikuje člověk."
category: "ai"
platform: "vsude"
...
updated: "2026-08-12"
tldr: >-
  Obsahová továrna obrací běžný postup: jednu věc měsíčně uděláte důkladně (pilíř
  s vašimi čísly a zkušeností) a zbytek z ní odvodíte — pilíř se rozebere na 25 až 35
  samostatných myšlenek a z nich vzniknou posty pro každou síť v jejím jazyce,
  newsletter, video skripty i FAQ. AI je výrobní linka, ne autor: tón značky je
  zafixovaný v Projektu, výroba běží v dávkách a platí pravidlo, které nesmí padnout
  ani v nejhorším týdnu — AI vyrábí, člověk publikuje.
faq:
  - q: "Proč nemůže AI napsat rovnou i pilíř?"
    a: >-
      Protože nemá vaši zkušenost s klienty ani vaše čísla. Pilíř je jediná část
      procesu, kde se opravdu vyplatí sedět a přemýšlet — je to materiál, ze kterého
      žije celý zbytek měsíce. Text vygenerovaný modelem z ničeho vyrobí deriváty,
      které jsou také z ničeho.
  - q: "Proč nestačí říct modelu „udělej deset postů z článku“?"
    a: >-
      Dostanete desetkrát to samé shrnutí v jiném pořadí. Postup má dva kroky
      a druhý bez prvního nefunguje: nejdřív se pilíř rozebere na 25 až 35
      samostatných myšlenek, které unesou vlastní post, a teprve z nich se vyrábějí
      výstupy — každý postavený na jedné myšlence, ne na celém článku.
  - q: "Můžu dát stejný text na všechny sítě?"
    a: >-
      Ne — je to nejrychlejší způsob, jak nikde nefungovat. Každá platforma má jiný
      způsob čtení: na LinkedInu rozhoduje první řádek, na Instagramu obraz
      a rytmus, v newsletteru má člověk trpělivost na tři odstavce, na krátkém videu
      máte tři vteřiny. Stejná myšlenka, jiné podání.
  - q: "Jak udržím jednotný tón značky?"
    a: >-
      Nechte si stylový manuál destilovat z textů, které se povedly (a z těch, které
      zněly špatně) — konkrétní pravidla s citacemi, ne přídavná jména. Manuál pak
      uložte do trvalého kontextu Projektu, aby každá konverzace startovala se
      znalostí značky a vy nepsali „piš stručně, bez frází“ do každé zprávy.
  - q: "Co zkontrolovat před publikací?"
    a: >-
      Tři věci od nejdražší chyby: fakta (čísla, jména, tvrzení o konkurenci — model
      si věci vymýšlí sebejistě), tón a závazky (neslibujeme něco, co neumíme?)
      a formální věci. Zvlášť hlídejte zesilování tvrzení: z opatrného „bývá“
      v pilíři se v postu snadno stane „vždycky“ — a při běžném čtení si toho nikdo
      nevšimne.
  - q: "Smí automatizace sama publikovat na sítě?"
    a: >-
      Jen kusy, které už člověk schválil a naplánoval. Rozdíl mezi „nástroj
      v naplánovaný čas odešle schválený text“ a „nástroj si text sám vyrobí
      a odešle“ je rozdíl mezi pomocníkem a rizikem. Chyba v obsahu se neopravuje
      smazáním — už ji někdo viděl a udělal snímek obrazovky.
---
