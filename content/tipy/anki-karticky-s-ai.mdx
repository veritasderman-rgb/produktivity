...
excerpt: "Kompletní návod s prompty: proč rozložené opakování funguje, jak z vlastních poznámek a učebnice vyrobit kartičky, které se dají naučit, rozdíl mezi dobrou a mizernou kartičkou na ukázkách, cloze doplňovačky, obrázkové karty, mnemotechniky na míru a import do Anki přes CSV."
category: "ai"
platform: "vsude"
audience: ["student"]
keys: []
...
Číst si sešit počtvrté je nejpříjemnější a nejméně účinný způsob učení, jaký existuje. Cítíte se u toho chytře — text je povědomý, všechno dává smysl — a druhý den u tabule zjistíte, že povědomost a znalost jsou dvě různé věci. Kartičky tenhle podvod na sobě samém ruší: buď si vzpomenete, nebo ne, a je to vidět hned.
...
Nejčastější způsob, jak si kartičky znechutit: naimportovat naráz osm set karet a druhý den zjistit, že opakování zabralo hodinu a půl. Orientační pravidlo: **za každou novou kartičku denně počítejte v ustáleném provozu zhruba osm až deset opakování denně.** Dvacet nových denně se tedy po pár týdnech ustálí kolem sto padesáti až dvou set karet k odbavení, což je při dobře napsaných kartičkách dvacet až třicet minut. Padesát nových denně už je hodina denně a to nikdo dlouhodobě nedělá.

Než začnete sypat karty do balíčku, nechte si spočítat, co vám vyjde:
...
Vrátí rozpočet v minutách a obvykle nepříjemné zjištění, že jste chtěli začít pozdě. Kontrolujte jednu věc: odhad počtu kartiček z rozsahu látky bývá střelba od boku — po první kapitole, kterou zpracujete doopravdy, si přepočítejte zbytek podle skutečnosti.
...
Na tuhle kartičku neexistuje odpověď, kterou byste si mohli vybavit — je to odstavec. Otočíte ji, přečtete, kývnete a nenaučíte se nic. Navíc při každém opakování strávíte třicet sekund čtením věcí, které dávno umíte.
...
Šest karet místo jedné. Zní to jako víc práce, ale odbavíte je za třicet sekund dohromady a přesně vidíte, která z nich vám nejde. **Jedna kartička = jedna informace.** Tomu se říká atomičnost a je to nejdůležitější pravidlo v celé této oblasti.
...
Kartička „Rok 1348? → založení Univerzity Karlovy" vypadá v pořádku, ale trénuje jen rozpoznávání letopočtu. U testu ale potřebujete opačný směr: vidíte otázku na univerzitu a musíte si vybavit rok. Formulujte kartičky **ve směru, ve kterém je budete potřebovat** — a když potřebujete oba směry, udělejte dvě karty (Anki na to má typ poznámky se dvěma směry, ale používejte ho vědomě, ne u všeho).

Aktivní formulace poznáte podle slovesa: „vyjmenuj", „napiš vzorec", „přelož", „urči", „spočítej" jsou lepší začátky než „co je" a „popiš".
...
Sedmiprvkový seznam si nikdy nevybavíte celý, takže kartičku budete pořád hodnotit jako neúspěch a Anki vám ji bude cpát pořád dokola. Seznamy se učí jinak: přes cloze doplňovačky (fáze 4), přes vazbu na jednotlivé prvky („Který přemyslovský král získal titul krále dědičně?") nebo přes mnemotechniku, která seznam zabalí do jedné věty.
...
Vrátí seznam, ze kterého bývá polovina k přepsání — u prvního balíčku je to normální. Pozor na jednu věc: rozdělování občas přežene a z jedné rozumné karty udělá pět triviálních. Karty, jejichž odpověď je „ano" nebo úplně zřejmá, rovnou smažte.

## Fáze 3: kartičky z vlastních poznámek a z učebnice

### Základní generátor: ze zápisu do balíčku

Tohle je prompt, který budete používat nejčastěji. Uložte si ho do [knihovny promptů](/tipy/ai-knihovna-promptu) nebo do projektu, ať ho nepíšete znovu.
...
Vrátí patnáct až třicet karet z jedné kapitoly. **Poslední blok promptu nepřeskakujte** — seznam vynechaného je nejcennější část výstupu, protože upozorní na místa, která se z kartiček naučit nedají (souvislosti, příčiny, procesy) a potřebují jiný přístup, typicky si je [nechat vysvětlit](/tipy/ai-vysvetleni-latky) a pak vyprávět nahlas vlastními slovy.

A tvrdé pravidlo, které z tohoto workflow nelze vypustit: **vygenerované kartičky projděte řádek po řádku, než je naimportujete.** Není to formalita. Za prvé model občas doplní tvrzení, které v zápisu nebylo, a naučit se nesmysl je horší než neučit se nic. Za druhé — a to je důležitější — tahle kontrola je učení sama o sobě. Uvidíte, které otázce nerozumíte, ještě než ji začnete drtit.

### Z fotky sešitu nebo učebnice

Skenování zvládne mobil a modely čtou i rukopis, včetně vlastního nečitelného. Postup: vyfoťte stránky rovně a při dobrém světle (víc v tipu [skenujte telefonem](/tipy/skenujte-telefonem)), nahrajte do chatu a přidejte prompt.
...
Cloze je typ kartičky, kde se z věty vymaže jedno slovo a vy ho doplňujete. Hodí se přesně tam, kde otázka a odpověď zní křečovitě: u definic, vzorců, letopočtů v souvislosti a hlavně u seznamů, které se nedají vybavit najednou.

V Anki se cloze zapisuje značkou uvnitř věty a jedna věta může nést víc mazání — každé se pak stane samostatnou kartičkou:
...
Vrátí hotové řádky k importu. Zkontrolujte, jestli po zakrytí zbytek věty odpověď neprozrazuje — typicky když ve větě zůstane synonymum vymazaného slova.

### Obrázkové karty: schémata, mapy, grafy

Biologie, zeměpis a chemie se z textu učí špatně, protože zkouší obrázek: popiš stavbu buňky, ukaž pohoří, poznej vzorec. Nejsilnější technika se jmenuje **zakrývání obrázku** (image occlusion) — na schéma se položí obdélníčky přes popisky a kartička po vás chce, co je pod nimi. Anki to umí v novějších verzích rovnou, u starších přes doplněk.

AI vám obrázek nezakryje, ale udělá druhou půlku práce: rozebere schéma na seznam popisků a otázek a řekne, co má smysl zakrývat.
...
Vrátí tři varianty, ze kterých jedna obvykle sedne. Kontrola je nutná u akronymů: modely se občas spletou v písmenech a vyrobí větu, která pořadí nesedí — projděte si to písmeno po písmenu. A pozor na past: mnemotechnika je berlička na seznam, ne náhrada porozumění. Pořadí planet si zapamatujete, ale proč jsou vnitřní planety kamenné, se z věty nedozvíte.
...
Vrátí obsah, který zkopírujete do textového editoru a uložíte. Před importem projeďte očima poslední kontrolu: počet řádků odpovídá počtu karet a žádný řádek nemá dva středníky.
...
Rozložené opakování na čtyři dny nefunguje tak, jak má — ale kartičky pořád zůstávají nejlepší způsob, jak zjistit, co neumíte, a nemarnit čas tím, co umíte. Nastavení se ale liší od dlouhodobého provozu.

Prakticky: vyrobte karty jen na to, co se v testu skutečně objeví (podle okruhů, ne podle celé učebnice), zvedněte denní limit nových karet tak, abyste je stihli zavést do dvou dnů, a zbytek času jeďte opakování. V Anki se hodí funkce vlastního studia nebo filtrovaný balíček, který vytáhne karty k procvičení mimo běžný rozvrh. A **den před testem se učte jen karty, které vám padají** — na zbytek nesahejte.
...
Vrátí plán na čtyři dny, včetně nepříjemné, ale správné rady, co obětovat. Poslední odstavec je tam proto, že kartičky svádí k jedinému způsobu učení — a když test obsahuje výpočet nebo otevřenou otázku, samotné kartičky vás nezachrání.
...
- **Anki** — samotné rozložené opakování: zdarma na počítači, bezplatná synchronizace přes AnkiWeb, mobilní verze pro učení cestou. Umí cloze i zakrývání obrázků.
- **Claude** — generování a hlavně audit kartiček z vašich poznámek, čtení fotek sešitu včetně rukopisu, mnemotechniky a rozbor karet, které pořád padají. Uložený prompt v projektu ušetří psaní.
...
- **Textový editor s UTF-8** — poznámkový blok, VS Code, cokoli, co umí uložit soubor v UTF-8; jediný krok mezi výstupem AI a importem do Anki.
...
Až budete mít balíček rozjetý, přidejte si k němu jeden zvyk, který stojí dvě minuty a vytáhne z kartiček dvojnásobek: **po každém opakování si vezměte tři karty, které vám dneska padly, a nahlas vysvětlete, proč je odpověď taková.** Ne odpověď — důvod. Kartička testuje, jestli fakt máte v hlavě; vysvětlení odhalí, jestli mu rozumíte, a přesně to se ptají u zkoušení a v otevřených otázkách. Když vysvětlení nedáte dohromady, máte téma na příští [vysvětlení látky s AI](/tipy/ai-vysvetleni-latky).
