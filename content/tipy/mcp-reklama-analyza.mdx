...
updated: "2026-08-13"
tldr: >-
  Dva oficiální konektory bez programování: MCP server Mety (mcp.facebook.com/ads)
  napojí AI na reklamní účet a lokální open source server od týmu Google Analytics na
  návštěvnost webu. Model si čísla vytáhne sám — aktuální, za zadané období — a teprve
  nad nimi přemýšlí; nejcennější pohled vznikne spojením obou stran. Skutečné limity
  rozpočtu patří na platformu, ne do promptu, a změny v účtu potvrzuje vždy člověk.
faq:
  - q: "Potřebuju kvůli Meta konektoru vývojářskou aplikaci?"
    a: >-
      Ne. K MCP serveru Mety se přihlašujete přes svůj běžný účet Meta Business
      obyčejným přihlašovacím oknem — nezakládáte vývojářskou aplikaci a neprocházíte
      App Review. Odsouhlasíte, k jakému reklamnímu účtu má nástroj přístup, a když
      chcete skončit, odeberete konektor a odvoláte oprávnění v nastavení Business
      účtu.
  - q: "Existuje oficiální MCP server pro Google Analytics?"
    a: >-
      Ano, vydává ho přímo tým Google Analytics jako open source pod licencí Apache
      2.0. Má tři vlastnosti, které je třeba znát: je experimentální (nemá na něm
      viset nic kritického), je lokální (běží na vašem počítači, takže nikomu novému
      nedáváte přístup k datům) a je jen pro čtení — nic v GA4 nepřenastaví ani
      nesmaže.
  - q: "Proč nesedí čísla z reklamního účtu a z Analytics?"
    a: >-
      Nikdy sedět nebudou a je chyba to po AI chtít. Důvody jsou strukturální:
      rozdílná atribuce, rozdílná časová okna a blokování měření na straně
      návštěvníků. Praktický důsledek: v každém nástroji sledujte trend uvnitř toho
      nástroje a mezi nástroji porovnávejte pořadí kampaní, ne hodnoty.
  - q: "Stačí napsat limit rozpočtu do promptu?"
    a: >-
      Ne — instrukce v promptu je pravidlo, nastavení na platformě zámek. Skutečný
      limit nastavíte ve správci reklam: strop útraty účtu, limity rozpočtu kampaní
      a omezení práv uživatele, pod kterým je konektor přihlášený. Model se může
      splést a jediné, co v tu chvíli zabrání škodě, je zábrana mimo něj.
  - q: "Smí model sám měnit rozpočty nebo zapínat kampaně?"
    a: >-
      Ne. Model smí číst, počítat a psát doporučení; zvednout rozpočet nebo zapnout
      kampaň smí jedině člověk. Nikdy nezapínejte režim, ve kterém se změny provedou
      bez ptaní — a hromadné operace dělejte skriptem, kde je vidět celý seznam
      najednou, protože po dvacátém dialogu člověk odklikává automaticky.
  - q: "Jak z jednorázových otázek udělat měsíční report?"
    a: >-
      Konverzace není reprodukovatelná — model může příště vzít jiné období nebo
      metriky a vy porovnáváte nesrovnatelné reporty. Postup má tři stupně:
      zafixovaný prompt se šablonou do posledního detailu, pak skript, který data
      stahuje pokaždé stejně (stroj počítá, model vysvětluje), a nakonec plánovaná
      rutina, která podklad připraví sama.
---
