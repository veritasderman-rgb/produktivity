...
excerpt: "Kompletní návod s prompty: tři úrovně asistence (našeptávač, chat, agent) a kdy kterou, jak nastavit kontext projektu, testy a refaktoring, orientace v cizí codebase, review vygenerovaného kódu a mantinely pro agentní režim. Odpovědnost za kód zůstává vaše."
category: "ai"
platform: "vsude"
audience: ["vyvojar"]
keys: []
