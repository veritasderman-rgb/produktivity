...
updated: "2026-08-12"
tldr: >-
  Většina otázek nováčka v prvních týdnech má odpověď, která už je někde napsaná —
  jen ji nikdo neumí najít. Projekt v AI s nahranými postupy a instrukcí „odpovídej
  jen z dokumentů, při nejistotě odkaž na člověka“ ji zpřístupní kdykoli a bez
  ostychu. Postaví se za odpoledne z toho, co existuje (nic nového se nepíše),
  a nejcennější vedlejší produkt je seznam otázek bez odpovědi — přesný audit toho,
  co ve firmě žije jen v hlavách lidí.
faq:
  - q: "Musím kvůli Projektu sepsat novou dokumentaci?"
    a: >-
      Ne — zásada je nepsat nic nového. Nahrajte, co existuje, i když je to neúplné:
      postupy, wiki, šablony, FAQ z týmového chatu, organigram a slovník interních
      zkratek. Mezery vám ukáže sám provoz — otázky, na které Projekt neuměl
      odpovědět, jsou nejlevnější audit dokumentace, jaký kdy získáte.
  - q: "Co do onboardingového Projektu nesmí?"
    a: >-
      Jen ta část dokumentace, kterou by nováčkovi kdokoli z týmu bez váhání ukázal
      — ven jdou mzdy, hodnocení lidí, obchodní tajemství nad rámec role a osobní
      údaje klientů. Pozor na skryté záložky tabulek (ceník s listem marží) a veďte
      Projekt na firemním účtu se smluvní ochranou dat, ne v soukromém účtu
      vedoucího — jinak odejde s ním.
  - q: "Jak zabráním tomu, aby si AI chybějící postup domyslela?"
    a: >-
      Instrukcí, která je jádrem celé věci: odpovídej výhradně z nahraných
      dokumentů, u každé odpovědi uveď zdroj, a když odpověď v podkladech není,
      řekni to výslovně a odkaž na konkrétního člověka. Před předáním to otestujte
      otázkou, na kterou odpověď v dokumentech není — když dostanete věcnou odpověď
      místo přiznání, instrukce nefungují.
  - q: "Nevyzní to jako odbytí nováčka robotem?"
    a: >-
      Rozhoduje formulace: „založil jsem ti Projekt, ptej se ho na cokoli, i popáté
      na totéž — a když ti neodpoví, přijď a doplníme to“ dává nástroj navíc, ne
      bariéru. Zároveň vymezte, na co se ptát lidí: kontext, důvody, rozhodování
      a vše, co v dokumentech není. Cíl není nula otázek na kolegy, ale posun
      k „proč“.
  - q: "Jak často Projekt aktualizovat?"
    a: >-
      Kvartální revize, patnáct až třicet minut, pevně v kalendáři. Zastaralý
      Projekt je horší než žádný — odpovídá loňskou pravdou a nováček to nemá jak
      poznat. Pomáhají tři návyky: datum platnosti v názvu dokumentu, jedna verze
      místo tří a vlastník na každý dokument.
  - q: "Může nováček podle odpovědi z Projektu rovnou schválit slevu?"
    a: >-
      Ne — Projekt odpovídá, člověk rozhoduje. Slevy, výjimky, smlouvy a cokoli
      s právním nebo finančním dopadem schvaluje člověk podle schvalovací matice,
      ne odpověď z chatu. Nástroj, který zrychlí zaučení, nesmí zrušit kontrolní
      body.
---
