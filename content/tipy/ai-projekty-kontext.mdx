...
excerpt: "Kompletní návod s prompty: co do Projektu nahrát, jak psát projektové instrukce, kdy založit nový projekt a jak ten stávající udržovat, aby nelhal."
category: "ai"
platform: "vsude"
...
tested: "2026-08-27"
tldr: >-
  Projekt je prostor, ve kterém žijí trvalé instrukce, nahrané podklady a všechny konverzace k jednomu tématu — kontext přestává být něco, co píšete, a stává se něčím, co máte. Návod vede od auditu podkladů přes stylové listy a terminologické slovníky po instrukce s pravidlem „chybí podklad", které brání vymýšlení faktů. Klíčové rozhodovací pravidlo: co říkáte potřetí, patří o úroveň výš.
faq:
  - q: >-
      Kdy se projekt vyplatí a kdy je zbytečný?
    a: >-
      Vyplatí se, když platí dvě podmínky zároveň: k tématu se budete vracet (aspoň jednou týdně po dobu měsíců) a existuje kontext, který se nemění — dokumenty, pravidla, styl. Na jednorázovou rešerši nebo jeden e-mail otevřete obyčejnou konverzaci a nechte ji zemřít.
  - q: >-
      Co patří do projektu a co do globálních instrukcí?
    a: >-
      Globální instrukce = já: jazyk, délka odpovědí, profese, co nechci nikdy — platí bez ohledu na téma. Instrukce projektu = tahle práce: role modelu, pravidla domény, formát, zdroje. Pomůcka: řeknu to potřetí? Patří to o úroveň výš. Globální pravidla do projektu neopisujte — duplicita je zdroj konfliktu.
  - q: >-
      Odpovídá model jen z nahraných podkladů?
    a: >-
      Ne — kombinuje je s obecnými znalostmi a hranice není vidět. Proto do instrukcí patří pravidlo „zdroje pravdy": fakta ber výhradně z podkladů, a když odpověď v podkladech není, napiš CHYBÍ PODKLAD místo odhadu. Nástroj, který odpovídá skutečně jen z nahraných zdrojů, je NotebookLM (Google ho v červenci 2026 přejmenoval na Gemini Notebook, princip zůstal stejný).
  - q: >-
      Můžu do projektu nahrát smlouvy a osobní údaje?
    a: >-
      Jen to, co tam podle smlouvy s klientem jít smí. Citlivé věci — osobní údaje, mzdy, neveřejné výsledky — patří jen do placeného účtu se smluvní ochranou dat, a i tam anonymizovaně: jména nahraďte rolemi, odstraňte kontakty a čísla smluv. Anonymizovanou verzi zkontrolujte očima, modely přehlédnou údaj v tabulce nebo patičce.
  - q: >-
      Pomůže, když do projektu nahraju co nejvíc souborů?
    a: >-
      Naopak — víc podkladů neznamená lepší odpovědi. Od určitého objemu kvalita klesá, protože relevantní pasáž se ztratí mezi balastem, a při přiblížení ke stropu velikosti projekt tiše pracuje jen s částí materiálu. Vybírejte jako podklady pro nového kolegu na první den, ne jako archiv.
  - q: >-
      Kdy mám založit nový projekt místo přidávání do stávajícího?
    a: >-
      Když si kontexty odporují (dva klienti s vylučujícími se pravidly — nejsilnější důvod), když by instrukce musely obsahovat podmínky „u klienta A jinak", nebo když se podklady překrývají názvem. Nedělte ale podle času ani jednotlivých úkolů — vzniknou desítky mrtvých prostorů.
---
...
- **Vlastní GPT** — pro jeden úzký účel se sdílením dalším lidem (třeba kontrola smluv podle firemních pravidel), ne pro širokou agendu. Od srpna 2026 smí nové vlastní GPT založit jen firemní účet (Business/Enterprise/Edu) — v osobním plánu (Free/Plus/Pro) jde jen používat a upravovat ty, které už existují.
- **NotebookLM (dnes Gemini Notebook)** — když potřebujete jistotu, že odpověď pochází výhradně z nahraných zdrojů, s odkazem na pasáž; doplněk projektů, ne náhrada.
