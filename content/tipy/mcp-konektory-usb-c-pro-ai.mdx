...
excerpt: "Kompletní návod s prompty: co je MCP a proč je to USB-C pro AI, jak připojit poštu, kalendář či Notion a jak nastavit oprávnění podle nejmenších práv."
category: "ai"
platform: "vsude"
audience: ["vyvojar"]
keys: []
...
updated: "2026-08-12"
tldr: >-
  MCP je otevřený standard, který funguje jako USB-C pro AI: jednou zapojíte konektor
  a asistent vidí přímo do pošty, kalendáře, Notionu či Drivu — konec kopírování dat
  sem a tam. Postupuje se po jednom konektoru, první týden jen čtení, oprávnění podle
  principu nejmenších práv. Konektor je oprávnění číst a připravovat, ne odesílat
  a platit — akce s následkem navenek schvaluje vždy člověk.
faq:
  - q: "Znamená konektor, že AI má přístup ke všem mým datům?"
    a: >-
      Ne. Model si nesahá kam chce — může jen to, co konektor nabízí a co jste
      povolili, a běží pod vaším účtem a oprávněním, takže nevidí víc než vy.
      Konektor si navíc data vyžádá až ve chvíli, kdy je potřebuje k odpovědi;
      nestahuje si vaši poštu na hromadu dopředu.
  - q: "Jak mám nastavit oprávnění konektoru?"
    a: >-
      Podle principu nejmenších práv: čtení místo zápisu, kdykoli to stačí, užší
      rozsah místo širšího (jedna složka, ne celý disk), pracovní účet pro pracovní
      věci a žádné oprávnění „pro jistotu“. Osvědčený postup: jeden konektor na
      začátek, týden jen čtení, pak teprve zápis — a další konektor až potom.
  - q: "Může asistenta ovlivnit text, který přečte v poště nebo dokumentu?"
    a: >-
      Ano — to je riziko, o kterém se skoro nemluví. Zpráva se schovanou instrukcí
      může asistenta ovlivnit, protože mezi vaším zadáním a přečteným obsahem
      nerozlišuje dost spolehlivě. Obrana: akce s následkem navenek schvaluje člověk.
      S právem jen číst je nejhorší výsledek divná odpověď; s právem odesílat je to
      jiný příběh.
  - q: "Smí rutina, která běží bez dozoru, něco odesílat?"
    a: >-
      Ne — rutina končí podkladem nebo konceptem, ne akcí. Připraví shrnutí, koncept
      odpovědi nebo upozornění; odeslání, potvrzení a platbu dělá člověk. A dovolte
      jí výslovně napsat „tenhle týden nic“: rutina, která má něco najít, má jinak
      tendenci něco najít vždycky, i když se nic nestalo.
  - q: "Kdy se firmě vyplatí vlastní MCP server?"
    a: >-
      Když jsou data v systému bez hotového konektoru a lidé z něj pravidelně
      kopírují, když se na ně opakovaně ptá hodně lidí, když se odpověď dá získat
      spolehlivě, když to ušetří víc než pár minut denně — a když existuje vlastník,
      který server udrží při změnách systému. Nejnáročnější není programování, ale
      sepsat, na co se má server umět ptát.
  - q: "Jak poznám, že odpověď z konektorů není vymyšlená?"
    a: >-
      Chtějte ke každému tvrzení zdroj — odkaz nebo název dokumentu. Bez toho
      neodlišíte, co asistent skutečně našel, od toho, co doplnil. Když odpověď
      nesedí, nechte si popsat postup: které konektory použil, co v nich hledal
      a které tvrzení je z dat a které jeho závěr.
---
