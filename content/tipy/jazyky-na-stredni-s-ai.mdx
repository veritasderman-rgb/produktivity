...
updated: "2026-08-12"
tldr: >-
  AI je jazykový parťák, se kterým můžete mluvit kdykoli a který se nikdy neušklíbne
  nad chybou — zaplňuje přesně to, co ve škole chybí: nálet mluvení a okamžitou opravu
  vlastních textů. Klíčem je jednou nastavit úroveň a pravidlo „neopravuj během řeči,
  rozbor až po rozhovoru“, mluvit ve scénkách místo volného povídání a slohy psát sám
  a nechat si je jen opravit a vysvětlit. Patnáct minut denně porazí hodinu jednou týdně.
faq:
  - q: "Proč mě AI nemá opravovat během rozhovoru?"
    a: >-
      Opravování během řeči vede k tomu, že přemýšlíte o gramatice místo o obsahu,
      mluvíte pomaleji a nakonec radši mlčíte. Cílem konverzace je plynulost; přesnost
      se řeší potom, na klidno, v rozboru po rozhovoru. Mluvení a rozbor jsou dvě
      různé činnosti — kdo je slučuje, dělá obojí špatně.
  - q: "Můžu si nechat od AI napsat sloh?"
    a: >-
      Ne — je to nejrychlejší cesta k tomu, že u maturity odevzdáte text o dvě úrovně
      horší, než co jste dosud „psali“. Opravená vlastní věta učí, cizí hotový text
      neučí nic. Text napíšete sami a AI ho opraví a vysvětlí, ale nesmí ho přepsat —
      a to musí být v promptu napsané výslovně.
  - q: "Jak se učit slovíčka, aby v neděli nebyla pryč?"
    a: >-
      Sloupeček „slovo — překlad“ se naučíte na páteční test a pak zmizí, protože
      slovo bez kontextu nemá na co se navázat. Funguje opak: slovo v celé větě,
      ideálně takové, která se týká vás — jazyk se ukládá po frázích. Nejlepší zdroj
      jsou slova, která vám chyběla ve vlastní konverzaci.
  - q: "Umí AI ohodnotit moji výslovnost?"
    a: >-
      Nespolehlivě — hlasový režim řeč nejdřív převede na text a posuzuje přepis, ne
      zvuk. Užitečný je ale opačný signál: když se v přepisu opakovaně objevuje jiné
      slovo, než říkáte, vyslovujete ho tak, že vám nerozumí ani stroj. Na výslovnost
      používejte nahrávky rodilých mluvčích a shadowing.
  - q: "Stačí trénovat poslech na hlasu AI?"
    a: >-
      Ne. Syntetický hlas mluví pomaleji a čistěji, než jak mluví lidé — kdo trénuje
      jen na něm, dostane u zkoušky nepříjemné překvapení. Poslech trénujte na
      podcastech, seriálech a videích; AI se hodí jako příprava před poslechem
      a rozbor po něm.
  - q: "Nahradí mi AI učitele nebo doučování?"
    a: >-
      Nenahradí živého partnera, pobyt mezi rodilými mluvčími ani učitele, který vás
      zná a ví, co u vás vázne. Je to trenažér mezi hodinami — zvládne opravy textů,
      procvičování a konverzaci, takže se živý učitel může věnovat tomu, co stroj
      neumí.
---
