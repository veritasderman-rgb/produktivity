...
**Hlídač státu** tahle data sbírá, čistí a propojuje — a má MCP server, rozhraní, přes které si je asistent umí číst sám. Místo klikání po rejstřících vedete rozhovor: název firmy, IČO, série dotazů, propojení. Připojení je otázka pár minut a podrobně ho řeší [prověrka obchodního partnera přes Hlídač státu](/tipy/proverka-obchodniho-partnera-hlidac-statu) — ten návod je psaný z firemního úhlu, ale technická část platí beze zbytku; obecně o konektorech je [přehled MCP konektorů](/tipy/mcp-konektory-nastroje). Novinářský úhel rozebírá samostatný text [Hlídač státu pro novináře](/tipy/hlidac-statu-pro-novinare).
...
Poslední krok před odesláním a jediný, kde je pokušení nechat model „to trochu vylepšit“ nejnebezpečnější. Korektura znamená opravit pravopis a nechat text na pokoji. Jak prompt formulovat, aby model neupravoval styl, řeší [oprav jen pravopis](/tipy/ai-oprav-jen-pravopis); české typografické zvyklosti rozebírá [česká typografie](/tipy/ai-ceska-typografie). Pro redakci se vyplatí přidat vrstvu, která se v běžné korektuře nedělá:
...
Body 3 a 4 jsou to, kvůli čemu tenhle prompt v redakci stojí za víc než obyčejná korektura. Nekonzistentní číslo mezi perexem a třetím odstavcem je nejčastější chyba textů psaných pod tlakem a při vlastním čtení se přehlédne skoro vždycky. Bod 4 je jen upozorňovač, ne právní posudek — ten dělá člověk, u citlivých textů právník. Tvrdší oponenturu než korekturu má postup [AI jako oponent](/tipy/ai-oponent): necháte model napadnout vlastní text z pozice protistrany. Před vydáním investigativy je to půlhodina, která se vyplatí.
...
Podrobný postup i s vlastními šablonami pro jednotlivé sítě má [z článku příspěvky na sítě](/tipy/z-clanku-prispevky-na-site); marketingový pohled na výrobu obsahu ve velkém [obsahová továrna](/tipy/obsahova-tovarna-ai) — v redakci ale platí přísnější pravidla.
...
Novinář má ráno tři zdroje: poštu, kalendář a to, co se přes noc stalo v jeho tématech. Sestavit z toho jeden přehled je práce pro plánovanou úlohu, která se spustí sama před vaším příchodem. Nastavení včetně napojení na poštu a kalendář má [ranní brief s Claude](/tipy/claude-ranni-brief-navod) a [rutiny nad poštou a kalendářem](/tipy/claude-rutiny-posta-kalendar).
