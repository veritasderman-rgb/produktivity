...
excerpt: "Kompletní návod s prompty: jak napojit AI na Notion nebo složku s poznámkami, jak se ptát vlastními slovy, jaká minimální hygiena zápisků musí platit, aby vyhledávání fungovalo — a jak si archiv každý týden sám doplňovat."
category: "ai"
platform: "vsude"
...
Kde jsou v poznámkách citlivé věci — osobní údaje, zdravotní informace, obchodní tajemství — pracujte s nimi **jen v placeném nebo firemním účtu se smluvní ochranou dat**, ne ve volně dostupném chatu. A i tam platí, že co se nemusí zpřístupnit, se nezpřístupňuje. Oprávnění udělujete vy a můžete je kdykoli odebrat; dejte si do kalendáře jednou za kvartál pět minut na kontrolu, co všechno je připojené.
...
Nejpohodlnější varianta. Konektor je standardizované propojení (Claude je má pro Gmail, Kalendář, Drive, Notion, Slack a další), kde udělíte oprávnění a AI vidí do vašeho prostoru přímo — nic nekopírujete, nic nenahráváte, a když poznámku změníte, další odpověď už pracuje s novou verzí. Jak konektory fungují obecně, rozebírá tip [MCP konektory](/tipy/mcp-konektory-usb-c-pro-ai).

Postup je nudný a to je dobře: v nastavení připojíte Notion, přihlásíte se, vyberete stránky nebo prostor, ke kterým dáváte přístup, a potvrdíte. Vybírejte úzce — v tomhle dialogu se rozhoduje o tom, jestli vám za měsíc AI ukáže někomu zápis z osobní schůzky.
...
Vrátí podklad, se kterým jdete na schůzku připravení. Poslední řádek promptu — rozlišení faktu a dojmu — je tam schválně: v poznámkách je obojí promíchané a v shrnutí se z „přišlo mi, že se jim to nelíbí“ snadno stane „nelíbilo se jim to“. Na navazující přípravu se hodí tip [příprava na jednání](/tipy/ai-priprava-na-jednani).
...
Vzájemné odkazování pomáhá i tady: propojené poznámky dávají odpovědi kontext, který v jednotlivém souboru není. V Obsidianu na to jsou [dvojité závorky](/tipy/obsidian-dvojite-zavorky), v Notionu [propojené pohledy](/tipy/notion-propojene-pohledy).
...
Vrátí sadu hotových poznámek, které projdete, upravíte a vložíte. Klíčové je poslední slovo: **nic neukládá samo.** Automatické zakládání poznámek zní pohodlně, ale rychle vám zaplevelí archiv obsahem, který jste nikdy nečetli — a nedůvěryhodný archiv je horší než žádný. Filtr „vynech jednorázové věci“ je stejně důležitý: bez něj dostanete padesát poznámek týdně a přestanete to dělat.

Podobná rutina se dá postavit i nad zápisy z porad a e-maily; postup popisuje [týdenní přehled s AI](/tipy/ai-tydenni-prehled) a pro pravidelné spouštění se hodí plánované úlohy — AI pustí destilaci sama v pátek odpoledne a vy jen ráno projdete návrh, jak popisuje tip [rutiny nad poštou a kalendářem](/tipy/claude-rutiny-posta-kalendar).
...
Bod 2 odhalí nejzajímavější díry: poznámky se často odvolávají na dohodu, která nikdy nebyla nikde zapsaná. Bod 3 je zase přímý vstup do dokumentace procesů — postup, který děláte poosmé a nemáte ho popsaný, je kandidát na [checklist opakovaného procesu](/tipy/checklisty-opakovanych-procesu).
...
- **Čas:** půlhodinové hledání ve vlastním archivu prostě zmizí — odpověď přijde dřív, než byste otevřeli druhou záložku. Při třech takových hledáních měsíčně jsou to zhruba dvě hodiny, které jste dosud trávili listováním.
- **Peníze:** roky zápisků konečně začnou vydělávat. Dosud to byl náklad (čas na psaní bez návratnosti), teď je to zdroj — a k tomu se nepočítá práce, kterou neuděláte podruhé, protože zjistíte, že už ji máte hotovou.
- **Klid:** psaní poznámek přestane mít příchuť zbytečnosti. Víte, že se k nim dostanete, takže je píšete radši a líp — a nemusíte si v hlavě držet, kde co je.
- **Kvalita:** nezapomínáte, proč jste se rozhodli, jak jste se rozhodli. V jednáních s klienty a v týmových sporech je doložené rozhodnutí i s datem a důvodem rozdíl mezi dohadem a faktem.
