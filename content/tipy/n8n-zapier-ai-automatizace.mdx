...
excerpt: "Kompletní návod s prompty: kdy stačí rutina v Claude a kdy potřebujete n8n, Zapier nebo Make, tři hotové scénáře krok za krokem a ošetření chyb."
category: "ai"
platform: "vsude"
...
updated: "2026-08-12"
tldr: >-
  První AI automatizace bez programování: AI není celý automat, ale jeden krok
  uprostřed — něco scénář spustí (trigger), model z toho vytáhne nebo napíše
  strukturovaný výstup a výsledek skončí v tabulce, CRM nebo ve složce Koncepty. Návod
  rozhoduje, kdy stačí rutina v Claude a kdy potřebujete Zapier, Make či n8n, ukazuje
  tři hotové scénáře a ošetření chyb. Automat smí připravit cokoli, poslední kliknutí
  zůstává vaše.
faq:
  ...
  - q: "Proč se prompt v AI kroku píše jinak než v chatu?"
    a: >-
      Protože ho neuvidíte selhat, nemůžete se doptat a výstup čte stroj, ne člověk.
      Platí pět pravidel: jeden krok, jeden úkol; pevný výstupní formát (JSON
      s vyjmenovanými klíči); výslovný zákaz domýšlení s hodnotou „neuvedeno“;
      uzavřené číselníky místo volných kategorií; a ukázka vstupu i výstupu přímo
      v promptu.
  ...
  - q: "Jak poznám, že se scénář tiše rozbil?"
    a: >-
      ...
      upozornění denně. A jednou měsíčně pusťte umělý test: je to jediný způsob, jak
      rozlišit „nic se nestalo“ od „scénář týden neběžel“.
  - q: "Co když model vrátí platný, ale nesmyslný výstup?"
    a: >-
      To je nejzákeřnější selhání, protože scénář proběhne jako úspěšný. Obrana je
      kontrola rozumnosti před zápisem: rozpočet mimo očekávaný rozsah, datum
      v minulosti, kategorie mimo číselník nebo prázdné povinné pole ať vede na
      ruční frontu, ne do CRM.
