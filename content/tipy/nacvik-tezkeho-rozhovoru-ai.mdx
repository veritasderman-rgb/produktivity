...
Nejčastější důvod, proč nácvik nikam nevede, je start bez ujasněné pozice. Když nevíte, co přesně chcete a kde je vaše hranice, simulace se zvrhne v povídání a vy z ní vyjdete stejně nejistí, jen unavenější. Deset minut přípravy před prvním kolem zvedne užitek celého večera víc než tři kola nácviku navíc.
...
**Co udělám, když nedostanu nic.** Nejnepříjemnější otázka a zároveň jediná, která vám dá v rozhovoru klid. Odpověď může být „zůstanu a vrátím se k tomu v červnu", může být „začnu se dívat po jiné práci" — ale musí existovat. Kdo nemá odpověď na tuhle otázku, mluví z pozice prosby.

Tohle si můžete napsat sami na papír. Když se zaseknete, hodí se nechat si pozici rozebrat — hlavně proto, že model se doptá na věci, které sami sobě neřeknete.
...
Vrátí mapu pozice, ve které je nejcennější bod 2 — otázky, na které nemáte odpověď, jsou přesně místa, kde vás rozhovor rozhodí. Pozor na bod 3: model odhaduje motivaci člověka, kterého nezná, takže s ním zacházejte jako s hypotézou, ne s faktem. Když napíše „vašeho šéfa nejspíš tlačí rozpočet", je to námět k ověření, ne informace.

### Fakta a anonymizace

Nácvik má trénovat formulace, ne dohledávání čísel. Než začnete, mějte po ruce: co jste za sledované období dodali, jaká čísla to má, jaké termíny se posunuly a co o tom existuje písemně. Bez podkladů se z nácviku stane cvičení v obecných frázích — a přesně to u skutečné schůzky uslyšíte jako „to zní hezky, ale konkrétně?".

Do popisu scénáře přitom nepatří celá jména, konkrétní klienti, přesné mzdy ani zdravotní a rodinné detaily kolegů. Nahraďte je rolemi a intervaly: „kolega z obchodu", „klient, roční objem kolem [X] tisíc", „plat kolem [rozmezí]". Simulace tím neztratí nic — protistrana potřebuje vědět, že jde o peníze a zhruba o kolik, ne částku na koruny.
...
Zadání píšete jako režisér, ne jako tazatel. Popíšete postavu, prostředí, pravidla hry a teprve pak spustíte. Osvědčená kostra vypadá takhle.
...
Tenhle mikroprompt používejte klidně třikrát za rozhovor. Je to nejrychlejší způsob, jak udržet obtížnost, a zároveň si díky němu uvědomíte, kde přesně vám protistrana „ustoupila zadarmo" — bývá to místo, kde váš argument ve skutečnosti nebyl silný, jen slušně řečený. Pomáhá i mít celé zadání uložené v [projektu s trvalým kontextem](/tipy/ai-projekty-kontext), abyste ho před každým kolem nepsali znovu.
...
„Pak bych vysvětlila důvody" není replika, je to plán. Napište přesně to, co byste řekli: „Chci mluvit o svém platu. Za poslední rok jsem převzala dva projekty navíc a chci se bavit o částce 65 000 od ledna." Rozdíl je zásadní — trénink má cenu jen tehdy, když formulace opravdu vyslovíte, protože právě ony vám pak vyjdou z pusy i na schůzce. Pokud se přistihnete, že píšete v podmiňovacím způsobu, přepište větu do oznamovacího a odešlete.

Piště krátce. Repliky delší než pět řádků v realitě neuslyší nikdo celé — a délka vašich vět v nácviku je sama o sobě diagnostika. Kdo si potřebuje na obhajobu své pozice napsat deset řádků, ten na schůzce mluví moc.
...
Kolo pokaždé pořádně ukončete, i když dopadlo špatně. Nácvik závěru je samostatná dovednost: „Rozumím, že dnes rozhodnutí nepadne. Domluvme se, že se k tomu vrátíme [termín], a do té doby vám pošlu [podklad]." Většina lidí trénuje otevření a zapomíná, že těžké rozhovory se prohrávají na konci, kde se nedomluví další krok.

### Když se zaseknete uprostřed

Nemusíte to vydržet. Zaseknutí je informace, ne selhání — a dá se z něj vytěžit víc než z hladkého průběhu.
...
Vrátí rozbor, který bývá nepříjemný a přesný. Nejužitečnější bývají body 4 a 5: fakta, která jste měli po ruce a nepoužili, a poměr „přínos versus snaha", který dobře odhalí, jestli mluvíte z pozice partnera, nebo prosebníka. Pozor na jednu věc — model občas oceňuje věty za to, že jsou zdvořilé, i když nic nepřinesly. Berte jeho pochvalu s rezervou a soustřeďte se na kritiku.
...
Bod 4 je důvod, proč prompt takhle vypadá: nejde o to sesbírat pět chytrých vět, ale o to jednu z nich několikrát vyslovit. Pravidlo pro výběr je jednoduché — vezměte variantu, která zní jako vy. Věta, kterou byste nikdy neřekli, vás na schůzce zradí, protože ji v napětí buď zapomenete, nebo pronesete tónem, který k ní nesedí.
...
Situace zůstává, mění se, kdo proti vám sedí. Vlídný šéf, který slibuje. Tvrdý, který blokuje. Mlčenlivý, který vás nechá mluvit, dokud si sami neublížíte — a to je varianta, kterou většina lidí nikdy netrénuje, přitom v praxi bolí nejvíc.
...
Nejcennější je pokyn o tichu. V realitě vzniká po nepříjemné otázce pauza a většina lidí ji zaplní tím, že si sama sníží požadavek. Když si to jednou odžijete nanečisto, podruhé už ticho vydržíte. Alternativa bez hlasového režimu: čtěte svoje repliky nahlas z obrazovky — je to méně, ale pořád mnohem víc než číst je očima.
...
Vrátí rozhovor, ve kterém narazíte na všechny čtyři standardní obrany za sebou. Připravte si předem odpověď hlavně na bod 3 — odsun je nejčastější reálný výsledek a většina lidí na něj nemá nic než „dobře". Dobrá reakce obsahuje termín a podmínku: „Rozumím. Domluvme se tedy na [datum] a na tom, co do té doby mám dodat, aby odpověď byla ano."
...
Vrátí rozhovor, ve kterém se ukáže, jestli umíte oddělit vztah od podmínek. Cíl kola není klienta porazit, ale odejít s pravidlem — „změny po odsouhlasení zadání jdou jako samostatná položka" — vysloveným nahlas a bez omluvy. Pokud vám z nácviku vyjde, že jste třikrát řekli „promiň", máte co trénovat.
...
Vrátí nejtěžší z těchhle rozhovorů. Trénujte jednu jedinou dovednost: sdělit rozhodnutí v prvních třiceti vteřinách, jasně a bez úvodu o počasí, a pak přejít k praktickým věcem. Každý argument navíc otevírá prostor k vyjednávání o něčem, o čem se nevyjednává. A pozor — tohle je oblast s právními dopady; nácvik řeší formulace a lidskou stránku, konkrétní podmínky ukončení konzultujte s personalistou nebo právníkem, ne s modelem.
...
Vrátí trojstranný rozhovor, který je náročný na vedení — a přesně proto se hodí zkusit si ho nanečisto. Sledujte u sebe, jestli jste dali prostor tichému člověku a jestli schůzka skončila konkrétním rozdělením odpovědnosti, ne obecnou dohodou „budeme spolu líp komunikovat". Závěrečné shrnutí za obě postavy je bonus, který od živých účastníků nikdy nedostanete.
...
Vrátí rozhovor, ve kterém trénujete hlavně jedno: vrátit se k tématu poté, co vás protistrana odvedla jinam. Formulace „k tomu se rád vrátím, ale nejdřív chci dokončit tohle" zní v hlavě snadno a nahlas se říká překvapivě těžko. Do zadání pište obecně a bez identifikujících detailů — osobní věci třetích lidí do chatu nepatří o nic víc než mzdy kolegů.
...
Vrátí přesně to, co si vytisknete nebo přepíšete do poznámek. Klíčový je poslední řádek promptu — jakmile model začne vylepšovat formulace, dostanete elegantní text, který na schůzce nepoužijete. Tahák má znít jako vy v pátém kole nácviku, ne jako příručka komunikace.

Víc si stejně nezapamatujete a víc nepotřebujete. Celé scénáře jsou kontraproduktivní: jakmile rozhovor sejde z linky (a on sejde), scénář vás začne brzdit, protože se ho snažíte dodržet.

### Zápis po schůzce

Nácvik se vyplatí uzavřít až po tom skutečném rozhovoru. Napište si tři věty: co druhá strana řekla jinak, než jste čekali, co vám z připravených formulací fungovalo a co ne. Za rok, až budete připravovat další podobný rozhovor, je tenhle zápis cennější než celý nácvik.
