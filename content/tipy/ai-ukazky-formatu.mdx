...
updated: "2026-08-12"
tldr: >-
  Jedna vložená ukázka nese víc informace než odstavec instrukcí — předá strukturu, délky, tón i slovník, tedy věci, které byste slovy nikdy nepopsali. Návod provede od první vložené ukázky přes rozhodnutí, kdy stačí jedna a kdy tři, přes šablony pro tabulky, zápisy, e-maily a posty až po vlastní stylovou banku. Vzory se před použitím vždy anonymizují.
faq:
  - q: "Kdy stačí jedna ukázka a kdy mám dát tři?"
    a: >-
      Jedna stačí, když je formát pevný a opakuje se beze změn — týdenní report, zápis podle firemní šablony. Tři se vyplatí, když se obsah mezi případy hodně liší, ale forma má zůstat stejná, nebo když model z jedné ukázky opsal konkrétní detail. Víc než tři až čtyři obvykle nepomůžou.
  - q: "Co když model do nového textu opíše jméno nebo číslo ze vzoru?"
    a: >-
      To je klasický příznak toho, že nepozná, co je ve vzoru konstanta a co variace. Řekněte to výslovně: struktura ze vzoru, obsah z podkladů, žádný konkrétní údaj ze vzoru se nesmí objevit. Tři vzory problém odstraní samy, protože rozdíly mezi nimi ukazují, co je proměnná.
  - q: "Můžu jako vzor použít reálný e-mail nebo report s klientskými údaji?"
    a: >-
      Jen po anonymizaci — vzor zbavte citlivých údajů jednou, důkladně, a používejte už jen bezpečnou verzi. Nahrazujte hodnotami stejného tvaru, ne slovem „firma“, aby formát zůstal čitelný. A dokumenty s osobními údaji či obchodním tajemstvím patří jen do placeného účtu se smluvní ochranou dat.
  - q: "Mám jako vzor vybrat svůj nejlepší text?"
    a: >-
      Ne — nejvypiplanější kus je obvykle nejdelší a nejmíň typický a model podle něj vyrobí nafouknutou verzi všeho dalšího. Berte medián, ne maximum: vzor má být to, co chcete dostávat běžně.
  - q: "Co dělat, když si vložený vzor a moje instrukce odporují?"
    a: >-
      Nechte si rozpory vypsat předem, než model začne psát. Obecné pravidlo: při konfliktu vyhrává instrukce, protože je aktuální — ale pokud stejný konflikt řešíte opakovaně, patří změna do vzoru.
  - q: "Stačí stylový manuál v instrukcích, nebo musím vkládat celé ukázky?"
    a: >-
      Instrukce fungují na obecná pravidla — formát dat, vykání, zakázané obraty. Konkrétní formát ale drží líp vložená ukázka, takže u úlohy, na které vám záleží, vložte vzor, i když manuál máte.
---
