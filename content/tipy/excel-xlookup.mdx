...
6. Pokud pracujete s formátovanou tabulkou, používejte místo pevných odkazů na buňky (A2:A100) rovnou názvy sloupců tabulky (Ceník[Kód]) — vzorec pak zůstane funkční i po přidání nebo odebrání řádků.
7. XLOOKUP zvládne i vyhledávání odspodu tabulky (poslední shoda místo první) pomocí dalšího nepovinného argumentu — hodí se, když v datech hledáte nejnovější záznam, ne první, na který vzorec narazí.
...
- **Menší riziko chyby v reportu:** vestavěné ošetření nenalezené hodnoty znamená, že se vám v tabulce neobjeví matoucí chybová hláška místo srozumitelné informace, že hodnota chybí.
