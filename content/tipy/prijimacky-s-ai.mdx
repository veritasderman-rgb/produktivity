...
excerpt: "Kompletní návod s prompty: harmonogram pozpátku od termínu, testy nanečisto z archivu zadavatele, rozbor chyb podle příčiny a rodičovská role bez dusna."
category: "ai"
platform: "vsude"
...
updated: "2026-08-12"
tldr: >-
  Přijímačky nezkoušejí, co umíte, ale co dokážete ukázat za devadesát minut — proto
  se příprava staví jako systém: plán pozpátku od termínu, testy nanečisto
  z oficiálních zadání, rozbor chyb podle čtyř příčin (neznalost, nepozornost, čas,
  nepochopené zadání) a trénink mířený na slabiny. AI je sparring partner — vysvětlí
  krok za krokem, vygeneruje podobné úlohy, roztřídí chyby — ale zadání musí být
  oficiální, ne vymyšlené v chatu.
faq:
  - q: "Můžu si nechat cvičné testy vygenerovat od AI?"
    a: >-
      Ne — zkazí vám to kalibraci. Model vyrobí úlohy, které vypadají jako
      přijímačkové, ale mají jinou obtížnost, jiné rozložení témat i jinak položené
      otázky. Trénujte na oficiálních zadáních zadavatele (Cermat, stránky fakulty);
      generované úlohy jsou jen doplněk na procvičení jednoho typu, který jste
      pochopili.
  - q: "Proč nestačí chybnou úlohu prostě přepočítat?"
    a: >-
      Protože se neptáte, proč chyba vznikla. Skoro každá spadá do jedné ze čtyř
      kategorií — neznalost, nepozornost, čas, nepochopené zadání — a každá se řeší
      úplně jinak. Neznalost přitom bývá menšina: kdo ztrácí body z nepozornosti
      a času, nepotřebuje sbírku navíc, ale jinou práci s testem.
  - q: "Dají se věřit úlohám, které AI vygeneruje na procvičení?"
    a: >-
      Jen po kontrole. Modely si u matematických zadání běžně vymyslí čísla, která
      nevedou k řešení, nebo ke správnému zadání připíšou špatný výsledek. Nechte
      model každou úlohu nezávisle přepočítat, postup si projděte — a když se
      výsledek rozchází s oficiálním klíčem, pravdu má vždycky klíč.
  - q: "Jak mám napsat test nanečisto, aby něco změřil?"
    a: >-
      Jako zkoušku: u stolu, papír a tužka, stopky na oficiální čas, telefon v jiné
      místnosti, bez nahlížení do sešitu. Test napsaný v pohodlí měří něco, co
      u zkoušky mít nebudete. Před opravou si u každé úlohy poznamenejte, jak jste
      si byli jistí — rozbor chyb pak odliší přehmat od neznalosti.
  - q: "Jak můžu jako rodič pomoct, abych to nezhoršil(a)?"
    a: >-
      Vaším úkolem je udržet podmínky a klid, ne kontrolovat výkon: klidné místo,
      spánek, přihlášky včas, vytištěné oficiální testy. Zajímejte se o proces, ne
      o čísla — otázka „co ti dělalo největší problém?“ vede k rozhovoru, „kolik
      jsi měl?“ staví dítě do obrany. Škodí dril navíc, srovnávání a přenesená
      nervozita.
  - q: "Vyplatí se učit ještě večer před zkouškou?"
    a: >-
      Ne. Nedospalý mozek si nevybaví ani to, co má naučené — spánek je v posledním
      týdnu účinnější příprava než další hodiny nad sbírkou. Den před zkouškou jen
      projít strategii testu a chybník, sbalit věci a zjistit cestu s rezervou.
---
