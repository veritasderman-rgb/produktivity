...
excerpt: "Kompletní návod s prompty: napojte kalendář, úkoly a poštu, nechte AI sestavit páteční přehled a tři priority na příští týden. Rozhodnutí zůstává vaše."
category: "ai"
platform: "vsude"
...
updated: "2026-08-12"
tldr: >-
  Týdenní revize padá na sběru dat — a sběr je přesně ta část, která se dá delegovat: přehled sestavuje AI, rozhodnutí dělá člověk. Rutina v pátek dopoledne porovná kalendář, úkolovník a poštu a vypíše, co se dokončilo, co uvázlo, co spadlo ze stolu a na co se čeká, plus návrh tří priorit s odůvodněním. Vy pak za pět minut potvrdíte, vyměníte nebo škrtnete — a po čtvrt roce archiv přehledů ukáže vzorce, které jinak nevidíte.
faq:
  - q: >-
      Proč nenechat AI rovnou určit priority na příští týden?
    a: >-
      Protože priorita není údaj v datech, je to volba. Model vyrobí věrohodně znějící priority odvozené z nejnaléhavějšího termínu a nejhlasitějšího vlákna — přesně ten způsob řízení, kterému se chcete revizí vyhnout. Proto rutina priority navrhuje s odůvodněním a vy je potvrzujete, měníte nebo škrtáte.
  - q: >-
      Které zdroje napojit?
    a: >-
      Tři a víc ne: kalendář (jediný zdroj, který nelže o čase), úkolovník (dokončené, termíny a stáří úkolů) a poštu (na co se čeká a co přišlo mimo plán). Poznámky, dokumenty a firemní chat nechte stranou — zvyšují objem a snižují srozumitelnost. Rutina potřebuje jen právo číst; provoz patří na pracovní účet se smluvní ochranou dat.
  - q: >-
      Kdy má přehled chodit?
    a: >-
      Pátek dopoledne, hodinu až dvě před koncem týdne — ještě stihnete dodělat drobnost a nejste v pátečním večerním rozpoložení. Přehled, který dorazí večer nebo v neděli, se čte jako výčitka. A k přehledu si zablokujte pět minut v kalendáři, jinak se rituál rozpustí.
  - q: >-
      Co je sekce „spadlo ze stolu" a proč potřebuje archiv?
    a: >-
      Jsou to věci, které byly v plánu a nestalo se s nimi nic — ani odklad, ani zmínka. V ručních revizích chybí, protože si na ně nikdo nevzpomene. Rutina je sestaví porovnáním s minulým přehledem, takže bez archivu a bez pěti řádků vašich rozhodnutí nemá s čím srovnávat.
  - q: >-
      Co dělat s úkolem, který v „uvázlo" visí potřetí?
    a: >-
      Neplánovat ho znovu — opakovaně nehybný úkol vám něco říká o zadání, ne o vaší disciplíně: je moc velký, není jasný hotový výsledek, nebo patří někomu jinému. Nejrychlejší test je otázka „co by se stalo, kdybych ho zrušil úplně" — u poloviny takových položek nic.
  - q: >-
      Jak poznám, že je rutina vyladěná?
    a: >-
      Čtete přehled stabilně pod pět minut, sekce „uvázlo" obsahuje položky, které tam patří, a nemusíte kontrolovat, jestli rutina něco nevynechala. Pak stačí čtvrtletní revize zadání. A hlídejte podíl přijatých priorit: když z návrhů berete stabilně jen jednu ze tří, zadání neodpovídá tomu, jak přemýšlíte.
---
