...
tested: "2026-08-27"
tldr: >-
  Nemusíte se učit programovat — musíte se naučit zadávat a kontrolovat: AI skript napíše, vysvětlí a řekne, jak ho spustit. Návod projde celý cyklus od rozpoznání vhodné úlohy přes zadání s ukázkou skutečných dat, laické vysvětlení a náhledový režim až po bezpečné spuštění na kopii a vlastní knihovnu skriptů. Nad vším platí: nikdy nespouštějte skript, kterému nerozumíte aspoň rámcově — a vždycky mějte zálohu.
faq:
  - q: >-
      Kdy se skript vyplatí a kdy je zbytečný?
    a: >-
      Když platí aspoň dvě ze tří věcí: úloha je hromadná (víc než pár desítek položek), mechanická (pravidlo jde popsat větou) a bude se opakovat. Skript naopak není odpověď tam, kde u každé položky rozhoduje člověk, nebo kde to umí vestavěná funkce programu, který už máte — hromadné přejmenování zvládne i správce souborů.
  - q: >-
      Musím umět programovat, abych skript mohl bezpečně použít?
    a: >-
      Ne — ale musíte umět říct větou, co skript udělá se soubory na vašem disku. Nechte si ho vysvětlit po blocích běžnou češtinou a zvlášť se ptejte: které soubory čte, které vytváří, přepisuje nebo maže, posílá něco na internet a co je nejhorší, co se může stát. Když odpovědi nerozumíte, skript nepouštějte.
  - q: >-
      Jak zabránit tomu, aby skript něco nenávratně pokazil?
    a: >-
      Třemi pojistkami: kopie celé složky mimo dosah skriptu (synchronizace do cloudu není záloha — cloud poslušně zopakuje každou změnu), náhledový režim, kdy skript nejdřív jen vypíše, co by udělal, a zkušební běh na vzorku deseti souborů. Celé to trvá dvacet minut a je to rozdíl mezi ušetřeným dnem a přejmenovaným archivem, ve kterém nevíte, co je co.
  - q: >-
      Můžu do chatu vložit ukázku svých skutečných dat?
    a: >-
      Ke psaní skriptu stačí struktura dat, ne jejich obsah — jména, čísla účtů a rodná čísla nahraďte smyšlenými hodnotami stejného tvaru, skript rozdíl nepozná. Osobní a firemní data patří jen do placeného účtu se smluvní ochranou dat; samotný skript pak pouštíte lokálně, kde data nikam neodcházejí.
  - q: >-
      Co dělat, když skript spadne?
    a: >-
      Chybová hláška je informace, ne selhání: zkopírujte ji celou, přesně jak se zobrazila, a přidejte kontext — co jste udělali, co jste čekali a co skript stihl. Než opravu pustíte, zjistěte, jestli první běh nenechal složku v polovičním stavu; když si nejste jistí, vraťte se ke kopii a začněte znovu.
  - q: >-
      Smí skript chybějící údaje odhadnout?
    a: >-
      Ne — když v PDF není částka, má zůstat prázdno. Dopočítaná hodnota vypadá stejně věrohodně jako skutečná a odhalí se až v účetnictví. Stejné pravidlo platí u úklidu složek: skript nesmí obsahovat žádný příkaz na mazání, nálezy jen vypíše a rozhoduje člověk.
---
