...
excerpt: "Kompletní návod s prompty: jak popsat úlohu, nechat si napsat a laicky vysvětlit skript, bezpečně ho spustit na kopii dat, vyřešit chybovou hlášku a postavit si vlastní knihovnu hotových nástrojů. Bez jediného řádku kódu napsaného vlastní rukou."
category: "ai"
platform: "vsude"
audience: []
keys: []
...
Skript se vyplatí, když platí aspoň dvě z těchto tří věcí: úloha je **hromadná** (víc než pár desítek položek), **mechanická** (pravidlo jde popsat větou, nevyžaduje úsudek u každé položky) a **bude se opakovat**. Jednorázové přejmenování pěti souborů skriptem neřešte, otevřete správce souborů.

Neplatí to naopak absolutně: i jednorázová úloha se vyplatí, pokud je natolik velká, že ruční průchod znamená chyby z únavy. Pět set faktur je přesně ten případ.
...
Když nevíte, jak na to technicky, nechte si napsat návod na míru:

```text
Napiš mi úplně podrobný návod, jak tenhle skript spustím.
Jsem na [Windows 11 / macOS], nikdy jsem nic neinstaloval
z příkazové řádky a nevím, co je terminál.

Chci:
1. co musím nainstalovat, odkud to stáhnu a jak poznám, že je to hotové,
2. kam uložit soubor se skriptem a jak ho pojmenovat,
3. jak otevřít terminál a jak se v něm dostat do té složky,
4. jaký příkaz napsat, doslova, i s uvozovkami,
5. jak pozná, že skript doběhl správně,
6. co udělat, když se okno hned zavře a nic neuvidím.

Piš po krocích, každý krok jedna věta a co uvidím na obrazovce.
Nepředpokládej žádné znalosti.
```

Vrátí návod, podle kterého se dá postupovat naslepo. Bod 6 řešte hned — zavírající se okno je nejčastější důvod, proč lidé skončí s pocitem, že „to nefunguje“, přestože skript proběhl.
...
Horší případ: skript proběhne bez hlášky a udělá něco jiného, než jste chtěli. Tady nepomůže chybová hláška, ale konkrétní příklad.

```text
Skript proběhl bez chyby, ale výsledek je špatně.

Ukázka toho, co udělal (5 skutečných případů):
[původní název] → [co z toho udělal]

Co z toho je špatně a jak to má vypadat správně:
[u každého případu napiš požadovaný výsledek]

U ostatních [480] souborů to dopadlo správně, nechci to rozbít.

Zjisti, proč se ty případy chovají jinak, vysvětli mi to česky
a pak uprav skript tak, aby zvládl obojí. Napiš mi taky, jak si
mám ověřit, že oprava nerozbila případy, které fungovaly.
```

Vrátí diagnózu a opravu. Poslední věta je podstatná — u úprav skriptů je běžné, že oprava jedné skupiny případů rozbije jinou, a bez kontrolního postupu si toho všimnete až na tisícím souboru.
