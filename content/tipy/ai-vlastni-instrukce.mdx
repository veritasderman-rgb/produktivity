...
updated: "2026-08-12"
tldr: >-
  Vlastní instrukce jsou pár vět v nastavení účtu, které se přidají ke každé nové konverzaci — dobře napsané ušetří první dvě zprávy v každé z nich. Fungující sada má čtyři bloky: kdo jste, formát odpovědí, tón a zákazy, a patří do ní jen to, co platí napříč vším. Návod přidává hotové sady pro manažera, studenta, freelancera i vývojáře a postup, jak instrukce otestovat a kvartálně pročistit.
faq:
  - q: "Co patří do vlastních instrukcí a co do Projektu?"
    a: >-
      Vlastní instrukce popisují vás, Projekt popisuje jednu oblast vaší práce. Test: platilo by pravidlo i pro konverzaci o úplně jiném tématu? Pokud ne, patří o vrstvu níž — poznáte to i podle podmínky na začátku: instrukce začínající „u“, „když“ nebo „pokud jde o“ skoro vždycky patří do Projektu.
  - q: "Proč nefunguje instrukce „odpovídej stručně“?"
    a: >-
      Protože stručnost si každý představuje jinak — je to obecná, nekontrolovatelná formulace. Silná instrukce popisuje strukturu a rozsah v číslech: kolik odrážek, co má být první, kdy použít tabulku. Konkrétní pravidlo se dá dodržet i zkontrolovat.
  - q: "Můžu do instrukcí napsat jména klientů nebo aktuální projekt?"
    a: >-
      Ne. Instrukce se posílají s každou konverzací, takže citlivé údaje opustí počítač i u banálního dotazu — patří jen do placeného účtu se smluvní ochranou dat a i tam anonymizovaně. A proměnlivý kontext (projekt, klient, termín) je za dva měsíce nepravda, se kterou model dál počítá.
  - q: "Jak poznám, že moje instrukce fungují?"
    a: >-
      Testem: vezměte tři typická zadání, pusťte je v nové konverzaci a počítejte, kolik oprav jste museli dopsat. Nula až jedna znamená, že instrukce sedí; tři a víc, že to, co opravujete, v instrukcích chybí nebo je vágní. Trojici pusťte za měsíc znovu — a po větší aktualizaci modelu taky.
  - q: "Co když model některé pravidlo ignoruje?"
    a: >-
      Nejčastější příčina je nejednoznačnost nebo spor dvou pravidel — typicky „piš stručně“ versus „vždycky uveď všechny alternativy“. Nechte si odpověď zkontrolovat pravidlo po pravidle a spor rozhodněte: jedno pravidlo nechte, druhé si vyžádejte promptem, když ho zrovna potřebujete.
  - q: "Jak dlouhé mají instrukce být?"
    a: >-
      Řádově desítky řádků, zhruba dvě stě až tři sta slov — čím delší sada, tím slabší jednotlivé pravidlo. Dlouhé podklady a pravidla pro jednu oblast přesuňte do Projektu a jednou za kvartál instrukce pročistěte: co jste neopravovali, ven.
---
