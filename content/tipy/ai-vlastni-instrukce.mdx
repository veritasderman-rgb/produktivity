...
excerpt: "Kompletní návod k trvalým instrukcím: co do nich patří a co ne, čím se liší od Projektu a od jednotlivého promptu, jak je otestovat — a hotové sady k okopírování pro manažera, studenta, freelancera i vývojáře."
category: "ai"
platform: "vsude"
audience: []
keys: []
...
Projektový manažer Martin otevírá denně dvanáct až patnáct konverzací: k plánování, k mailům, k rychlým shrnutím, k přípravě na poradu. Skoro každá začne stejně. Model odpoví dlouhým odstavcem, začne větou „skvělá otázka" a nabídne pět variant, ačkoli Martin chtěl doporučení. Martin dopíše „kratší, v bodech, bez úvodu" a teprve třetí zpráva je ta, kterou skutečně použije. Dvě zbytečné zprávy krát čtrnáct konverzací je zhruba dvacet minut denně strávených opravováním něčeho, co se dá říct jednou.

Po nastavení instrukcí se první odpověď trefí. Model ví, že Martin je projektový manažer ve stavební firmě, že chce odpovědi v bodech s doporučením na začátku, že nemá rád zdvořilostní vatu a že u čehokoli, co míří ven ke klientovi, chce označit místa, kde si model není jistý. Za tři měsíce si instrukce dvakrát doplnil — jednou o pravidlo „u odhadů času vždycky uveď, z čeho vycházíš", jednou o „když ti chybí informace, zeptej se místo hádání".
