...
Pod tabulku napiš, kolik vláken jsi viděl a za jaké období,
kde se moje pravidla nedala použít (chybí pravidlo, nebo si
dvě odporují), u kterých vláken sis nebyl jistý stavem a co ti
chybělo, a kolik upomínek by rutina dnes připravila naostro.
...
ne shrnutí zprávy) a kolik dní to leží. U skupiny A rovnou
připrav koncept (max 3 věty podle mé karty tónu), u skupiny C
koncept, který věc zdvořile uzavře. U skupiny B koncept nepiš,
jen odhadni, kolik času potřebuju.
```
...
- **Nezavírat vyprchalé smyčky.** Vlákno, u kterého proběhly všechny připomínky a nic nepřišlo, není otevřená příležitost, ale otevřené okno v hlavě. Pusťte ho vědomě.
...
- **Klid:** přestanete si nosit v hlavě seznam lidí, kteří vám dluží odpověď. Týdenní přehled je vnější paměť, které se dá věřit.
...
Pokročilý trik: nechte hlídač u vláken, kde si není jistý tónem, připravit **dva koncepty** — jeden krátký a věcný, druhý vstřícnější — a označit je v předmětu jako A a B. Stačí do zadání přidat větu „u vláken, kde není zřejmý požadovaný registr, ulož dvě varianty“. Volba mezi dvěma hotovými verzemi je přesnější než přepisování jedné; po dvou týdnech navíc uvidíte, kterou variantu volíte, a to je pravidlo rovnou do karty tónu.
