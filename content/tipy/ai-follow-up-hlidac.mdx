...
Pracovní dny jsou důležitější, než se zdá: „pět dní“ přes velikonoční týden znamená upomínku ve chvíli, kdy adresát ani nebyl v práci. Výchozí hodnoty si pak zpřesněte vlastní historií.

```text
Projdi moji poštu za posledních [6 měsíců] a spočítej, za jak
dlouho mi lidé odpovídají. Skupiny: interní kolegové, klienti,
nové poptávky, dodavatelé, úřady. Pro každou uveď počet vláken,
medián doby do první odpovědi v pracovních dnech a den,
po kterém už odpověď prakticky nepřišla.
...
zprávy) a odhad délky vyřízení (do 2 minut / do 15 minut /
delší práce).
