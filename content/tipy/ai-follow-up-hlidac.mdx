...
Vrátí seznam, ve kterém typicky najdete dvakrát víc položek, než jste čekali; závěrečné poznámky o nejistotě a vyřazených typech jsou zárodek pravidel. Pozor: model odhaduje, jestli zpráva „něco chce“, z formulace, a u zdvořilé češtiny se plete — věta „kdyžtak dej vědět“ může být požadavek i výplň. Co do seznamu nepatří, škrtněte hned, ať se to nepropíše do pravidel.
...
Cílem téhle fáze je, aby AI viděla schránku přímo — hlídač, do kterého kopírujete maily ručně, je jen složitější způsob, jak na věci zapomínat.
