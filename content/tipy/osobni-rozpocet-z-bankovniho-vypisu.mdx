...
excerpt: "Návod s prompty: export z banky, anonymizace, kategorizace transakcí, odhalení zapomenutých předplatných a desetiminutová rutina, aby to vydrželo."
category: "ai"
platform: "vsude"
...
updated: "2026-08-12"
tldr: >-
  Data pro rozpočet už existují — banka je vede roky zpátky, položku po položce. Za
  jeden večer se z ročního exportu udělá kompletní obraz: anonymizace, kategorizace
  s pravidly, měsíční cash flow a seznam zapomenutých předplatných. Aby to vydrželo,
  potřebujete desetiminutovou měsíční rutinu se stejným promptem. Výpis je jedna
  z nejcitlivějších věcí, které o sobě máte — a rušení plateb i převody děláte vy
  sami ve svém bankovnictví.
faq:
  - q: "Proč stahovat dvanáct měsíců, a ne tři?"
    a: >-
      Roční okno je jediné, ve kterém uvidíte věci, které se dějí jednou za rok:
      pojistky, dálniční známku, daně, dovolenou, vánoční nákupy. Kdo analyzuje
      kvartál, dostane zkreslený obraz „normálního měsíce“, který ve skutečnosti
      neexistuje — a pak se diví, proč mu rozpočet nesedí.
  - q: "Co z výpisu smazat, než ho nahraju?"
    a: >-
      Úplně smažte čísla účtů, variabilní symboly, adresy a celá jména osob;
      nechte datum, částku, typ platby a hrubý popis útraty. Citlivá jména
      (zaměstnavatel, lékař, osoba, které posíláte peníze) nahraďte obecným popisem.
      Pracujte jen v placeném účtu se smluvní ochranou dat a soubor po analýze
      z konverzace odstraňte — anonymizaci nejlépe zvládne skript u vás v počítači.
  - q: "Jaký je rozdíl mezi cash flow a zůstatkem na účtu?"
    a: >-
      Cash flow je rozdíl mezi tím, co za měsíc přiteklo a odteklo; zůstatek je
      součet celé historie účtu. Můžete mít na účtu sto tisíc a přitom pět měsíců
      po sobě záporné cash flow — účet vypadá zdravě, dokud rezerva nedojde.
      Zaměňovat ta dvě čísla je nejdražší omyl v osobních financích.
  - q: "Co když si model u nejasné platby není jistý?"
    a: >-
      Nesmí hádat — bez výslovného pokynu „nehádej, dej to do nezařazeno“ nejasné
      platby tiše rozdělí podle dojmu a dostanete přesně vypadající čísla, která
      nesedí. Seznam nezařazených plateb doplníte ručně za pár minut; je to levnější
      než nedůvěra k vlastnímu rozpočtu.
  - q: "Může AI rovnou zrušit předplatné, které nepoužívám?"
    a: >-
      Ne — rušení plateb dělá člověk ve svém bankovnictví nebo přímo u služby. AI
      připraví rozhodovací tabulku s otázkami, ale u zrušení se překvapivě často
      zjistí, že na službě něco visí: sdílený rodinný účet, doména, zálohy fotek.
      A u ročních plateb má obvykle smysl nechat službu doběhnout a jen vypnout
      obnovení.
  - q: "Proč mi jednorázová analýza nevydrží?"
    a: >-
      Protože je to fotka, ne měřič — rozhodnutí se bez měření vrátí do starých
      kolejí. Klíč je desetiminutová rutina první víkend v měsíci: stáhnout výpis,
      spustit uložený prompt s mapovacími pravidly, doplnit řádek a mrknout na tři
      čísla. Teprve srovnání s předchozími měsíci odhalí, že rozvozy rostou třetí
      měsíc v řadě.
---
