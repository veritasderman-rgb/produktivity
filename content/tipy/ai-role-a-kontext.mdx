...
updated: "2026-08-12"
tldr: >-
  Kvalita odpovědi se rozhoduje v zadání, ne ve výběru modelu. Dobrý prompt má čtyři díly: roli (kdo má AI být — filtr toho, čeho si všímá), kontext (to jediné, co model o vaší situaci neví), úkol (jedno sloveso, jasný rozsah) a formát (jak má výstup vypadat, včetně toho, co nechcete). Návod to ukazuje na jednom zadání ve třech verzích a končí šablonou k vyplnění.
faq:
  - q: >-
      Proč dostávám obecné odpovědi, které by seděly komukoli?
    a: >-
      Protože v zadání není ani jedna informace, kterou by nešlo uhodnout — model pak generuje průměr všeho, co kdy takový text obsahoval. Platí pravidlo: každý řádek zadání, který by šel použít na kohokoli jiného, je zbytečný — a každý, který platí jen pro vás, zvyšuje kvalitu odpovědi.
  - q: >-
      K čemu je role, když model žádné nové znalosti nezíská?
    a: >-
      Role je filtr: mění, co model považuje za relevantní. Právník si na stejném textu všimne lhůt a sankcí, marketér příslibu značce, účetní DPH. Nejužitečnější role je kritik nebo oponent, protože model má sklon souhlasit. U mechanických úloh (převod formátu, třídění) roli vynechte — jen zabírá místo.
  - q: >-
      Kolik kontextu je akorát?
    a: >-
      Tolik, kolik byste řekli schopnému člověku, který o vaší situaci neví nic a nemůže se doptat — prakticky tři až deset řádků plus podklad. Vždycky patří dovnitř: pro koho výstup je, co už se stalo, omezení a čeho se obáváte. Nejjistější způsob: nechte se modelem doptat, které informace mu chybí.
  - q: >-
      Proč zadávat i to, co nechci?
    a: >-
      Protože zákaz je často účinnější než požadavek: „bez obecných rad", „bez úvodního odstavce", „nepoužívej slovo řešení". Formát není kosmetika — odpověď, kterou musíte přeskládat, než ji použijete, je poloviční odpověď. Zadejte délku, strukturu, tón a výslovně i fráze, které se nesmí objevit.
  - q: >-
      Co dělat, když odpověď nesedí — přepsat celé zadání?
    a: >-
      Ne, opravte jen vrstvu, která selhala: obecná odpověď = chybí kontext; odborně mimo = špatná role; správná věc v nepoužitelné podobě = chybí formát; odpověď na něco jiného = chybí sloveso v úkolu. A dolaďujte v konverzaci — „zkrať to na polovinu" zabere pět vteřin.
  - q: >-
      Zaručí dobrý prompt pravdivou odpověď?
    a: >-
      Ne — kvalitní zadání zvyšuje kvalitu, ne pravdivost. Čísla, citace a paragrafy se pořád ověřují u zdroje a modely rády vyplní mezery věrohodně vypadající hodnotou; proto do promptů patří zákaz vymýšlení čísel se značkou DOPLNIT. A citlivá data nahrazujte zástupnými hodnotami, nebo pracujte jen v placeném účtu se smluvní ochranou dat.
---
