...
excerpt: "Kompletní návod s prompty: jak z hotového reportu udělat prezentaci, která drží — osnova slidů před grafikou, zhuštění textu na odrážky, klikatelný prototyp k odladění struktury, poznámky pro mluvčího, tři verze pro tři publika a teprve nakonec sazba do firemní šablony."
category: "ai"
platform: "vsude"
...
Graf na slidu má jednu úlohu: ukázat to, co říká nadpis. Když se na graf musí publikum dívat déle než pět vteřin, aby pochopilo pointu, je špatný. Praktická pravidla: jedna datová řada, pokud nesrovnáváte, popisky přímo u čar místo legendy, zvýrazněná ta část, o které mluvíte, a žádné 3D. Podrobněji o čtení dat je v tipu [analýza dat s AI](/tipy/ai-analyza-dat) — ale pro slidy platí, že složitý graf je vždycky slabší než jednoduchý s dobrým nadpisem.
...
Pokud šablonu nemáte pořádně nastavenou, začněte tím. Předloha (v PowerPointu Předloha snímků) drží písma, barvy, pozice a zápatí na jednom místě, takže se změna projeví všude najednou. Bez ní strávíte hodinu ručním zarovnáváním a stejně to bude vypadat rozházeně. Návod je v tipu [předloha v PowerPointu](/tipy/powerpoint-predloha), na zarovnání se hodí [nástroje zarovnání](/tipy/powerpoint-zarovnani).
...
Před ostrým během si prezentaci projděte ještě jednou od začátku, ideálně nahlas a bez publika. Zkratka Shift+F5 spustí prezentaci od aktuálního slidu, což ušetří klikání při opakovaném zkoušení jedné pasáže — viz [Shift+F5](/tipy/powerpoint-shift-f5).
