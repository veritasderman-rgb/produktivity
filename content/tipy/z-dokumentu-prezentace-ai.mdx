...
updated: "2026-08-12"
tldr: >-
  Nejhorší způsob, jak dělat prezentaci, je otevřít PowerPoint a začít psát na
  první slide. Funguje opačné pořadí: brief (publikum, čas, rozhodnutí), osnova
  s nadpisy jako tvrzeními, zhuštění na odrážky do deseti slov, klikatelný
  prototyp jako artefakt proklikaný nahlas se stopkami — a teprve pak sazba do
  šablony. Slidy nejsou dokument a každé číslo musí souhlasit s originálem,
  protože model při zhušťování zaokrouhluje a stupňuje.
faq:
  - q: "Proč nestačí říct AI „udělej z toho prezentaci“?"
    a: >-
      Protože model neví, komu mluvíte ani co po publiku chcete — vrátí
      převyprávěný dokument rozsekaný na slidy, rovnoměrný a bez pointy. Brief
      je pět řádků a změní všechno: publikum, čas, rozhodnutí, které
      potřebujete, prostředí a co už posluchači vědí.
  - q: "Kam patří závěr — na začátek, nebo na konec?"
    a: >-
      Na začátek. Klasická chyba je držet závěr jako pointu detektivky —
      u pracovních prezentací funguje opak: řekněte závěr na druhém slidu
      a zbytek času ho podpírejte. I když jednání skončí po deseti minutách,
      hlavní sdělení už zaznělo.
  - q: "Jak poznám, že má prezentace dobrou strukturu?"
    a: >-
      Zkouškou nadpisů: nadpisy pište jako tvrzení, ne štítky („Pilot snížil
      reklamace o pětinu“ místo „Výsledky“), a když si je přečtete za sebou,
      má z nich vzniknout souvislý příběh. Je to nejrychlejší kontrola kvality
      prezentace — a změny pořadí dělejte v osnově, kde stojí deset vteřin,
      ne v hotové sazbě.
  - q: "Musím kontrolovat čísla, která AI dala do slidů?"
    a: >-
      Vždycky — model při zhušťování zaokrouhluje, spojuje a stupňuje:
      z „o 19 % v pilotní skupině“ se snadno stane „o pětinu celkově“
      a z opatrného „naznačuje“ rázné „prokazuje“. Kontrola proti původnímu
      dokumentu je posledních deset minut práce, které nejde vynechat — špatné
      číslo na plátně vezme důvěru zbytku prezentace.
  - q: "K čemu je klikatelný prototyp, když stejně skončím v PowerPointu?"
    a: >-
      Tok, délku a rytmus prezentace poznáte jen tím, že si ji projdete —
      artefakt proklikáte šipkami, nahlas a se stopkami, a opravy děláte
      jednou větou v chatu místo přesouvání textových polí. Typicky zjistíte,
      že jste o čtvrtinu přes čas. Prototyp ale není výstup: slouží k ladění,
      neposílá se.
  - q: "Můžu jednu prezentaci použít pro vedení, tým i klienta?"
    a: >-
      Ne — vedení chce pět slidů a rozhodnutí, tým dvacet slidů a postup,
      klient deset slidů o svém užitku. Z jednoho dokumentu ale vzniknou tři
      verze levně: obvykle jde třetina slidů převzít, takže druhá verze je
      hodina práce. A slidy na rozeslání mailem jsou samostatný žánr — musí
      fungovat bez mluvčího.
---
