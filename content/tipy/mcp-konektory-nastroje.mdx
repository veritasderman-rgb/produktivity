...
Vrátí návod na míru včetně kontrolního dotazu. Bod 5 je tam schválně: instalaci, kterou neumíte vrátit, si nepouštějte. A bod 2 čtěte pozorně — u lokálního serveru se vaše data nedostanou dál než k modelu, u vzdáleného prochází ještě přes provozovatele.
...
Hodí se to hlavně na hromadné úkony. Padesát produktových fotek, ze kterých má zmizet pozadí a mají se srovnat na stejný rozměr, je hodina ruční práce a jedno zadání pro agenta.
...
Analytika je oblast, kde jsou konektory nejvíc podceněné, protože práce s daty vypadá jako něco pro specialistu. Většinou potřebuje jen někoho, kdo se zeptá.
