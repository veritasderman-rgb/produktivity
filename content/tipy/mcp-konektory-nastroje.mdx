...
Nejjednodušší cesta. V nastavení konektorů na claude.ai najdete adresář hotových napojení, vyberete službu, kliknete na připojení a přesměruje vás to na přihlašovací obrazovku dané služby. Tam se přihlásíte svým běžným účtem a **potvrdíte seznam oprávnění**. Nikde se nezakládá vývojářská aplikace a nevzniká API klíč, který byste museli hlídat: přihlášení běží přes OAuth, tedy služba vydá klientovi časově omezené pověření vázané na váš účet a vámi odsouhlasený rozsah práv. Odebrat ho můžete kdykoli, a to nejen v nastavení konektorů, ale i na straně služby v přehledu připojených aplikací — to druhé místo je jediný seznam, který vidí i konektory, na které jste zapomněli.
...
U třetí varianty zpomalte. Do řetězce mezi vás a vaše data vstupuje někdo další — a to i tehdy, když je server open source, protože běží na jeho infrastruktuře. Chtějte dohledatelného autora nebo firmu, veřejný repozitář s historií a jasně napsané, kam data tečou a co se loguje. Když aspoň jedna věc chybí, nechte to být.
...
4. Konkrétní dotaz, kterým si po instalaci ověřím, že to funguje
5. Jak ho zase odeberu, kdyby se to nepovedlo

Nepředpokládej, že umím programovat. Kde je riziko,
...
Obrazovka, na které služba vypisuje, co konektor smí, je jediné místo v celém procesu, kde rozhodujete vy. Všechno ostatní je klikání. Přečtěte ji celou a hledejte tři věci. **Rozsah** — „přístup ke všem vašim návrhům" je něco jiného než „přístup k návrhům ve složce X"; když služba nabízí volbu, zvolte to užší, rozšířit se dá kdykoli. **Směr** — rozlište, co jen čte, a co může zakládat, měnit nebo mazat; u konektorů, které chcete zpočátku jen na analýzu, je právo zápisu zbytečné riziko. A **účet**: u služeb s více pracovními prostory si ohlídejte, který se připojuje. Nejčastější tichá chyba je připojit osobní účet a divit se, že model nevidí firemní data — nebo naopak.
...
Typický režim práce: máte jeden podklad a potřebujete z něj várku příspěvků pro několik kanálů, každý v jiné délce a jiném tónu, rozloženou do dvou týdnů.
...
5. Tři změny, které mám zkusit příští měsíc, a jak poznám,
   že zabraly
...
**Svěřte přípravu.** Várka příspěvků z jednoho podkladu, přeformulování do jiného kanálu, vytažení témat z delšího textu, návrh kalendáře na měsíc, vyhodnocení minulého období, sjednocení tónu. Mechanická práce s vysokou návratností a nulovým rizikem — nejhorší, co se stane, je koncept, který smažete.

**Nesvěřujte publikaci.** Zveřejněný příspěvek nejde vzít zpátky; screenshot vznikne dřív, než ho stihnete smazat. Platí to i pro reakce na komentáře a zprávy, kde je riziko ještě vyšší, protože jde o odpověď konkrétnímu člověku v kontextu, který model nemusí znát. **AI navrhuje, člověk schvaluje** je u sociálních sítí méně zásada a víc praktické opatření. Jedna věc mezi tím: **automatické publikování naplánovaných konceptů**, které jste sami předem schválili, je legitimní — schválení proběhlo, jen s časovým odstupem. Širší postup rozebírá [obsahová továrna s AI](/tipy/obsahova-tovarna-ai) a [sociální sítě s AI](/tipy/socialni-site-s-ai).
...
Adobe konektor je z téhle trojice nejširší. **Práce s obrázky**: odstranění pozadí, ořez a změna velikosti, generativní rozšíření plátna, výběr objektu podle popisu, vyplnění plochy, vektorizace a dlouhá řada úprav expozice, barev a kontrastu. **Práce s videem**: metadata, rychlé střihy, změna rozměru, vykreslení snímku i celého výstupu, vylepšení řeči v audiu. A **tvorba v Express a Firefly**: sestavení návrhu, export do dalších formátů, práce s písmy a knihovnou materiálů.

Prakticky se to hodí hlavně na hromadné úkony. Padesát produktových fotek, ze kterých má zmizet pozadí a mají se srovnat na stejný rozměr, je hodina ruční práce a jedno zadání pro agenta.
...
**Silná je v mechanice.** Varianty téhož ve dvaceti provedeních. Přeformátování jednoho návrhu do pěti rozměrů. Hromadné úpravy podle jednoho pravidla. Doplnění dat do šablony. Ořezy, pozadí, exporty, přejmenování. Úkoly, kde je člověk pomalejší a dělá víc chyb, protože ho to po dvacáté přestane bavit.

**Slabá je v tom, co dělá grafiku grafikou.** Originalita, nápad, který se nedá odvodit z ničeho existujícího, cit pro to, co se k vaší značce hodí. Model nemá vkus, má statistiku — a statistika vrací průměr. Když mu zadáte „udělej to hezky", dostanete něco, co vypadá jako všechno ostatní. Z toho plyne dělba práce: **rozhodnutí o vzhledu udělá člověk jednou a napíše je do šablony nebo do stylového zadání, model je pak aplikuje donekonečna** — přesně tenhle postup rozebírá tip o [automatickém generování obrázků](/tipy/gemini-api-obrazky-automaticky).

## Analytika a data

Analytika je oblast, kde jsou konektory nejvíc podceněné, protože práce s daty vypadá jako něco, co potřebuje specialistu. Většinou potřebuje jen někoho, kdo se zeptá.
...
Vrátí přehled, který v rozhraní analytiky poskládáte za dvacet minut klikání. Bod o malých číslech je tam proto, že skok z tří na devět návštěv je „nárůst o 200 procent" a v reportu vypadá jako událost. Bod o rozlišení závěru a dat čtěte pozorně — model rád vysvětluje, i když k vysvětlení nemá podklad.

Stejným způsobem se ptá na funnel: „sestav funnel od [vstupní stránka] přes [mezikroky] k [cíl] za posledních 90 dní, porovnej mobil a desktop, porovnej organic a paid a u největšího propadu napiš tři hypotézy a ke každé dotaz do dat, který ji potvrdí nebo vyvrátí." Ověřte si přitom, že mezikroky odpovídají skutečným událostem ve vašem měření — nejčastější chyba není v analýze, ale v tom, že se měří něco jiného, než si myslíte. Navazuje na to tip [analýza dat s AI](/tipy/ai-analyza-dat); co jde v reklamních účtech, rozebírá sesterský článek [MCP pro reklamu a analýzu](/tipy/mcp-reklama-analyza).
...
**Notion konektor** umí vyhledávat napříč pracovním prostorem, číst stránky, zakládat a upravovat je, dotazovat se do databází a pracovat s komentáři. Praktická hodnota není v psaní do Notionu, ale ve čtení z něj: firemní paměť, ve které nikdo nic nenajde, se změní na něco, čemu jde položit otázku. **Google Drive konektor** hledá v souborech podle významu, čte jejich obsah, vrací metadata a oprávnění a umí zakládat nové soubory.

**Supabase konektor** je pro ty, kdo mají vlastní databázi: vypíše tabulky a rozšíření, spustí SQL dotazy, přečte logy, vrátí bezpečnostní a výkonnostní doporučení, vygeneruje typy a spravuje migrace. Pozor: spouštění SQL je mocné a nevratné — dotazy, které něco mění, si nechte na sebe.
...
Modely Flash Image se dají potkat pod přezdívkou Nano Banana 2, silnější Pro Image jako Nano Banana Pro. Sto ilustrací v rozlišení 1K tedy stojí kolem sedmi dolarů u levnější varianty a kolem třinácti u silnější — částka, u které se nevyplatí přemýšlet, ale u tisíce obrázků už ano.

**Video** je jiná liga. Veo 3.1 stojí zhruba 0,40 USD za sekundu výsledného videa v rozlišení 720p i 1080p a 0,60 za 4K; rychlejší varianta začíná kolem 0,10 za sekundu. Osmisekundový klip vyjde na jednotky dolarů, za minutu videa už platíte řádově dvacet dolarů a víc.
...
Tady je potřeba být poctivý, protože se to často popisuje nepřesně. **Gemini API není datový zdroj, je to model.** Konektor typu Gmail nebo Notion existuje proto, že za ním jsou vaše data — pošta, stránky, soubory. Za Gemini API žádná vaše data nejsou; je to druhý mozek vedle toho, se kterým už mluvíte. Proto se nedá zapnout jako „konektor na Gemini" v tom smyslu, v jakém zapínáte Drive. Smysl to ale dává ve dvou podobách.

### Cesta A: skript nad API klíčem

Nejčistší a nejpoužívanější varianta. Necháte si napsat krátký skript, který umí jednu věc — zavolat Gemini API s vaším klíčem a uložit výsledek do souboru. Claude Cowork nebo Claude Code pak ten skript spustí jako každý jiný nástroj ve složce. Klíč se bere z proměnné prostředí a modelu se nikdy neukáže. Výhody jsou tři: **klíč zůstává u vás**, **chování je předvídatelné**, protože skript dělá přesně to, co je v něm napsané, a **výsledek je opakovatelný** — stejný vstup, stejné nastavení, stejný výstup i za rok.
...
**Motiv se bere z článku.** Skript projde složku s články, z každého vytáhne titulek a perex z hlavičky a složí z nich větu o předmětu ilustrace. Nikdo motiv nevymýšlí zvlášť.
...
**Výstup jde do složky, ne na web.** Obrázek se uloží jako PNG pod názvem odpovídajícím článku; převod do WebP, tedy do formátu, který se servíruje čtenářům, je samostatný krok — schválně, protože mezi generováním a publikací má být místo, kde se člověk podívá a rozhodne. Skript navíc přeskakuje články, které obrázek už mají, takže se dá pustit opakovaně. To je celý bezpečnostní model téhle cesty: **generuje stroj, publikuje člověk.** Podrobněji je postup v tipu [obrázky pro projekt automaticky](/tipy/gemini-api-obrazky-automaticky).
...
Vrátí hotový skript s komentáři a vysvětlením. Tři věci zkontrolujte dřív, než ho pustíte na celou dávku: že klíč opravdu není nikde v kódu, že strop na počet volání existuje a funguje, a že se skript dá pustit na jednu položku. Vysvětlení na konci není zdvořilost — skript, kterému nerozumíte, nemáte pouštět na věci, které něco stojí.

Pokud tuhle cestu chcete rozšířit do celého projektu, navazuje na ni sesterský článek [web s Claude Code a Vercelem](/tipy/web-claude-code-vercel).
...
Cena za to pohodlí je konkrétní: **dáváte svůj API klíč cizí službě.** Kdo klíč má, může na váš účet utrácet, bez ohledu na to, jak dobré má autor úmysly — stačí, aby měl špatně zabezpečený server. U serveru, který si sami spustíte lokálně ze zdrojového kódu, je riziko menší, protože klíč zůstává u vás; u hostovaného je plné. Minimum opatření: **samostatný klíč** jen pro tenhle účel, **nízký rozpočtový limit**, **dohledatelný autor** a veřejný repozitář a **pravidelná kontrola spotřeby**, protože zneužitý klíč se pozná jedině na účtu.
...
**Napřed čtení, teprve po zkušenosti zápis.** První týden s novým konektorem se ptejte výhradně na věci, které nic nemění. Zjistíte, v čem se model plete, a to nejde získat jinak než používáním.
...
Stane se to a v devíti případech z deseti to není porucha. **Prázdná odpověď** obvykle znamená jiný rozsah, než si myslíte — model hledal v jiném období, pracovním prostoru, property nebo složce; nechte si vypsat, co konkrétně hledal. **Chyba oprávnění** znamená, že jste při připojení odsouhlasili užší rozsah, a řeší se odpojením a novým připojením, ne přemlouváním modelu. **Chyba autentizace** znamená vypršené pověření: odpojit, připojit, hotovo.
...
- **Notion, Google Drive a Supabase** — kontext k číslům a vlastní data: co jsme kdy spustili a co jsme komu slíbili.
- **Gemini API** — druhý model vedle hlavního na to, co je masové nebo vizuální; nejlevněji v dávkovém režimu.

## Co vám to přinese

- **Čas:** střízlivě 3–5 hodin týdně u člověka, který dnes přenáší data mezi analytikou, plánovačem a grafickým nástrojem. Největší položka bývá příprava obsahové várky a měsíční report.
- **Peníze:** úspora není v softwaru, ale v tom, co se začne dělat. Vyhodnocení, které dřív nikdo nedělal, mění, co se příště vydá. U Gemini API navíc platí, že dávkový režim za poloviční cenu zlevní každou velkou úlohu.
...
Pokročilý trik, který funguje líp než další konektor: **napište si jednostránkový popis vašeho provozu** — jak se jmenují klienti a projekty, které property v analytice patří komu, jak se jmenují kanály v plánovači, kde bydlí šablony — a uložte ho do trvalého kontextu, se kterým model pracuje. Konektory pak přestanou hledat naslepo: věta „udělej report pro Nováka za červenec" najednou znamená správnou property, správnou složku a správný formát. Rozdíl v kvalitě odpovědí bývá větší než rozdíl mezi třemi a osmi konektory.
