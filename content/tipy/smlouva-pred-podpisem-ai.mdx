...
excerpt: "Kompletní návod s prompty pro pět typů smluv: od anonymizace přes rizikovou analýzu s citací článků po otázky na protistranu. Ať víte, co podepisujete."
category: "ai"
platform: "vsude"
...
updated: "2026-08-12"
tldr: >-
  AI vám neřekne, jestli smlouvu podepsat — umí ale vytáhnout pasáže, které se
  čtou nejhůř a bolí nejvíc: automatická prodloužení, sankce bez stropu,
  jednostranné změny, výpovědní lhůty. Postup vede od anonymizace přes rizikovou
  analýzu s citací konkrétních článků a kontrolu toho, co ve smlouvě chybí, až po
  slušně formulované otázky na protistranu. AI je pozorný čtenář, ne právní
  zástupce — u velkých peněz končí návod u dveří advokáta, jen tam přijdete s pěti
  otázkami místo hromádky papíru.
faq:
  - q: "Můžu smlouvu nahrát do chatu tak, jak je?"
    a: >-
      Ne — nejdřív vymažte rodná čísla, čísla účtů, jména obou stran a adresy;
      na rozbor rizik nejsou identifikační údaje potřeba, model posuzuje
      konstrukci vět. Částky, lhůty a čísla článků naopak nechte. A citlivé
      dokumenty patří jen do placeného účtu se smluvní ochranou dat —
      anonymizace je druhá vrstva, ne náhrada té první.
  - q: "Můžu věřit citacím článků, které mi model vypíše?"
    a: >-
      Až po kontrole — je to nejnebezpečnější selhání celého postupu. Model umí
      citovat přesně, ale taky umí větu nepatrně přeformulovat, a rozdíl mezi
      „může“ a „musí“ je celý rozdíl. Než něco pošlete protistraně, najděte si
      každou citovanou větu v originále.
  - q: "Je rozbor od AI právní stanovisko?"
    a: >-
      Ne. AI nezná vaši situaci, nenese odpovědnost a nemá licenci — všechno,
      co vrátí, je hypotéza k ověření, nikdy závěr. Platí pravidlo: když by vás
      chyba stála víc, než stojí hodina konzultace, jděte za advokátem — ale
      připravení, s pěti konkrétními body místo hromádky papíru.
  - q: "Co když je ve smlouvě odkaz na obchodní podmínky, které nemám?"
    a: >-
      Vyžádejte si je před podpisem a rozeberte stejným postupem — jsou závazné
      stejně jako smlouva a to zajímavé bývá právě v nich. Smlouva na dvě
      stránky se často odkazuje na čtyřicetistránkové podmínky; rozbor bez nich
      je rozbor poloviny.
  - q: "Co dělat s riziky, která se nepodařilo vyjednat?"
    a: >-
      Ohlídat je organizačně: připomínka v kalendáři na výpovědní lhůtu
      s předstihem, fotky bytu při převzetí, uložený e-mail s příslibem. A ptát
      se na alternativy — když nejde snížit pokuta, dá se zavést strop. Část
      nálezů jsou navíc teoretické možnosti, které vás nikdy nepotkají.
  - q: "Může mi AI smlouvu rovnou přepsat?"
    a: >-
      Nedoporučuje se — formulace, které vygeneruje model, vypadají dobře
      a můžou znamenat něco jiného, než čekáte. Návrh znění používejte jako
      popis toho, co chcete, ne jako text k vložení do smlouvy. A podepisuje
      výhradně člověk: nejistota před podpisem je levnější než jistota po něm.
---
