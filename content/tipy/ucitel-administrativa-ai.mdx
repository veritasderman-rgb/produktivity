...
excerpt: "Návod s prompty: tematické plány z ŠVP, podklady do výroční zprávy, posudky, žádosti o granty — a šablonovník, aby se stejný papír nepsal podruhé."
category: "ai"
platform: "vsude"
audience: ["ucitel"]
keys: []
...
updated: "2026-08-12"
tldr: >-
  Papírová část učitelské práce — tematické plány, výroční zprávy, posudky,
  žádosti o granty, inventury — je skoro celá mechanická, a přesně tu jde
  delegovat na AI: strukturu, formulaci, kontrolu proti zadání a sjednocení pěti
  verzí do šablony. Obsah, čísla a odpovědnost zůstávají vaše. Dvě pravidla nad
  vším: dokumenty s údaji žáků se anonymizují dřív, než je kamkoli vložíte, a co
  jde ven ze školy, podepisuje člověk.
faq:
  - q: "Můžu do chatu vložit dokument se jmény žáků?"
    a: >-
      Ne — anonymizujte dřív, než text kamkoli vložíte: jména nahraďte značkami,
      identifikátory smažte a hlídejte i formulace, které dítě identifikují bez
      jména („jediný chlapec, který dojíždí a má asistenta“). Citlivé věci patří
      jen do placeného účtu se smluvně ošetřeným zpracováním dat, ideálně do
      nástroje schváleného školou.
  - q: "Smí AI napsat čísla do výroční zprávy nebo rozpočtu?"
    a: >-
      Nikdy — když modelu číslo chybí, napíše takové, které do věty sedne,
      a vypadá věrohodně. Počty žáků, úspěšnost i rozpočtové položky se vkládají
      hotové ze systému nebo z tabulky; součty patří do tabulky, kde se dají
      přepočítat, ne do textu. I vložená čísla po přepisu ověřte proti zdroji.
  - q: "Může AI napsat slovní hodnocení nebo rozhodnout o žákovi?"
    a: >-
      Rozhodovat o dítěti AI nesmí — známku, hodnocení i doporučení určuje
      učitel. Model umí převést vaše průběžné poznámky do souvislého textu
      a upozornit na tvrzení bez opory. Bez podkladů nemá smysl prompt spouštět:
      vznikne jen soubor frází o snaze a potenciálu.
  - q: "Můžu se spolehnout na to, co model ví o dotační výzvě?"
    a: >-
      Ne — pravidla dotačních programů se mění každý rok. Pracujte výhradně
      s vloženým textem výzvy, nechte si ji rozložit na seznam otázek se
      značkou „ve výzvě nenalezeno“ u nejasností a sporné body ověřte
      u vyhlašovatele — pět minut telefonu chrání celou žádost.
  - q: "Jak si vyrobit šablonu opakovaného dokumentu?"
    a: >-
      Ne z jednoho dokumentu — z jedné verze vznikne kopie, ne šablona. Vložte
      několik loňských verzí téhož typu a nechte najít společnou strukturu,
      proměnná místa nahradit placeholdery a nekonzistence vypsat. Šablonu
      uložte do sdílené složky, ať ušetří práci celé sborovně, a jednou ročně
      ji zreviduje.
  - q: "Musím výstup před odesláním číst celý?"
    a: >-
      Ano — co jde ven ze školy, podepisuje člověk, a podpis znamená, že to
      četl celé. Zvlášť u zkrácených verzí pro vedení a zřizovatele se snadno
      vyrobí tvrzení, které jste nikdy nemysleli („dva žáci postoupili“ se
      změní na „žáci pravidelně uspívají“).
---
...
Druhá investice je popis prostředí, ve kterém pracujete: typ a velikost školy, ročníky a předměty, informační systém, jak se u vás jmenují dokumenty a v jakém formátu je vedení chce, slovník zkratek a kdo co schvaluje. Sepište to na stránku a uložte do [projektu s trvalým kontextem](/tipy/ai-projekty-kontext) — AI pak popis má u každého dokumentu a přestane si domýšlet, jak to u vás chodí.
...
Přehled nekonzistencí bývá překvapivě dlouhý, protože nikdo nepíše stejný dokument dvakrát stejně. Šablonu uložte tam, kde na ni dosáhnou kolegové: ta, kterou má jeden učitel v poznámkách, ušetří čas jednomu člověku. Jak vést knihovnu opakovaně použitelných textů, rozvádí tip [knihovna promptů](/tipy/ai-knihovna-promptu).
