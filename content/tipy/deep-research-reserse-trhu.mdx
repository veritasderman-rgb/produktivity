...
excerpt: "Kompletní návod s prompty: jak formulovat výzkumnou otázku, zadání, které vrátí použitelný report, kritické čtení výsledku a pět hotových use-casů."
category: "ai"
platform: "vsude"
audience: ["manazer", "marketer", "freelancer", "novinar"]
keys: []
saves: "~dny rešerše"
date: "2026-08-12"
updated: "2026-08-12"
tldr: >-
  Hloubková rešerše projde desítky webových zdrojů a vrátí strukturovaný report s citacemi — nahradí dny práce, ale report je materiál, ne rozhodnutí. Rozdíl mezi podkladem a hezky formátovanou směsí pravdy a výmyslů leží v zadání, které míří k rozhodnutí, v kritickém čtení výsledku a v proklikání citací u čísel. Návod přidává pět hotových use-casů od vstupu na trh po prověření dodavatele a spojení rešerše s vlastními daty firmy.
faq:
  - q: "Proč mi rešerše vrátila obecnou esej?"
    a: >-
      Protože zadání bylo téma, ne rozhodnutí. „Konkurence v Polsku“ vrátí popis trhu; zadání, ze kterého je jasné, mezi čím se rozhodujete, pro koho a v jakém rozsahu, vrátí podklad. Tahle jediná změna zlepší výsledek nejvíc — a hranice nastavte úzce, rozšířit se dá druhým kolem, zúžit už ne.
  - q: "Jak poznám, co je v reportu doložené a co odhad?"
    a: >-
      Vyžádejte si to ve struktuře: tři oddělené seznamy „jisté / pravděpodobné / odhad“ plus sekce „co se nepodařilo zjistit“. Přiznaná nejistota je informace, skrytá nejistota je riziko. A pozor: model občas označí za jisté i tvrzení podepřené jediným sekundárním zdrojem.
  - q: "Musím proklikávat citace, když je report tak podrobný?"
    a: >-
      Ano — proklikněte každé číslo, na kterém rozhodnutí závisí, a každé tvrzení, které použijete dál. Tři typická selhání: číslo je jinde než v citovaném zdroji, zdroj je z jiného roku, nebo mluví o jiném segmentu či zemi — velikost trhu za celou střední Evropu vydávaná za jednu zemi vypadá v reportu naprosto přirozeně.
  - q: "Co dělat, když první report tápe?"
    a: >-
      Nespouštět nový široký běh, ale nejdřív kritiku vlastního výstupu (kde jsou největší nejistoty, co by muselo platit, aby byl závěr špatně) a pak cílené druhé kolo jen na díry. První rešerše hlavně ukáže, na co se máte ptát podruhé.
  - q: "Můžu do rešerše zapojit interní čísla firmy?"
    a: >-
      Ano, a právě v porovnání reportu s vlastními daty vzniká většina hodnoty — ale interní čísla patří výhradně do placeného nebo firemního účtu se smluvní ochranou dat a co jde anonymizovat, anonymizujte. A zakažte modelu dopočítávat nová čísla: bez toho odhadne „přibližný podíl na trhu“, který nemá oporu.
  - q: "Rozhodne rešerše za mě?"
    a: >-
      Ne — a nemá. Report může říct, co trh dělá; jestli vstoupíte, za kolik prodáte a s kým podepíšete, rozhodujete vy. Dobrá rešerše nejistotu nesnižuje, ale zviditelňuje: řekne vám, co víte, co jen tušíte a co byste museli zjistit jinak — třeba telefonátem nebo u právníka.
---
