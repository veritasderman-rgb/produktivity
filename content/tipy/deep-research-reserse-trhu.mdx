...
Vrátí kritiku vlastního výstupu, obvykle konkrétnější než kritika od člověka, protože model má report celý v kontextu. Bod 2 je nejužitečnější — seznam podmínek, které stačí ověřit, abyste věděli, jestli závěr drží. Tvrdší oponentura je v tipu [AI jako oponent](/tipy/ai-oponent).
