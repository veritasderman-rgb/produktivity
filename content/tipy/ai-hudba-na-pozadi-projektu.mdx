...
excerpt: "Kompletní návod s prompty: anatomie hudebního zadání, cesta od variant k finální stopě a střízlivý rozbor licenční reality, kterou jiné návody přeskakují."
category: "ai"
platform: "vsude"
...
tested: "2026-08-15"
tldr: >-
  Generátory hudby obracejí hledání naruby: místo skladby, která se hodí, popíšete skladbu, kterou chcete — žánr, tempo, nástroje, náladu a hlavně zákazy. Řemeslo se naučíte za odpoledne; těžší je licenční realita: co s vygenerovanou stopou smíte dělat, závisí na tarifu v okamžiku vytvoření a podmínky se mění, takže je čtěte sami a ukládejte si jejich kopii s datem.
faq:
  - q: >-
      Co generátory hudby umějí nejlíp a kde mají hranice?
    a: >-
      Nejsilnější jsou instrumentální podkresy a krátké znělky — čím kratší úsek, tím míň prostoru na rozpad skladby. Delší skladby ztrácejí soudržnost, přesnou synchronizaci na obraz generátor neumí a stejné zadání podruhé nevrátí stejnou skladbu. Plánujte s tím, že finální stopa vznikne střihem z generovaného materiálu.
  - q: >-
      Proč je v zadání důležitější, co v hudbě být nemá?
    a: >-
      Protože nejčastější chyba podkresu je skladba, která je sama o sobě příliš zajímavá — posluchač ji začne poslouchat místo vás. Zákazy („bez zpěvu", „bez bicích", „bez výrazné melodie") posunou výsledek dál než tři přívlastky navíc; generátor bez zákazu vždycky přidá víc, ne míň.
  - q: >-
      Jak vybrat správnou variantu?
    a: >-
      Ne v tichu: skladba vybraná v tichých sluchátkách je typicky ta nejzajímavější — a nejzajímavější skladba je pod komentářem nejhorší. Vygenerujte šest až deset variant a poslouchejte je rovnou pod hotovým obrazem nebo pod svým hlasem, na zařízení, na kterém to bude poslouchat publikum.
  - q: >-
      Můžu stopu z bezplatného účtu použít komerčně?
    a: >-
      Obvykle ne — na bezplatném účtu bývá výstup určen pro osobní a nekomerční použití a rozhoduje plán v okamžiku vytvoření skladby, ne publikace. Stopa z volného účtu se obvykle nestane komerčně použitelnou tím, že si příští měsíc předplatíte vyšší tarif. „Komerční" navíc zahrnuje i zpeněžený kanál, reklamu a práci pro klienta.
  - q: >-
      Vlastním vygenerovanou hudbu?
    a: >-
      Licence od služby říká, co s výstupem smíte dělat — neříká, že k němu máte autorské právo. V řadě jurisdikcí vzniká ochrana jen pro dílo vytvořené člověkem, takže čistě generovaná stopa může být bez ochrany a nemusíte mít nástroj, jak zabránit ostatním v užití podobné stopy. Čím víc vlastního vkladu (text, aranž, sestřih), tím jinak celek vypadá.
  - q: >-
      Můžu si nechat licenční podmínky shrnout od AI?
    a: >-
      Ne — modely licenční texty zjednodušují a znají jen stav ke svému tréninku, zatímco podmínky se mění často a bez ohlášení. Od AI si vezměte checklist otázek, odpovědi hledejte v aktuálním znění podmínek sami a uložte si jejich kopii s datem do složky zakázky.
---
...
- **[Udio](https://udio.com)** — po dohodách s hudebními vydavateli se přestavuje na uzavřenou platformu: skladby žijí uvnitř služby a stažení souboru ven je omezené. Pro znělky a podkresy, které potřebujete jako soubor do střihu, je to v tuhle chvíli nepraktická volba.
