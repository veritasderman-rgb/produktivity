...
excerpt: "Kompletní návod s prompty: kdy zapnout AI vyhledávání místo Googlu, jak se ptát, aby odpověď stála na zdrojích — a kde nástroj spolehlivě selže."
category: "ai"
platform: "vsude"
...
tested: "2026-09-24"
tldr: >-
  AI vyhledávače vrátí odpověď, u které je vidět, ze kterého odkazu každá věta pochází — tvrzení s prokliknutelným zdrojem je podklad, tvrzení bez něj názor. Citace samotná ale nic negarantuje: model umí připojit odkaz k větě, kterou zdroj nepodporuje. Návod ukazuje, kdy AI vyhledávání zapnout místo Googlu, jak se ptát zadáním místo hesla a jak citace proklikávat tak, aby to zabralo minuty.
faq:
  - q: "Kdy použít AI vyhledávání a kdy klasický vyhledávač?"
    a: >-
      Když víte, na jakou stránku chcete, použijte vyhledávač — navigační otázky typu jízdní řád nebo dokumentace. Když víte, co chcete vědět, ale ne odkud to vzít, použijte AI vyhledávání — syntetické otázky, na které neodpovídá jedna stránka, ale musíte složit dohromady pět.
  - q: "Můžu věřit odpovědi, když u ní jsou citace?"
    a: >-
      Ne bez kliknutí — citace je pozvánka k ověření, ne důkaz. Model umí přestřelit formulaci (zdroj „naznačuje“, odpověď „prokazuje“), sloučit čísla z různých let nebo odkázat na stránku, kde tvrzené číslo vůbec není. Ani jedno nepoznáte z odpovědi, poznáte to jedním kliknutím a patnácti vteřinami čtení.
  - q: "Musím proklikávat všechny citace?"
    a: >-
      Ne, to je nereálné. Funguje pravidlo: proklikněte každé tvrzení, na kterém závisí rozhodnutí nebo které skončí v textu, který někomu odevzdáte — v praxi tři až pět citací. Priorita: čísla, tvrzení o kauzalitě, doslovné citace a všechno, co vás překvapilo.
  - q: "Co když model cituje článek, který studii jen převyprávěl?"
    a: >-
      Číslo, které putovalo přes tři převyprávění, cestou často změnilo význam. Doptejte se: „najdi tu původní studii a uveď její vzorek“ — a u důležitých zdrojů si nechte rozvést, co přesně se měřilo, jak velký byl vzorek a kdo výzkum zadal a zaplatil.
  - q: "Na co se AI vyhledávání nehodí?"
    a: >-
      Na čerstvé zprávy (index nemusí mít nejnovější stránky), lokální praktické informace jako otevírací doby (zdrojem je oficiální stránka nebo telefon), zdroje za paywallem (model zná jen abstrakt) a na zdravotní, právní a daňové otázky — tam slouží jen jako příprava na rozhovor s odborníkem.
  - q: "Můžu do dotazu napsat jména klientů nebo interní čísla?"
    a: >-
      Ne — citlivá data patří výhradně do placeného nebo firemního účtu se smluvní ochranou dat, a co jde anonymizovat, anonymizujte předem. Rešerše se skoro vždycky dá položit obecně: místo konkrétního klienta „firma s obratem v řádu desítek milionů v oboru X“.
---
...
- **[Gemini Notebook](https://notebook.google.com)** (dřívější NotebookLM — Google nástroj v červenci 2026 přejmenoval) — druhá polovina workflow: co si na webu najdete a stáhnete, sem nahrajte. Odpovídá jen z vašich zdrojů a cituje do konkrétního dokumentu, viz [vlastní zdroje v Gemini Notebook](/tipy/notebooklm-vlastni-zdroje).
