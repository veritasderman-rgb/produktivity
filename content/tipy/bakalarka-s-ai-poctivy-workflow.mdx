...
excerpt: "Velký návod se 30+ konkrétními prompty: od výzkumné otázky přes rešerši v NotebookLM a analýzu dat Python skripty až po sazbu, simulovaného oponenta a checklist před odevzdáním. Myšlení zůstává vaše — mechaniku dělá AI."
category: "ai"
platform: "vsude"
audience: ["student"]
keys: []
