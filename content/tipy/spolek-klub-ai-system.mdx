...
excerpt: "Kompletní návod s 25 prompty pro každého, kdo po večerech táhne spolek: jednotná vizuální identita přes Canva konektor, kalendář akcí jako zdroj pravdy, členská evidence s rolemi v Supabase, hromadné maily s osobním oslovením — a celý systém dokumentovaný tak, aby šel předat nástupci."
category: "ai"
platform: "vsude"
...
| Údaj | Zdroj pravdy | Odvozeniny (nikdy se needitují samostatně) |
| --- | --- | --- |
| Termín, čas, místo akce | událost v kalendáři sboru | plakát, pozvánka, e-mail, FB událost, rozhlas, vývěska |
| Vizuál (logo, barvy, písma) | mini brand + předlohy v Canvě | každý konkrétní plakát, diplom, obrázek na sítě |
| Kdo je člen, kontakty, role | členská evidence (Supabase) | adresáti e-mailů, seznam na diplomy, prezenčka VH |
| Kdo zaplatil příspěvek | tabulka prispevky | seznam dlužníků, upomínky, zpráva o hospodaření |
| Souhlasy (fotky, e-maily) | tabulka souhlasy | co smí do alba, kdo dostává poštu |
| Povinnosti a lhůty spolku | stanovy → výtah → opakované události | připomínky, program VH, termín rozeslání pozvánek |
| Jak se co dělá | provozní příručka | zaučení nástupce, rutiny, odpovědi na „jak se u nás…" |
...
- **Supabase** — členská evidence s rolemi a Row Level Security: členové, funkce, příspěvky, souhlasy. EU region, RLS od první migrace; podrobná stavba v [detailním návodu na CRM](/tipy/interni-crm-supabase-detailni-navod).
