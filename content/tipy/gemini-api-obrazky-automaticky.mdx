...
excerpt: "Kompletní návod s prompty: jedna vizuální identita a jeden příkaz — stylový prompt, skript od AI, dávkové generování, komprese do WebP a bezpečný API klíč."
category: "ai"
platform: "vsude"
...
updated: "2026-08-12"
tldr: >-
  Místo klikání v generátoru napíšete stylové zadání jednou, uložíte ho do souboru
  a skript (který vám napíše AI) pak vyrábí obrázky jedním příkazem — konzistentní,
  komprimované do WebP a pojmenované. Klíčem je odladit styl ručně na pěti různých
  motivech, než vznikne řádek kódu, držet API klíč mimo kód a nastavit si rozpočtový
  strop. Generuje stroj, publikuje člověk.
faq:
  - q: "Potřebuju umět programovat, abych si linku na obrázky postavil?"
    a: >-
      Ne. Skript si necháte napsat — vy rozhodujete o stylu a schvalujete výstup.
      Neumět kód napsat je v pořádku; nerozumět tomu, co skript dělá, v pořádku není,
      protože sahá na váš placený účet. Nechte si ho proto vyložit blok po bloku
      včetně míst, kde se mažou soubory a volá placené API.
  - q: "Jak zajistím, aby obrázky vypadaly jako jedna série?"
    a: >-
      Stylové zadání žije v textovém souboru a skript ho ke každému motivu připojí
      doslova — konzistence není v modelu, ale v tom, že se zadání nemění náhodou.
      Nejúčinnější nástroj je omezení počtu barev a blok zákazů (žádný text, loga,
      stíny). Styl pak měňte jen jednu věc naráz a přegenerujte celou sérii.
  - q: "Můžu skript nechat publikovat obrázky rovnou na web?"
    a: >-
      Ne — generuje stroj, publikuje člověk. Skript má ukládat do složky, protože
      generátory umí vyrobit deformovaný text, zvláštní anatomii nebo motiv, který se
      k tématu nehodí. I u sevřeného stylu se občas objeví útvar, který dává smysl
      jen modelu.
  - q: "Kam patří API klíč, když ne do kódu?"
    a: >-
      Do proměnné prostředí nebo souboru vyloučeného z verzování — nikdy do kódu, ani
      „dočasně“. Zveřejněný klíč najdou automatizované roboty během hodin a protočí
      ho za vaše peníze. Nepatří ani do chatu, issue nebo screenshotu; pro každý
      projekt mějte klíč zvlášť a při podezření ho hned zneplatněte.
  - q: "Co když mi dávka protočí rozpočet?"
    a: >-
      Nastavte si u poskytovatele rozpočtový strop a upozornění při blížícím se
      limitu, do skriptu přidejte počítadlo volání a tvrdý limit s potvrzením. Před
      velkou dávkou vždy spusťte nasucho běh — je to jediná pojistka proti tomu, že
      překlep v CSV vyrobí sto obrázků k ničemu.
  - q: "Smím vygenerované obrázky použít komerčně?"
    a: >-
      Ověřte si to v aktuálním znění licenčních podmínek přímo na webu služby, ne
      v odpovědi modelu — podmínky se liší službu od služby a mění se. Přečtěte si,
      co říkají o komerčním užití, právech k obrázku a povinnosti uvádět původ.
---
