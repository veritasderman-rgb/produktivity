...
Jeden motiv obvykle potřebujete ve víc podobách: široký nahoru do článku, čtvercový do náhledu, na výšku na sociální sítě. Do skriptu se to přidá jako další krok — zadejte konkrétní rozměry, trvejte na tom, že se má **ořezávat, ne roztahovat**, a nechte si výsledky uložit pod jasně odlišenými názvy. Ořez je zdarma a okamžitý, ale u kompozice postavené na šířku uřízne půlku motivu; u klíčových obrázků se proto vyplatí radši vygenerovat druhý obrázek přímo v jiném poměru s upraveným zadáním kompozice.
