...
## Chcete rovnou hotový příklad?

Kdo nechce číst teorii a rád si nejdřív prohlédne, jak to vypadá poskládané, může přeskočit rovnou na linku **Vzorové sestavy**: [herní PC, tři předplatná, GitHub a pár webů](/agenti/sestava-herni-pc-tri-predplatna) je ta nejběžnější česká situace i s tím, co se dá zrušit a kdy se vyplatí přejít z předplatného na API. Druhá sestava, [tichý server na noční směnu](/agenti/sestava-tichy-server-nocni-smena), ukazuje, co se změní, když stroj běží pořád. A třetí, [dynamický web s Claudem](/agenti/sestava-dynamicky-web-s-claudem), jde jiným směrem — žádné vlastní železo, jen účet, GitHub a rutina, která každé ráno napíše návrh článku a čeká na schválení.

Zbytek seriálu pak rozebírá jednotlivé díly obou sestav do hloubky.
