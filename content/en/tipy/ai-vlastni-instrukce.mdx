...
excerpt: "A complete guide to standing instructions: what belongs in them and what doesn't, how they differ from a Project and from a single prompt, how to test them — and ready-made sets to copy for a manager, a student, a freelancer, and a developer."
category: "ai"
platform: "vsude"
audience: []
keys: []
