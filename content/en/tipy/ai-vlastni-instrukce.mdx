...
updated: "2026-08-12"
tldr: >-
  Custom instructions are a few sentences in your account settings that get added to every new conversation — written well, they save you the first two messages of every one. A working set has four blocks: who you are, answer format, tone, and prohibitions, and only contains what applies across everything you do. The guide adds ready-made sets for a manager, student, freelancer, and developer, plus a way to test the instructions and prune them quarterly.
faq:
  - q: "What belongs in custom instructions and what belongs in a Project?"
    a: >-
      Custom instructions describe you; a Project describes one area of your work. The test: would the rule also apply to a conversation about a completely different topic? If not, it belongs a layer down — you can also tell by a condition at the start: an instruction beginning with “for,” “when,” or “in the case of” almost always belongs in a Project.
  - q: "Why doesn't the instruction “answer concisely” work?"
    a: >-
      Because everyone pictures conciseness differently — it's a general, unverifiable phrase. A strong instruction describes structure and length in numbers: how many bullets, what comes first, when to use a table. A specific rule can be both followed and checked.
  - q: "Can I put client names or my current project into the instructions?"
    a: >-
      No. Instructions are sent with every conversation, so sensitive data leaves your computer even with the most trivial question — it belongs only in a paid account with contractual data protection, and even there anonymized. And changing context (project, client, deadline) becomes untrue in two months while the model keeps counting on it.
  - q: "How do I know my instructions actually work?"
    a: >-
      By testing: take three typical tasks from your work, run them in a new conversation, and count how many corrections you had to type. Zero to one means the instructions fit; three or more means what you're fixing is missing from the instructions or written too vaguely to follow. Rerun the trio a month later — and after a major model update too.
  - q: "What if the model ignores one of my rules?"
    a: >-
      The most common cause is ambiguity or a conflict between two rules — typically “write concisely” versus “always list all the alternatives.” Have the answer checked rule by rule and settle the conflict: keep one rule, and request the other in the prompt when you actually need it.
  - q: "How long should the instructions be?"
    a: >-
      On the order of dozens of lines, roughly two to three hundred words — the longer the set, the weaker each individual rule. Move long reference material and single-area rules into a Project, and prune the instructions once a quarter: whatever hasn't changed an answer lately goes out.
---
