...
excerpt: "A complete guide with prompts: how to dictate so the transcript is actually usable, how to tidy it into an email, meeting notes, or a draft with a single prompt, how to handle long texts block by block, and how to turn walks and commutes into writing time."
category: "ai"
platform: "vsude"
