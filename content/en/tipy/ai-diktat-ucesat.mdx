...
tested: "2026-08-15"
tldr: >-
  Talking is roughly three times faster than typing — and a raw transcript is not a text, it's raw material. Dictate your thoughts in blocks with spoken voice tags, then have the output tidied up with a prompt built for the purpose: an email, meeting notes, tasks, or a draft. The check always stays with you — the model can quietly make your claims more confident or add a sentence you never said.
faq:
  - q: >-
      Do I have to dictate in finished sentences?
    a: >-
      No — trying to dictate finished sentences leads to getting stuck on phrasing, long silences, and a half-empty recording. Talk in blocks of thought instead: one topic for as long as something occurs to you, then move to the next. Let the filler, repetition, and tangents stand — removing them is exactly the work AI does well and fast.
  - q: >-
      Should I dictate punctuation (“comma,” “period”)?
    a: >-
      For a short message typed straight into a field, spoken punctuation is worth it. If the transcript is heading into AI anyway, don't bother — it breaks up the flow of speech, and AI will add it better than you'd dictate it.
  - q: >-
      What if the model adds something to the text I never said?
    a: >-
      That's exactly the biggest risk: models make claims more confident (“we'll probably make it” turns into “we'll make it”) and add logical-sounding sentences you never said. When the content matters, have the model list every place where the meaning changed, and always read the text before sending — the human sends.
  - q: >-
      How do I dictate a longer text, like an article?
    a: >-
      Not in one half-hour take — a long transcript turns to mush. First dictate a one-minute skeleton and approve the outline, then dictate in blocks of three to five minutes, each with a context header, and finally have them stitched together with a prompt that bans rewriting your sentences and adding content.
  - q: >-
      How do I keep the result from sounding like generic AI prose?
    a: >-
      Give the model real samples of your writing, not a description of your style — have it turn them into an instruction and attach it to every cleanup prompt, or put it straight into your custom instructions. Whenever the output contains a phrasing you'd never use, that's a workflow bug, not an improvement.
  - q: >-
      Can I say client names and contract numbers while dictating?
    a: >-
      They slip into a stream of speech easily, but before you feed the transcript into AI, replace specific identifiers with a more general description (“client A”) — it doesn't affect how the text gets organized. Genuinely sensitive content belongs only in a paid account with a contractual data-protection agreement, never a freely available chat.
---
