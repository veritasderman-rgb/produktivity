...
excerpt: "A complete guide with prompts: campaign structure from goal to format, personas built on real data instead of guesswork, seven copy angles for A/B testing, a creative brief for a designer or a generator, and reading an export — including what CTR, CPC, and cost per conversion actually mean."
category: "ai"
platform: "vsude"
...
Petra runs a two-person studio and sells an online course. Last year she tried advertising: three ads with a stock photo and the copy “Finally learn to do it properly,” a month of runtime, forty thousand crowns gone. Nine orders came in and she had no idea which ad brought them or which audience — the dashboard showed hundreds of rows and no answer.
...
Budget and duration: [e.g. $800 over 4 weeks]
...
angle-pain-A          42,180      912   2.16%  $0.16       18      $8.65
angle-proof-C         29,510      410   1.39%  $0.24        4     $25.83
angle-curiosity-D     51,220    1,184   2.31%  $0.15        2     $93.72
angle-humor-E         22,700      188   0.83%  $0.29        0          —

Total: $520, 35 conversions, average $14.86
```
