...
excerpt: "A guide with prompts: steering translation with your own samples, translation versus localization, back-translation checks, and glossary workflows."
category: "ai"
platform: "vsude"
...
updated: "2026-08-12"
tldr: >-
  Translation isn't a search for equivalents — it's a decision about how the sentence would sound if someone from the target culture had written it from scratch, and that decision has to be handed to the AI. The strongest technique is steering tone with two or three of your own samples instead of adjectives; the most important check is back-translation, which exposes shifts in commitment (“includes” becoming “may include”). Recurring translations get faster with a Project holding a glossary and templates.
faq:
  - q: >-
      Why does my translated text sound machine-made even when the grammar is right?
    a: >-
      The mistakes come in three layers: a long compound sentence translated one-to-one reads like a legal document, the politeness register doesn't translate but has to be set (excess formality reads as distant in some cultures), and idioms need a functional equivalent, not a literal transfer. The word “translate” by itself is an instruction for the most boring possible output.
  - q: >-
      How do I tell the model what tone to translate in?
    a: >-
      Don't show it adjectives, show it texts: “professional but friendly” means something different to everyone. Paste two or three of your own texts in the target language and say “like this” — they carry information about sentence length, greetings, and politeness levels you could never describe in words.
  - q: >-
      How do I check a translation into a language I can't judge?
    a: >-
      With back-translation: have the text translated back with the instruction “don't improve it” and compare it against your original. The most dangerous shift isn't a dictionary mistake but a change in the degree of commitment — “includes” becoming “may include” sounds acceptable and means different money. Check commitments, conditions, deadlines, and numbers especially.
  - q: >-
      How is localization different from translation?
    a: >-
      Translation converts sentences; localization converts the whole text so it makes sense in the target country: domestic institutions and IDs, date and number formats, units, cultural references, and the degree of directness. For law, taxes, and warranties, localization stops — there it's material for a specialist in local regulations, not binding text.
  - q: >-
      Can I paste a contract with names and account numbers in for translation?
    a: >-
      The translation itself usually doesn't need that data — replace it with placeholders (“Client A,” “amount X”) and add it back into the finished text; tone and meaning survive just fine. Where you must work with sensitive data, the rule applies: only in a paid account with a contractual data-protection agreement.
  - q: >-
      How do I speed up translations I do over and over?
    a: >-
      Set up a Project for each language pair: your style description and rules in the instructions, samples and a glossary — a table of terms that always translate the same way — in the files. Then you just paste text and write “translate according to the project's rules.” For texts that only change in details, have a set of fill-in templates made and skip translating entirely.
---
