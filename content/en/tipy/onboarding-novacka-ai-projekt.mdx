...
excerpt: "A complete guide with prompts: what to upload into the Project, instructions so AI doesn't guess, and getting a new hire to ask it instead of colleagues."
category: "ai"
platform: "vsude"
audience: ["manazer"]
keys: []
...
updated: "2026-08-12"
tldr: >-
  Most of a new hire's questions in the first weeks have an answer that's already
  written down somewhere — nobody just knows how to find it. A Project in AI with
  uploaded procedures and the instruction “answer only from the documents; when
  unsure, point to a person” makes it available anytime, without embarrassment. It's
  built in one afternoon from what already exists (nothing new gets written), and
  the most valuable by-product is the list of unanswered questions — a precise
  audit of what lives only in people's heads.
faq:
  - q: "Do I have to write new documentation for the Project?"
    a: >-
      No — the principle is to write nothing new. Upload what exists, even if it's
      incomplete: procedures, wiki pages, templates, an FAQ from the team chat, the
      org chart, and a glossary of internal jargon. The gaps will be revealed by
      use itself — the questions the Project couldn't answer are the cheapest
      documentation audit you'll ever get.
  - q: "What must never go into an onboarding Project?"
    a: >-
      Only the part of the documentation anyone on the team would show a new hire
      without hesitation belongs in it — out go salaries, people evaluations, trade
      secrets beyond the role, and clients' personal data. Watch out for hidden
      spreadsheet tabs (a price list with a margins sheet), and run the Project on
      a company account with contractual data protection, not a manager's personal
      account — otherwise it leaves with them.
  - q: "How do I stop the AI from inventing a missing procedure?"
    a: >-
      With the instruction that is the heart of the whole thing: answer exclusively
      from the uploaded documents, cite the source with every answer, and when the
      answer isn't in the materials, say so explicitly and point to a specific
      person. Before handing it over, test it with a question whose answer isn't in
      the documents — if you get a substantive answer instead of an admission, the
      instructions aren't working.
  - q: "Won't this come across as fobbing the new hire off onto a robot?"
    a: >-
      Phrasing decides: “I've set up a Project for you — ask it anything, even the
      same thing five times, and when it can't answer, come to me and we'll add it”
      gives an extra tool, not a barrier. Also define what to ask people about:
      context, reasons, decisions, and anything not in the documents. The goal
      isn't zero questions to colleagues — it's shifting them toward “why.”
  - q: "How often should the Project be updated?"
    a: >-
      A quarterly review, fifteen to thirty minutes, fixed in the calendar. A stale
      Project is worse than none — it answers with last year's truth and the new
      hire has no way to tell. Three habits make it cheap: a validity date in the
      document name, one version instead of three, and an owner for every document.
  - q: "Can a new hire approve a discount based on a Project answer?"
    a: >-
      No — the Project answers, a human decides. Discounts, exceptions, contracts,
      and anything with legal or financial impact are approved by the person in the
      approval matrix, not by a chat answer. A tool that speeds up onboarding must
      not remove the checkpoints.
---
