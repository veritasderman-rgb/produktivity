...
excerpt: "Our most comprehensive guide: AI rollout from the data foundation through tools and policy to self-monitoring meetings. 50+ prompts and a 90-day plan."
category: "ai"
platform: "vsude"
audience: ["manazer"]
keys: []
...
updated: "2026-08-12"
tldr: >-
  The difference between a company where AI demonstrably saves hundreds of hours and one where a few people pay for a chat subscription isn't money or technology — it's the order of the steps: data, rules, and people first, the tool only afterward. This guide spells that order out in six parts that build on each other, with 50+ prompts, a sample policy, and a 90-day plan. One rule holds it all together: AI proposes, a human approves.
faq:
  - q: >-
      Where should a company start with an AI rollout?
    a: >-
      Not with a tool. Companies where AI works started with data, rules, and people — the tool came only afterward. Without the data foundation everything else is a battery-powered toy, which is why Part 1 of the guide is a data inventory, metadata, and cleaning up the company corpus.
  - q: >-
      Is it enough to buy licenses and let people experiment?
    a: >-
      Licenses with no policy is one of the most common mistakes: within a month, half the company has sensitive data sitting in personal accounts and nobody knows where. A one-page policy with data classification beats a twenty-page treatise — the complete sample is in Part 3.
  - q: >-
      Who should be the company AI champion?
    a: >-
      A respected practitioner, not a technician from IT. The team reads an IT champion as a directive from above — a respected practitioner beats an enthusiastic technician every time.
  - q: >-
      How many automations should we roll out at once?
    a: >-
      Few, and measured. Eight automations at once means that when five of them don't work, nobody can tell which or why. The proven format is a pilot: 5–10 people, 6 weeks, measured numbers.
  - q: >-
      How do we know the rollout worked?
    a: >-
      Only against a baseline — without pre-rollout numbers, success can't be proven or disproven. And don't measure prompt count; people start producing prompts just for the statistic. What to measure and what is theater is covered in Part 6.
  - q: >-
      When is an AI rollout finished?
    a: >-
      Never entirely. Without a quarterly review the system ages within a year — price lists change, and so do people and roles. “We rolled it out” is the last of the eight most common company mistakes.
---
