...
updated: "2026-08-12"
tldr: >-
  AI can take the mechanics of hiring off your hands: a job description built from
  the team's reality, a scorecard written before the first résumé, structured
  extracts from applications against your criteria, interview questions, and decent
  rejections. But it has the hardest line on this site: it must never rank, score,
  or recommend candidates — the EU's AI Act classifies AI in recruitment as
  high-risk, and the decision is made by a named human who can justify it without
  pointing at the tool.
faq:
  - q: "Why must AI never rank applicants by fit?"
    a: >-
      Ranking is a decision about people, even if you formally confirm it — in
      practice you'll only rarely depart from the order the tool presents. The model
      also reproduces bias from the data it learned from (names, schools, résumé
      gaps), and the EU's AI Act classifies recruitment systems as high-risk, with
      obligations like human oversight and a documentable process.
  - q: "So what may AI do when sorting applications?"
    a: >-
      Convert disparate material into a uniform structure, list what a résumé
      contains for each criterion and what's missing, find inconsistencies in the
      timeline, prepare follow-up questions, and summarize the cover letter — tasks
      where it works with the text in front of it and the result can be verified.
      It must not assign scores, rank, recommend, or infer traits from the material.
  - q: "Why write the evaluation criteria before the first résumé arrives?"
    a: >-
      Criteria written after reading the applications aren't criteria — they're a
      rationalization of what you liked. The scorecard — four to six observable
      criteria with described levels — is created up front and filled in identically
      for every candidate. Avoid “culture fit”: it's the most common cover for
      deciding by sympathy.
  - q: "What is a structured interview and why is it worth it?"
    a: >-
      Three things: the same questions for everyone in the same order, evaluation
      against pre-written criteria, and notes taken immediately. The unstructured
      interview is one of the worst-predicting selection tools in common use — and
      the structured one is the cheapest quality improvement in hiring that exists.
      Ask about the past, not hypotheticals.
  - q: "Can I paste résumés into a free chat?"
    a: >-
      No — a résumé is a collection of personal data and belongs only in a paid
      account with contractual data protection. For an extract against criteria, the
      professional part is enough anyway: you can remove the name, contact details,
      birth date, and photo and work with “candidate 7,” which incidentally also
      shrinks the room for bias.
  - q: "What happens to candidates' materials after hiring ends?"
    a: >-
      Process them only for the purpose of that specific hiring round, and delete
      unsuccessful candidates' materials once it ends. Keeping them longer “in the
      database” requires revocable consent, and candidates should be told in the ad
      itself how you handle their materials. Set a reminder for the deletion — it's
      the step everyone forgets once the position is filled.
---
