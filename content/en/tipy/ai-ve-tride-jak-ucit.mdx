...
excerpt: "A complete guide with prompts: assignments AI can't do for a student, simple classroom rules, defending your own writing instead of a witch hunt, AI as an in-class tool, and a hands-on demonstration of hallucinations. Includes what to do about an essay ChatGPT wrote."
category: "ai"
platform: "vsude"
audience: ["ucitel"]
keys: []
