...
updated: "2026-08-12"
tldr: >-
  A blanket AI ban at school can't be enforced, punishes the honest students, and misses what actually needs to be taught — a more useful goal is “make sure they keep learning something.” The guide covers three rule zones instead of a ban, AI-resistant assignments (personal experience, in-class work, grading the process, a short defense), conversation instead of detectors, and lessons where students see for themselves that the model makes things up.
faq:
  - q: "Can I rely on an AI-text detector when grading?"
    a: >-
      No — detectors don't have the reliability a decision about a student's grade would require. They falsely flag plainly written texts, texts by students writing in a non-native language, and proofread texts, and they're trivially bypassed by rephrasing. A detector must never be the basis for a grade or a disciplinary measure — at most it's a nudge to ask.
  - q: "What should I do when I suspect a paper was written by AI?"
    a: >-
      Conversation instead of accusation: one on one, with questions about specific places in the work — why this example, what does this sentence mean. A student who didn't write the text can't answer questions about their own work; and one who answers everything probably did write it, and you were wrong. That's a result too, and a better one than grading by detector.
  - q: "How do I write an assignment AI can't do for the student?"
    a: >-
      Not by making it harder, but by building in something the model doesn't have: personal experience and local context, in-class work on a topic set that day, grading the process (outline, drafts, notes) rather than just the result, and a two-minute defense of the submitted text. The goal is to lower the payoff of cheating — when the honest path is faster, most of the class takes it.
  - q: "Shouldn't I just ban AI in my subject?"
    a: >-
      A blanket ban can't be enforced, disadvantages the students who follow it, and misses a skill they won't learn anywhere else. A working agreement doesn't answer “is AI allowed?” but “for what, and how”: three zones — no AI, AI with disclosure, AI freely — and for each assignment you say which zone it belongs to.
  - q: "Can I sit students down with AI tools during class?"
    a: >-
      Only within a frame you control: you prepare the ready-made prompt for the model, not a blank window. And mind the rules that can't be worked around — AI services have age limits and terms of use to verify with the specific service and your school's leadership, and students' personal data never goes into the tools.
  - q: "How do I teach students that the model makes things up?"
    a: >-
      Explaining it has almost no effect — showing it has an enormous one. Run a lesson where students experience the model confidently lying: a question about something that doesn't exist, a detail of local history, a quote from a book. The takeaway isn't “the model can't be trusted” but “you can't tell from the output whether it can be trusted, so you always verify.”
---
