...
excerpt: "A complete guide with prompts for orchestrating subagents: when one agent isn't enough, how to write an instruction file, how to split work into batches, how to check results with a script instead of reading by hand. Case study: 250+ tips and translating a whole website."
category: "ai"
platform: "vsude"
