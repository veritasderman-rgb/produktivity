...
excerpt: "A complete guide with prompts: what to upload to a Project, how to write project instructions, when to start a new project instead of overloading one, how to distill lasting context out of conversations, and how to maintain a project so it doesn't lie to you six months in."
category: "ai"
platform: "vsude"
