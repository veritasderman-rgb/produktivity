...
excerpt: "A guide with prompts for the PhD week: a research routine with citations, prepping exercises, grading tests, and admin — AI stays strictly an advisor."
category: "ai"
platform: "vsude"
...
updated: "2026-08-12"
tldr: >-
  Much of the PhD week is mechanics AI can handle for you: a Monday research routine with citations, a library of papers that answers questions, exercises prepped from your own materials, grading suggestions based on your rubric, and templates for repeated questions. What it can't handle is the part that matters: your own research idea, the responsibility for a grade, and the relationship with students. Student data belongs only in an institutional account, anonymized and in line with your faculty's rules.
faq:
  - q: "Can AI grade the tests?"
    a: >-
      No — the instructor assigns the grade. AI may be a fast first reader that suggests points per your rubric and justifies them, but you review and sign off on every suggestion. The grading must be defensible without reference to the tool: “that's how the AI scored it” is not an answer you can say to a student.
  - q: "What must I do before uploading student tests?"
    a: >-
      Anonymize: cover the header with the name, assign each test a sequence number, and keep the name–number key to yourself. Use an institutional or paid account with contractual data protection, not a free chat, and check your university's rules — some faculties explicitly regulate uploading student work to external services.
  - q: "Can I trust the papers the research routine finds?"
    a: >-
      Only after verification — models generate plausible-looking nonexistent papers with real authors and believable DOIs. Every source you record must be opened in a database, ideally via your university's access. What you can't find doesn't exist.
  - q: "Why use NotebookLM instead of a regular chat for the literature?"
    a: >-
      Because it answers only from what you upload and shows a citation into a specific source for every answer — it doesn't mix your literature with what it holds in memory, and when the answer isn't in the uploaded papers, it says so. Practically: one notebook per topic, not per dissertation.
  - q: "How do I keep grading consistent across the whole set?"
    a: >-
      First have your rubric reviewed (where it's ambiguous, what alternative correct solutions it misses), then run a consistency check across the set: identical answers with different points, suspicious spread. And the extra check: grade three tests fully yourself without looking at the suggestions and compare — if one in three differs, the problem is the rubric.
  - q: "Do I have to disclose AI use somewhere?"
    a: >-
      Yes — universities and journals have rules that are being written right now and change every year. Find your faculty's policy and the journal's author guidelines before deploying the tool, and disclose specifically: for what exactly, which tool, and what you verified yourself. “AI was used in writing” says nothing.
---
