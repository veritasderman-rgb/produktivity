...
excerpt: "A guide with prompts: pacing guides from the curriculum, annual-report input, references, grants — and templates so the same paperwork is written once."
category: "ai"
platform: "vsude"
audience: ["ucitel"]
keys: []
...
updated: "2026-08-12"
tldr: >-
  The paperwork side of teaching — pacing guides, annual reports, recommendation
  letters, grant applications, inventories — is almost entirely mechanical, and
  that's exactly what can be delegated to AI: structure, wording, checking
  against requirements, and merging five versions into one template. The content,
  the numbers, and the accountability stay yours. Two rules above everything:
  documents with student data get anonymized before they go anywhere near a chat,
  and whatever leaves the school, a human signs.
faq:
  - q: "Can I paste a document with students' names into a chat?"
    a: >-
      No — anonymize before you paste anything: replace names with tags, delete
      identifiers, and watch for phrasing that identifies a child without
      a name (“the only boy who commutes and has an aide”). Sensitive material
      belongs only in a paid tool with a contractual data-processing agreement,
      ideally one the school has approved.
  - q: "May AI write the numbers in an annual report or a budget?"
    a: >-
      Never — when the model lacks a number, it writes one that fits the
      sentence and looks plausible. Student counts, success rates, and budget
      lines get pasted in ready-made from the system or a spreadsheet; totals
      belong in a spreadsheet where they can be recalculated, not in prose.
      Verify even pasted numbers against the source after rewording.
  - q: "Can AI write a report card comment or decide about a student?"
    a: >-
      AI must not decide about a child — grades, evaluations, and
      recommendations are the teacher's call. The model can turn your ongoing
      notes into flowing text and flag claims without evidence. Without notes
      there's no point running the prompt: you'd get generic phrases about
      effort and potential.
  - q: "Can I rely on what the model knows about a grant program?"
    a: >-
      No — grant rules change every year. Work strictly from the pasted text of
      the call, have it broken down into a question list with a “not found in
      the call” tag for gaps, and verify unclear points with the grantor —
      a five-minute phone call protects the whole application.
  - q: "How do I build a template for a recurring document?"
    a: >-
      Not from a single document — one version produces a copy, not a template.
      Paste several past versions of the same type and have the shared
      structure found, variable spots replaced with placeholders, and
      inconsistencies listed. Store the template in a shared folder so it saves
      the whole staff room time, and revise it once a year.
  - q: "Do I have to read the output in full before sending?"
    a: >-
      Yes — whatever leaves the school, a human signs, and the signature means
      they read all of it. Especially in shortened versions for administration
      or the district, a claim you never intended is easy to manufacture (“two
      students advanced” becomes “our students regularly succeed”).
---
