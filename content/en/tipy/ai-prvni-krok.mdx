...
excerpt: "A complete guide with copy-paste prompts: how to pick a tool, what to type into the first empty box, and telling a good answer from plausible nonsense."
category: "ai"
platform: "vsude"
...
tested: "2026-09-10"
tldr: >-
  Don't treat AI like a search engine or a magician — treat it like a fast, well-read colleague who's occasionally, confidently wrong: someone you hand work to and whose output you always sign off on yourself. The guide walks from choosing a tool through the first conversation (hand it a task, not a topic) and ten tasks by profession to the checks that expose good-sounding nonsense.
faq:
  - q: >-
      Which AI tool should I pick first?
    a: >-
      For a beginner, the differences between the main tools are far smaller than the difference between “I use it” and “I don't.” Pick one — ChatGPT, Claude, or Gemini if you live in Google's tools — and stay with it for a week; habit beats optimization. After a month you can run the same request elsewhere and compare with your own eyes.
  - q: >-
      Why does AI give me generic fluff?
    a: >-
      Because you handed it a topic instead of a task. “Something about team motivation” returns an essay; “I have a Monday meeting after a lost tender, prepare a structure so it doesn't turn into blame-hunting” returns something usable. A request needs who you are, what exactly you want, what you have, and what the output should look like — and let it ask you five questions before it starts.
  - q: >-
      Do I need a paid account right away?
    a: >-
      No, start free. A paid account makes sense once you hit one of three walls: daily message limits, longer documents, or the need to feed in data you care about protecting. Sensitive information belongs only in a paid account with contractual data protection — and don't put it in a free chat at all.
  - q: >-
      How do I tell when the model is making things up?
    a: >-
      Not by tone — it gets things wrong in the exact same tone it uses for the truth. Ask three questions: could it have known this? Is it a verifiable claim or just nice phrasing? What happens if it's wrong? Verify every number, citation, and link that goes into a decision or out of the company against the source.
  - q: >-
      What should I try in week one, and what should I avoid?
    a: >-
      Start with work where both input and output are text and you can judge quality by eye: first drafts of emails, document summaries, meeting notes, explanations, brainstorming. Avoid precise arithmetic over a large table (the model isn't a calculator), recent events without web search, and anything that would go out without your review.
  - q: >-
      Can AI send emails for me directly?
    a: >-
      No — the machine proposes, the human approves. Sending, payments, deletions, signatures, and grades are always approved by a person; no email leaves without you reading it in full. It's your name under that output, not the model's.
---
...
- **Gemini Notebook** (formerly NotebookLM) — when you need certainty that the answer comes strictly from your own uploaded material; good for studying and research.
