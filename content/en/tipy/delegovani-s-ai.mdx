...
excerpt: "A guide with prompts: an assignment template with context, deadline, and boundaries, check-ins instead of micromanagement, and an audit of your calendar."
category: "ai"
platform: "vsude"
audience: ["manazer"]
keys: []
...
updated: "2026-08-12"
tldr: >-
  Delegation fails on the assignment: most bad assignments aren't imprecise, they're incomplete — missing context, output description, boundaries, and escalation. AI can turn one sentence into a structured five-field assignment and, more importantly, read it through the eyes of someone without your context and show where they'll fill in the gaps wrong. The guide also covers delegation levels (do / propose / decide), check-ins instead of micromanagement, handling boomeranged tasks, and an audit of your own calendar.
faq:
  - q: "Why do delegated tasks keep coming back to me?"
    a: >-
      For three reasons that cover almost everything: missing context (the person doesn't know why, so they can't decide at a crossroads), missing output description (“prepare materials” is an area, not an output), and missing boundaries (what they may do alone, what they may not). Both look like the person's fault and are the assignment's fault.
  - q: "What should a good assignment contain?"
    a: >-
      Five fields: context (why and who uses the output), the output with check-off-able done criteria, a concrete deadline, boundaries (what they may do alone, what's out of scope), and escalation with a concrete trigger. Escalation is the field most often left out — and it saves the most: without it, a person either quietly battles an obstacle for three days or shows up at the first snag.
  - q: "How do I check the assignment is understandable?"
    a: >-
      Have the model read it as a junior who has never done this type of task — you can't read your own assignment objectively, because your head holds everything it's missing. The best diagnostic is having it describe the first three steps: when they head somewhere other than you expected, the assignment really does point there.
  - q: "Can AI pick the delegation level?"
    a: >-
      No — choosing between “do,” “propose,” and “decide” is a management decision, because it depends on the risk and on the person, whom the model doesn't know. AI is good at laying out the consequences of each level, which is exactly the part a busy manager skips. And if you've approved someone's proposals unchanged for three months, it's time to promote the level.
  - q: "How do I hand back a task someone quietly returned to me?"
    a: >-
      First distinguish what they're missing: information (provide it), authority (an assignment flaw — add boundaries), or just confidence — the most common case, where they know the answer and want someone else to say it. There, a question works better than an answer: “what would you do, and why?” The test: who takes the next step after the conversation?
  - q: "Can I paste my calendar into a chat for a delegation audit?"
    a: >-
      Only carefully — a calendar is a sensitive document with names, clients, and sometimes HR meetings. Work in a paid business account with contractual data protection and replace names with roles: for the audit, “meeting with a supplier” is enough, not the specific company.
---
