...
excerpt: "A complete guide with seventeen prompts: the official Meta Ads connector via Meta Business login, the official local Google Analytics MCP server from the Google Analytics team, questions to ask over campaigns and traffic, combining both sides into a single picture, and limits that belong on the platform, not in the prompt."
category: "ai"
platform: "vsude"
