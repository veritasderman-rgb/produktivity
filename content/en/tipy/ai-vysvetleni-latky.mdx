...
excerpt: "A complete guide with prompts: explanations at your level, the Feynman technique, test questions from your notes, and the trap of illusory understanding."
category: "ai"
platform: "vsude"
...
updated: "2026-08-12"
tldr: >-
  AI is the most patient teacher you'll ever have — it explains the same thing a sixth time in a different way and at your level, if you tell it what you already know and what you don't. But the difference between learning and the pleasant feeling of learning is activity: an explanation is a starting point, not the goal. The guide runs from setup through the Feynman technique (you explain, AI hunts for holes) and worked examples to test questions from your own notes and an exam plan.
faq:
  - q: "Why does AI explain the material too abstractly or too generally?"
    a: >-
      It's usually not the model's fault but the prompt's — without context you get an answer calibrated to the average of the internet, i.e., to nobody. Set up your study profile once: field, year, what you already know, and what not to assume. The “what I don't know yet” list is the more valuable half; without it the model explains one unknown term using three others.
  - q: "Isn't it enough to have the material explained and read it?"
    a: >-
      No — that's the biggest trap of the whole approach. The “aha, got it” feeling is the fluency of the text, not your knowledge; after an hour of reading you leave with higher confidence and the same knowledge. The defense: one recall attempt for every explanation read — close it, write it in your own words, only then compare.
  - q: "What is the Feynman technique with AI?"
    a: >-
      The reversed procedure: close the textbook, write your own explanation of the material from memory, and let AI hunt for errors, holes, and places where you use a term as an incantation. Three rounds are usually enough — you're done when the feedback returns refinements instead of errors. It's the strongest technique in the guide and also the least comfortable.
  - q: "Can I trust the numbers the model calculates?"
    a: >-
      No — the model is not a calculator; it produces intermediate results as text, not computation. Recheck every number, and for more complex calculations have it write a script or redo the result on a calculator.
  - q: "Can I have exam questions generated from general knowledge?"
    a: >-
      Better not — the source should be your notes, your textbook, and your lecturer's slides, otherwise the questions miss the syllabus. And forbid the model from filling gaps with its own knowledge, or you'll study things that were never said in the lecture. For the exam, what your instructor teaches is what counts.
  - q: "Will AI tell me whether I'll pass the exam?"
    a: >-
      Treat its assessment as orientation, not a grade — the model doesn't know how your course is scored and tends to be either kinder or harsher than reality. It's feedback, not a result: AI suggests, a human grades, and it's you sitting the exam.
---
