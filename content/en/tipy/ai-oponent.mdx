...
excerpt: "A complete guide with prompts for hard critique: untraining AI from agreeing with you, decision premortems, red-teaming a proposal — and when to ignore it."
category: "ai"
platform: "vsude"
...
tested: "2026-08-15"
tldr: >-
  AI can be a harsher critic than anyone in your company — but by default it agrees with you, so a hard critique has to be requested explicitly: with a role that has its own stake, an explicit ban on praise, and the question “why did this fail” instead of “will this work.” The guide covers attacking a text, a decision premortem, red-teaming a proposal and a plan, and ends with sorting the findings — work in three to five per round, and the decision stays yours.
faq:
  - q: >-
      Why does AI just tell me my proposal is good?
    a: >-
      Models are tuned to please, so “what do you think of my plan?” gets praise with three gentle notes tacked on. The fix: don't reveal what you think, assign a role with its own stake (“you're the CFO who has to defend this budget”), and ban praise explicitly.
  - q: >-
      What is a premortem and why does it work?
    a: >-
      Instead of asking whether the plan will work out, you jump a year forward and declare that it failed — only then do you look for reasons. That shift in framing sidesteps both confirmation bias and the model's agreeableness, because the question no longer contains any hope. The most valuable output is the “first signals” of failure, which you can turn into indicators to watch.
  - q: >-
      Why shouldn't I run the critique in the conversation where the text was written?
    a: >-
      A model that helped write a document evaluates it leniently — it's inside the context of its own text and doesn't notice what's missing. The rule is “a fresh mind does the critiquing”: at minimum a new conversation, and for important documents a different model than the one you wrote with.
  - q: >-
      The critique returned twenty-five objections — now what?
    a: >-
      Sort them into three piles: fix, knowingly keep (with a one-sentence note why — that's your prepared answer for the meeting), and discard. Work in three to five things per round; work in twenty and the document turns into a defensive wall of caveats nobody reads to the end.
  - q: >-
      How do I spot a made-up objection?
    a: >-
      The model's job is to object, so it objects even when there's nothing left. The signs: an objection with no address (“deeper risk analysis is missing” without saying where), a finding that's actually in the document, criticism outside the document's scope, and advice that would apply to anything. Verify every finding against the text before rewriting — and when an objection contradicts your field experience, experience wins.
  - q: >-
      Does an AI critic replace a colleague or a lawyer?
    a: >-
      No — it's a fast first wave, not the final check. For decisions involving money, contracts, or people, a human has to follow — someone who knows the market and your company's internal context. And sensitive business data belongs only on a paid account with contractual data protection; order-of-magnitude figures usually expose weaknesses just as well as exact numbers.
---
