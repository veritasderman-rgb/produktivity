...
excerpt: "A guide with 13 prompts: Claude Cowork pulls contacts and notes from scanned cards, prepares a CSV for your CRM, and drafts follow-ups. A human sends them."
category: "ai"
platform: "vsude"
...
updated: "2026-08-12"
tldr: >-
  A box of trade-show business cards turns into a CRM-ready table in one
  evening: your phone scans the cards ten at a time into a folder, Claude Cowork
  extracts the contacts and the handwritten margin notes — the part no card
  reader can handle — prepares a CSV for import, adds a mini-research column on
  each company, and drafts personalized follow-up emails. A human always sends,
  in small batches, and an email with nothing behind it doesn't get written at
  all.
faq:
  - q: "How is this better than a business card scanner app?"
    a: >-
      The most valuable information on a card often isn't the printed part but
      your pencil note in the margin — “call in September”, “interested in
      training for 12 people”. Automatic readers are built for printed text in
      a predictable layout; AI reads the handwriting and transcribes it
      verbatim into the context column. That's the difference between a list
      of names and a list of opportunities.
  - q: "Can I let AI send the follow-up emails directly?"
    a: >-
      No — AI writes the drafts, a human always sends. Bulk sending is the
      fastest way to turn expensively acquired contacts into spam. Sort the
      drafts into send after editing, postpone with a date, and delete — the
      third pile is usually the biggest, and that's fine. And send in small
      batches over three days, not all at once.
  - q: "What about cards where I remember nothing?"
    a: >-
      An email with nothing behind it is worse than silence, because it
      reveals you didn't remember the conversation. Have the contacts sorted
      into three groups: worth a short note (max 60 words that openly admits
      you want to reconnect), keep in the database with no action, and doesn't
      belong in the CRM at all. Never invent anything about the meeting.
  - q: "How do I handle the personal data on the cards?"
    a: >-
      Process only what a business contact needs, on a paid account with
      contractual data protection, and record the contact's origin (event and
      date) — you must be able to answer “where did you get my address”.
      A business card isn't consent to a newsletter, honor an objection the
      first time, and after the import delete the photos including the cloud
      backup and the trash.
  - q: "What if the model misreads an email or phone number?"
    a: >-
      An address with one swapped character goes unnoticed until it bounces —
      and a bounced email looks like silence. That's why the extraction
      returns a confidence column and a marker for illegible spots:
      low-confidence rows get checked against the photo, never guessed. When
      in doubt, leave the field empty and reach out via a professional
      network.
  - q: "Can I trust the company research AI adds?"
    a: >-
      Only with sources — for companies with generic names, the research
      easily attaches to a different company, and a link is the only thing
      that catches it. “Not found” is a correct answer you have to explicitly
      allow in the prompt, or you get empty phrasing. Treat the research as
