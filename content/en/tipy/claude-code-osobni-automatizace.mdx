...
excerpt: "A complete guide with prompts: installation, the first half hour, five typical tasks (cleaning up folders, bulk renaming, extracting data from PDFs, reports, running a website), CLAUDE.md as permanent instructions, and safety rules. Case study: this is how this website gets made."
category: "ai"
platform: "vsude"
