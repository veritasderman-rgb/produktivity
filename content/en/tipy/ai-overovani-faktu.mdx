...
- **Gemini Notebook** (formerly NotebookLM) — answers only from uploaded sources and shows a citation with every answer; ideal when you're checking text against your own source material.
