    ...
    <>
      ...
      <section className="border-b border-hairline">
        <div className="mx-auto max-w-5xl px-6 py-16 sm:py-24">
          <p className="eyebrow mb-6 text-blue">Ověřené systémy · denní tipy · AI novinky</p>
          <h1 className="display text-[clamp(38px,7vw,76px)]">
            Každý den <span className="text-blue">o&nbsp;kousek</span> rychlejší.
          </h1>
          ...
          <div className="mt-9 flex flex-wrap items-center gap-4">
            <Link
              href="/tipy"
              className="bg-blue px-6 py-4 text-[14px] font-bold tracking-wide text-blue-ink uppercase hover:bg-ink hover:text-paper"
            ...
            <Link
              href="/prirucka"
              className="border-[1.5px] border-hairline-strong px-6 py-4 text-[14px] font-bold tracking-wide uppercase hover:border-blue hover:text-blue"
              style={{ fontStretch: "110%" }}
            >
              Číst příručku
            </Link>
      ...
      <section className="mx-auto max-w-5xl px-6 py-16">
        <div className="mb-8 flex items-end justify-between gap-4">
          <div>
            <p className="eyebrow mb-2 text-blue">Čerstvé</p>
            <h2 className="display text-[clamp(24px,4vw,36px)]">Nejnovější tipy</h2>
          </div>
          <Link href="/tipy" className="border-b-2 border-blue pb-0.5 text-[14px] font-bold hover:text-blue">
      ...
      <section className="border-y border-hairline">
        <div className="mx-auto grid max-w-5xl gap-px bg-hairline px-0 md:grid-cols-2">
          <div className="bg-paper px-6 py-14 md:pr-12">
            <p className="eyebrow mb-2 text-blue">Základ</p>
            ...
            <Link href="/prirucka" className="mt-6 inline-block border-b-2 border-blue pb-0.5 text-[14px] font-bold hover:text-blue">
              Otevřít příručku
            </Link>
          </div>
          <div className="bg-paper px-6 py-14 md:pl-12">
            <p className="eyebrow mb-2 text-blue">Pro firmy</p>
            ...
            <Link href="/skoleni" className="mt-6 inline-block border-b-2 border-blue pb-0.5 text-[14px] font-bold hover:text-blue">
              Nabídka školení
            </Link>
          </div>
        </div>
      ...
      <section className="mx-auto max-w-5xl px-6 py-16">
        <div className="max-w-xl">
          <p className="eyebrow mb-2 text-blue">Newsletter</p>
