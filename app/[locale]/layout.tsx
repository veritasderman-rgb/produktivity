          ...
          <div className="mx-auto grid max-w-[var(--page-max)] gap-10 px-[var(--page-pad)] py-14 sm:grid-cols-3">
            ...
            <div>
              ...
              <ul className="space-y-2 text-[14px] font-semibold">
                ...
                <li><Link href={p("/kam-dal")} className="draw-link">{t.footer.resources}</Link></li>
                <li><Link href={p("/konektory")} className="draw-link">{t.footer.connectors}</Link></li>
            ...
            <div>
              ...
              <ul className="space-y-2 text-[14px] font-semibold">
                ...
                <li><Link href={p("/newsletter/archiv")} className="draw-link">{t.footer.newsletterArchive}</Link></li>
